...
if($loggedin["group"] == 'super_admin' || $loggedin["group"] == 'admin' || $loggedin["group"] == 'manager' || $loggedin["group"] == 'kabag' || $loggedin["group"] == 'na' || $loggedin["group"] == 'cso'){
	...
	$sql_mailbox 	= mysql_query("SELECT * FROM `gx_email` WHERE `kategori` LIKE '%".$kategori."%' ORDER BY `DateE` DESC");
    }else{
	$sql_mailbox 	= mysql_query("SELECT * FROM `gx_email` ORDER BY `DateE` DESC");
    }
    
    $sql_mailbox_all 	= mysql_query("SELECT * FROM `gx_email` ORDER BY `DateE` DESC");
    
    $sql_mailbox_spam 	= mysql_query("SELECT * FROM `gx_email` WHERE `kategori` = 'Spam' ORDER BY `DateE` DESC");
    $sql_mailbox_fo 	= mysql_query("SELECT * FROM `gx_email` WHERE `kategori` = 'Problem FO' ORDER BY `DateE` DESC");
    $sql_mailbox_wifi 	= mysql_query("SELECT * FROM `gx_email` WHERE `kategori` = 'Problem Wireless' ORDER BY `DateE` DESC");
    $sql_mailbox_request= mysql_query("SELECT * FROM `gx_email` WHERE `kategori` = 'Request' ORDER BY `DateE` DESC");
    $sql_mailbox_billing= mysql_query("SELECT * FROM `gx_email` WHERE `kategori` = 'Billing' ORDER BY `DateE` DESC");
