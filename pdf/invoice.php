...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="97%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="75%"><img src="logo-inv.png" height="45"></td>
        <td width="25%"><table width="248" border="0" align="right" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td width="119"><div align="left"><img src="logo-indosat.png"></div></td>
              <td width="10">&nbsp;</td>
            </tr>
          </table></td>
        </tr>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="34%" valign="top">            <span class="inv2">To</span><br>
            <span class="inv3">Bejo Marpaung</span><br>
            <span class="inv2">Jl Raya Kembar 3<br>
            Lowokwaru, Malang<br>
            Phone: (0341) 539-1037<br>
          Email: bejo@marpaung.com </span></td>
...
<table width="900" border="0" cellspacing="0">
  ...
  <tr>
    ...
    <td width="202" align="left"><font style="font-size:13px; padding-left:15px">'.trim($row_invoice["UserId"]).'</font></td>
    <td rowspan="2"><font style="font-size:13px;">Tanggal Cetak: '.date("d F Y H:i:s").'<br />
    Printed: '.($total_soft+1).'</font></td>
  </tr>
  <tr>
    <td align="right" valign="top"><font style="font-size:13px;">Printed By :</font></td>
    <td align="left" valign="top"><font style="font-size:13px; padding-left:15px">'.ucfirst(trim($loggedin["username"])).'( '.$_SERVER['REMOTE_ADDR'].' )</font></td>
