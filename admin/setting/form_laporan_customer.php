...
//SQL 
$table_main = "gx_setting_laporan_customer";
$table_detail = "";
...
//SELECT
    ...
    $urutan = "ORDER BY `kode_setting_laporan_customer` ASC";
    $select_all_data_valid = "SELECT * FROM `gx_setting_laporan_customer` WHERE `level` =  '0'";
...
//String Data View
    //Judul Form
    $judul_form = "Laporan Customer";
    $link_form_add_data = '<a href="form_setting_laporan_customer.php" class="btn bg-maroon btn-flat margin">Create New</a>';
    $judul_table = "";
    $data_field = array("Jenis Laporan", "Hari Clear", "Hari Uncleared", "Mingguan Clear", "Mingguan Uncleared", "Bulanan Clear", "Bulanan Uncleared", "Tahunan Clear", "Tahunan Uncleared");
    $data_sql_field = array("jenis_laporan", "hari_clear", "hari_uncleared", "mingguan_clear", "mingguan_uncleared", "bulanan_clear", "bulanan_uncleared", "tahunan_clear", "tahunan_uncleared");
    $index_field_sql = "id";
    $unix_field_sql = "kode_setting_laporan_customer";
    $url_form_detail = "";
    $url_form_edit = "";
    
    
    //id web
    $title_header = 'Laporan Customer';
    $submenu_header = 'laporan_customer';
...
$content = '<!-- Content Header (Page header) -->
		    ...
		    <div class="row">
				...
				<div class="box-body">
				   <div class="row">
				<div class="col-xs-1">Periode :</div>
					    <div class="col-xs-2">
						<input type="text" class="form-control" required="" name="periode_mulai" value="">
					    </div>
				<div class="col-xs-1">sd</div>
					    <div class="col-xs-2">
						<input type="text" class="form-control" required="" name="periode_akhir" value="">
					    </div>
					</div>    
				</div>
			    </div>
