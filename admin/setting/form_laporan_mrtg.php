...
//SQL 
$table_main = "gx_setting_laporan_mrtg";
$table_detail = "";
...
//SELECT
    ...
    $select_all_data_valid = "SELECT * FROM `gx_setting_laporan_mrtg` WHERE `level` =  '0'";
...
//String Data View
    //Judul Form
    $judul_form = "Laporan MRTG";
    $link_form_add_data = '<a href="form_laporan_mrtg.php" class="btn bg-maroon btn-flat margin">Create New</a>';
    $judul_table = "";
    $data_field = array("Jenis Laporan", "Harian", "Mingguan", "Bulanan");
    $data_sql_field = array("jenis_laporan", "harian", "mingguan", "bualanan");
    $index_field_sql = "id";
    $unix_field_sql = "kode_setting_laporan_mrtg";
    $url_form_detail = "";
    $url_form_edit = "";
    
    
    //id web
    $title_header = 'Laporan MRTG';
    $submenu_header = 'laporan_mrtg';
