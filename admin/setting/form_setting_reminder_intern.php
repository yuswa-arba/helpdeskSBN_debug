...
//SQL 
$table_main = "gx_setting_reminder_intern";
$table_detail = "";
...
//SELECT
    ...
    $urutan = "ORDER BY `id` ASC";
    $select_all_data_valid = "SELECT * FROM `gx_setting_reminder_intern` WHERE `level` =  '0'";
...
//UPDATE
    ...
    //$sql_update_lock 
    $table_update_lock = "gx_setting_reminder_intern";
...
//String Data View
    //Judul Form
    $judul_form = "Setting Reminder Intern";
    $link_form_add_data = '<a href="form_setting_reminder_intern.php" class="btn bg-maroon btn-flat margin">Create New</a>';
    $judul_table = "List Data Setting Reminder Intern";
    $data_field = array("Keterangan", "Jumlah", "Hari / Bulan", "Report or One Time", "Time", "");
    $data_sql_field = array("keterangan", "jumlah", "satuan_waktu", "jenis_reminder", "time", "catatan");
    $index_field_sql = "id";
    $unix_field_sql = "kode_setting_reminder_intern";
    $url_form_detail = "";
    $url_form_edit = "";
    
    
    //id web
    $title_header = 'Seting Reminder Intern';
    $submenu_header = 'setting_reminder_intern';
