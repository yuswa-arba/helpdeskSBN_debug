...
//SQL 
$table_main = "gx_setting_laporan_keuangan";
$table_detail = "";
...
//SELECT
    ...
    $urutan = "ORDER BY `kode_setting_laporan_keuangan` ASC";
    $select_all_data_valid = "SELECT * FROM `gx_setting_laporan_keuangan` WHERE `level` =  '0'";
...
//String Data View
    //Judul Form
    $judul_form = "Laporan Keuangan";
    $link_form_add_data = '<a href="form_setting_laporan_keuangan.php" class="btn bg-maroon btn-flat margin">Create New</a>';
    $judul_table = "";
    $data_field = array("Jenis Laporan", "Harian", "Mingguan", "Bulanan");
    $data_sql_field = array("jenis_laporan", "harian", "mingguan", "bulanan");
    $index_field_sql = "id";
    $unix_field_sql = "kode_setting_laporan_keuangan";
    $url_form_detail = "";
    $url_form_edit = "";
    
    
    //id web
    $title_header = 'Laporan Keuangan';
    $submenu_header = 'laporan_keuangan';
