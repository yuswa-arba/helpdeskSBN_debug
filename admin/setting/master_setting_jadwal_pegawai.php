...
//UPDATE
    ...
    $redirect_action_lock = "master_setting_jadwal_pegawai";
...
//String Data View
    //Judul Form
    $judul_form = "Master Setting Jadwal Pegawai";
    $link_form_add_data = '<a href="form_setting_jadwal_pegawai.php" class="btn bg-maroon btn-flat margin">Create New</a>';
    $judul_table = "List Data Setting Jadwal";
    $data_field = array("Kode Shift", "Nama Shift", "Check In", "Check Out");
    $data_sql_field = array("kode_shift", "nama_shift", "check_in", "check_out");
    $index_field_sql = "id";
    $unix_field_sql = "kode_shift";
    $url_form_detail = "detail_setting_jadwal_pegawai";
    $url_form_edit = "form_setting_jadwal_pegawai";
    
    
    //id web
    $title_header = 'Master Setting Jadwal Pegawai';
    $submenu_header = 'master_setting_jadwal_pegawai';
