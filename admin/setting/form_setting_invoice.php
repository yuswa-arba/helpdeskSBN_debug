...
//SELECT
    ...
    $select_all_data_valid = "SELECT * FROM `gx_setting_invoice` WHERE `level` =  '0'";
...
//UPDATE
    ...
    //$sql_update_lock 
    $table_update_lock = "gx_setting_invoice";
    $redirect_action_lock = "master_setting_invoice";
...
//String Data View
    //Judul Form
    $judul_form = "Setting Invoice";
    $link_form_add_data = '<a href="form_setting_invoice.php" class="btn bg-maroon btn-flat margin">Create New</a>';
    $judul_table = "Setting Invoice";
    $data_field = array("Invoice", "Nominal", "Due date", "Blokir", "Generate", "Friendly Reminder");
    $data_sql_field = array("menu_invoice", "nominal", "due_date", "blokir", "generate", "friendly_reminder");
    $index_field_sql = "id";
    ...
    //id web
    $title_header = 'Setting Invoice';
    $submenu_header = 'setting_invoice';
