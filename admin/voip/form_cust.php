...
if($loggedin["group"] == 'admin'){
	...
	*/
	...
	$sql_data_nomer	= mysql_query("SELECT * FROM `gx_voip_nomerTelpon` WHERE `nomer_telpon` = '".$row_data_cust["useralias"]."' LIMIT 0,1;", $conn);
	$row_data_nomer	= mysql_fetch_array($sql_data_nomer);
    }
	...
	<table cellspacing="2" class="addform_table1"  style="display: table;border-collapse: separate;border-spacing: 2px;border-color: gray;">
		...
		<td width="%75" valign="top" class="tableBodyRight" >
		    ...
		    <a href="data_voipnumb.php?r=myForm" class="btn btn-primary" onclick="return valideopenerform(\'data_voipnumb.php?r=myForm\',\'notelp\');">Search</a>
		    <span class="liens"></span> 
		</td>
	    </tr>
	    <tr>
		...
		<td width="%75" valign="top" class="tableBodyRight" >
			...
			<option value="0" '.((isset($_GET["cust_id"] )&& ($row_data_cust["typepaid"] == "0")) ? 'selected=""' : 'selected=""').'> PREPAID CARD</option>
		...
		<td width="%75" valign="top" class="tableBodyRight" >
			...
			while($row_timezone = mysql_fetch_array($sql_timezone)){
			    $content .='<option value="'.$row_timezone["id"].'" '.((isset($_GET["cust_id"] )&& ($row_data_cust["id_timezone"] == $row_timezone["id"]) OR ($row_timezone["id"] == "59") ) ? 'selected=""' : "").'> '.$row_timezone["gmtzone"].'</option>';    
			}
		...
		<td width="%75" valign="top" class="tableBodyRight" >
			...
			while($row_currency = mysql_fetch_array($sql_currency)){
			    $content .='<option value="'.$row_currency["currency"].'" '.((isset($_GET["cust_id"] )&& ($row_data_cust["currency"] == $row_currency["currency"]) OR ($row_currency["currency"]=="IDR")) ? 'selected=""' : "").'> '.$row_currency["name"].'</option>';    
			}
		...
		<td width="%75" valign="top" class="tableBodyRight" >
		    Yes  <input type="radio" '.((isset($_GET["cust_id"] )&& ($row_data_cust["block"] == "1")) ? 'checked=""' : "").' name="block" value="1"> - No <input type="radio" name="block" '.((isset($_GET["cust_id"] )&& ($row_data_cust["block"] == "0")) ? 'checked=""' : 'checked=""').' value="0">
		    <span class="liens"></span> 
		...
		<td width="%75" valign="top" class="tableBodyRight" >
	            <input class="form_input_text" name="lock_pin" size="20" maxlength="10" value="'.(isset($_GET["cust_id"] ) ? $row_data_cust["lock_pin"] : "").'">
		    <span class="liens"></span> 
		...
		<td width="%75" valign="top" class="tableBodyRight" >
		    Yes  <input type="radio" name="runservice" value="1" '.((isset($_GET["cust_id"] )&& ($row_data_cust["runservice"] == "1")) ? 'checked=""' : 'checked=""').' > - No <input type="radio" name="runservice" value="0" '.((isset($_GET["cust_id"] )&& ($row_data_cust["runservice"] == "0")) ? 'checked=""' : "").' >
		    <span class="liens"></span> 
		...
		<td width="%75" valign="top" class="tableBodyRight" >
	            <input class="form_input_text" name="creditlimit" size="20" maxlength="20" value="'.(isset($_GET["cust_id"] ) ? $row_data_cust["creditlimit"] : "" ).'">
		    <span class="liens"></span> 
		...
		<td width="%75" valign="top" class="tableBodyRight" >
		    ...
		    <span class="liens"></span> 
		    <br>currency : '.(isset($_GET["cust_id"] ) ? $row_data_cust["currency"] : "" ).'<br>Low credit limit to alert the customer
		</td>
	    </tr>
	    <tr>
		<td width="%25" valign="middle" class="form_head"> PERMITTED NOTIFICATIONS BY MAIL </td>  
		<td width="%75" valign="top" class="tableBodyRight" >
		    Yes  <input type="radio" name="notify_email" value="1" '.((isset($_GET["cust_id"] )&& ($row_data_cust["notify_email"] == "1")) ? 'checked=""' : "").'> - No <input type="radio" name="notify_email" value="0" '.((isset($_GET["cust_id"] )&& ($row_data_cust["notify_email"] == "0")) ? 'checked=""' : 'checked=""').'>
		    <span class="liens"></span> 
		...
		<td width="%75" valign="top" class="tableBodyRight" >
		    <input class="form_input_text" name="email_notification" size="30" maxlength="70" value="'.(isset($_GET["cust_id"] ) ? $row_data_cust["email_notification"] : "" ).'">
		    <span class="liens">                 </span> 
	        </td>
	    </tr>
	    <tr>
		...
		<td width="%75" valign="top" class="tableBodyRight" >
		    <input class="form_input_text" name="firstusedate" size="40" maxlength="40" readonly="" value="'.(isset($_GET["cust_id"] ) ? $row_data_cust["firstusedate"] : "" ).'">
		    <span class="liens"></span> 
	        </td>
	    </tr>
	    <tr>
		...
		<td width="%75" valign="top" class="tableBodyRight" >
		    Yes  <input type="radio" name="sip_buddy" value="1" '.((isset($_GET["cust_id"] )&& ($row_data_cust["sip_buddy"] == "1")) ? 'checked=""' : 'checked=""').'> - No <input type="radio" name="sip_buddy" value="0" '.((isset($_GET["cust_id"] )&& ($row_data_cust["sip_buddy"] == "0")) ? 'checked=""' : "").'>
		    <span class="liens"></span> 
		...
		<td width="%75" valign="top" class="tableBodyRight" >
		    Yes  <input type="radio" name="iax_buddy" value="1" '.((isset($_GET["cust_id"] )&& ($row_data_cust["iax_buddy"] == "1")) ? 'checked=""' : 'checked=""').'> - No <input type="radio" name="iax_buddy" value="0" '.((isset($_GET["cust_id"] )&& ($row_data_cust["iax_buddy"] == "0")) ? 'checked=""' : "").'>
		    <span class="liens"></span> 
		...
		<td width="%75" valign="top" class="tableBodyRight" >
	            <input class="form_input_text" name="inuse" size="5" maxlength="5" value="'.(isset($_GET["cust_id"] ) ? $row_data_cust["inuse"]  : "" ).'">
		    <span class="liens"></span> 
		...
		<td width="%75" valign="top" class="tableBodyRight" >
		    Yes  <input type="radio" name="autorefill" value="1" '.((isset($_GET["cust_id"] )&& ($row_data_cust["autorefill"] == "1")) ? 'checked=""' : "").'> - No <input type="radio" name="autorefill" value="0" '.((isset($_GET["cust_id"] )&& ($row_data_cust["autorefill"] == "0")) ? 'checked=""' : 'checked=""').'>
		    <span class="liens"></span> 
		...
		<td width="%75" valign="top" class="tableBodyRight" >
	            <input class="form_input_text" name="initialbalance" size="30" value="'.((isset($_GET["cust_id"] )) ? $row_data_cust["initialbalance"] : "0").'" maxlength="30">
		    <span class="liens"></span> 
		...
		<td width="%75" valign="top" class="tableBodyRight" >
	            <input class="form_input_text" name="vat_rn" size="40" maxlength="40" value="'.(isset($_GET["cust_id"]) ? $row_data_cust["vat_rn"] : "").'">
		    <span class="liens"></span> 
	        </td>
	    </tr>		
	    <tr>
		...
		<td width="%75" valign="top" class="tableBodyRight" >
			...
			<option value="0.00" '.((isset($_GET["cust_id"] )&& ($row_data_cust["discount"] == "0.00")) ? 'selected=""' : 'selected=""').'> NO DISCOUNT</option>
		...
		<td width="%75" valign="top" class="tableBodyRight" >
	            <input class="form_input_text" name="traffic" size="30" maxlength="20" value="'.(isset($_GET["cust_id"]) ? $row_data_cust["traffic"] : "").'">
		    <span class="liens"> </span> 
	        </td>
	    </tr>
	    <tr>
		...
		<td width="%75" valign="top" class="tableBodyRight" >
	            <textarea class="form_input_textarea" name="traffic_target" cols="50" rows="4">'.(isset($_GET["cust_id"]) ? $row_data_cust["traffic_target"] : "").'</textarea> 
			<span class="liens"></span> 
	        </td>
	    </tr>
	    <tr>
	...
	<a href="data_cust.php?r=myForm" class="btn btn-primary" onclick="return valideopenerform(\'data_cust.php?r=myForm\',\'cust\');">Search Customer</a>
	<a href="data_pegawai.php?r=myForm" class="btn btn-primary" onclick="return valideopenerform(\'data_pegawai.php?r=myForm\',\'pegawai\');">Search Pegawai</a>
	<br />
	<br />
	<table cellspacing="2" class="addform_table1"  style="display: table;border-collapse: separate;border-spacing: 2px;border-color: gray;">
	    <tbody>
	    ...
	    <tr>
		<td width="%25" valign="middle" class="form_head"> Customer Number / Kode Pegawai </td>  
		<td width="%75" valign="top" class="tableBodyRight" >
		     <input class="form_input_text" name="customer_number" size="30" maxlength="30" value="'.(isset($_GET["cust_id"] ) ? $row_data_nomer["customer_number"] : "").'" readonly="">
		    <span class="liens"> </span> 
		</td>
	    </tr>
	    <tr>
		...
		<td width="%75" valign="top" class="tableBodyRight" >
	            <input class="form_input_text" name="firstname" required="" size="30" maxlength="50" value="'.(isset($_GET["cust_id"] ) ? ($row_data_cust["firstname"].' '.$row_data_cust["lastname"]) : "").'">
		    <span class="liens"></span> 
	       </td>
	    </tr>
	    <tr>
		...
		<td width="%75" valign="top" class="tableBodyRight" >
	            <input class="form_input_text" name="email" size="30" required="" maxlength="70" value="'.(isset($_GET["cust_id"] ) ? $row_data_cust["email"] : "" ).'">
		    <span class="liens"></span> 
	       </td>
	    </tr>
	    <tr>
		...
		<td width="%75" valign="top" class="tableBodyRight" >
	            <input class="form_input_text" name="address" size="30" maxlength="100" value="'.(isset($_GET["cust_id"] ) ? $row_data_cust["address"] : "" ).'">
		    <span class="liens"></span> 
	       </td>
	    </tr>
	    <tr>
		...
		<td width="%75" valign="top" class="tableBodyRight" >
		    <input class="form_input_text" name="city" size="30" maxlength="40" value="'.(isset($_GET["cust_id"] ) ? $row_data_cust["city"] : "" ).'">
		    <span class="liens"></span> 
	       </td>
	    </tr>
	    <tr>
		...
		<td width="%75" valign="top" class="tableBodyRight" >
		    <input class="form_input_text" name="state" size="30" maxlength="40" value="'.(isset($_GET["cust_id"] ) ? $row_data_cust["state"] : "" ).'">
		    <span class="liens"></span> 
	       </td>
	    </tr>
	    <tr>
		...
		<td width="%75" valign="top" class="tableBodyRight" >
		    <input class="form_input_text" name="zipcode" size="30" maxlength="20" value="'.(isset($_GET["cust_id"]) ? $row_country["zipcode"] : "").'">
		    <span class="liens"></span> 
	        </td>
	    </tr>
	    <tr>
		...
		<td width="%75" valign="top" class="tableBodyRight" >
	            <input class="form_input_text" name="phone" size="30" maxlength="20" value="'.(isset($_GET["cust_id"] ) ? $row_country["phone"] : "" ).'">
		    <span class="liens"></span> 
	        </td>
	    </tr>
	    <tr>
		...
		<td width="%75" valign="top" class="tableBodyRight" >
	            <input class="form_input_text" name="fax" size="30" maxlength="20" value="'.(isset($_GET["cust_id"] ) ? $row_country["fax"] : "" ).'">
		    <span class="liens"></span> 
	       </td>
	    </tr>
	    <tr>
		...
		<td width="%75" valign="top" class="tableBodyRight" >
	            <input class="form_input_text" name="company_name" size="40" maxlength="50" value="'.(isset($_GET["cust_id"] ) ? $row_country["company_name"] : "" ).'">
		    <span class="liens"></span> 
	        </td>
	    </tr>
	    <tr>
		...
		<td width="%75" valign="top" class="tableBodyRight" >
		    <input class="form_input_text" name="company_website" size="40" maxlength="60" value="'.(isset($_GET["cust_id"] ) ? $row_country["company_website"] : "" ).'">
		    <span class="liens"></span> 
	        </td>
	    </tr>	
	    </tbody>
