...
if(isset($_POST["save"]))
{
	...
	echo mysql_query($sql_insert_invoice, $conn_voip) or die (mysql_error());
	...
	echo mysql_query($sql_insert_invoice_item, $conn_voip) or die (mysql_error());
	...
	window.location.href='".URL_ADMIN."voip/log_refill.php';
	</script>";
    ...
    $content = '
				...
				<div class="box-body">
					...
					<div class="col-xs-4">
					    ...
					    <a href="'.URL_ADMIN.'voip/data_subscription.php?r=form_refill" class="btn bg-olive btn-flat margin pull-right" onclick="return valideopenerform(\''.URL_ADMIN.'voip/data_subscription.php?r=form_refill\',\'refill\');">Select</a>
					</div>
				    </div>
				    </div>
