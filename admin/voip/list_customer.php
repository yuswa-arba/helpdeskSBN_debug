...
if(isset($_POST["search"])){
    ...
    $sql_masterCustomer = mysql_query("SELECT * FROM `cc_card`
				  ...
				  $i_useralias
				  $i_mac_addr
				  ORDER BY `id` ASC LIMIT $start, $perhalaman;",$conn_voip);
	
	$sql_total_data	= mysql_num_rows(mysql_query("SELECT * FROM `cc_card`
				  WHERE `username` != ''
				  $sql_fromday_create
				  $sql_today_create
				  $sql_fromday_fub
    ...
    $sql_masterCustomer = mysql_query("SELECT * FROM `cc_card` ORDER BY `id` ASC LIMIT $start, $perhalaman;",$conn_voip);
	$sql_total_data	= mysql_num_rows(mysql_query("SELECT * FROM `cc_card` ORDER BY `id` ASC;",$conn_voip));
}
