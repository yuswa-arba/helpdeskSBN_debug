...
if($loggedin["group"] == 'admin'){
  ...
  Sort by
<select name="sort" onchange="location.href=\'log_refill.php\'+options[selectedIndex].value;">
...
$content .= '
	<center>
        		...
        		<td align="left" class="bgcolor_002">
      			...
      			<td align="left" class="bgcolor_003">
					...
					<tr><td class="fontstyle_searchoptions">
	  				<input type="checkbox" name="fromday_refill" value="true" > From : <select name="fromstatsday_sday_refill" class="form_input_select">
					...
					<option value="01">01</option><option value="02">02</option><option value="03">03</option><option value="04">04</option><option value="05">05</option><option value="06">06</option><option value="07">07</option><option value="08">08</option><option value="09">09</option><option value="10">10</option><option value="11">11</option><option value="12">12</option><option value="13">13</option><option value="14">14</option><option value="15">15</option><option value="16">16</option><option value="17">17</option><option value="18">18</option><option value="19">19</option><option value="20">20</option><option value="21">21</option><option value="22">22</option><option value="23">23</option><option value="24">24</option><option value="25">25</option><option value="26">26</option><option value="27">27</option><option value="28">28</option><option value="29">29</option><option value="30">30</option><option value="31">31</option>
                                        ...
                                        <select name="fromstatsmonth_sday_refill" class="form_input_select">
					...
					<input type="checkbox" name="today_refill" value="true" >To :					<select name="tostatsday_sday_refill">
                                        ';
					$bil_tgl = date("d");
				 	...
				 	<select name="tostatsmonth_sday_refill">
					<OPTION value="2014-09" > September-2014 </option><OPTION value="2014-08" > August-2014 </option><OPTION value="2014-07" > July-2014 </option><OPTION value="2014-06" > June-2014 </option><OPTION value="2014-05" > May-2014 </option><OPTION value="2014-04" > April-2014 </option><OPTION value="2014-03" > March-2014 </option><OPTION value="2014-02" > February-2014 </option><OPTION value="2014-01" > January-2014 </option><OPTION value="2013-12" > December-2013 </option><OPTION value="2013-11" > November-2013 </option><OPTION value="2013-10" > October-2013 </option><OPTION value="2013-09" > September-2013 </option><OPTION value="2013-08" > August-2013 </option><OPTION value="2013-07" > July-2013 </option><OPTION value="2013-06" > June-2013 </option><OPTION value="2013-05" > May-2013 </option><OPTION value="2013-04" > April-2013 </option><OPTION value="2013-03" > March-2013 </option><OPTION value="2013-02" > February-2013 </option><OPTION value="2013-01" > January-2013 </option><OPTION value="2012-12" > December-2012 </option><OPTION value="2012-11" > November-2012 </option><OPTION value="2012-10" > October-2012 </option><OPTION value="2012-09" > September-2012 </option><OPTION value="2012-08" > August-2012 </option><OPTION value="2012-07" > July-2012 </option><OPTION value="2012-06" > June-2012 </option><OPTION value="2012-05" > May-2012 </option><OPTION value="2012-04" > April-2012 </option><OPTION value="2012-03" > March-2012 </option><OPTION value="2012-02" > February-2012 </option><OPTION value="2012-01" > January-2012 </option><OPTION value="2011-12" > December-2011 </option><OPTION value="2011-11" > November-2011 </option><OPTION value="2011-10" > October-2011 </option><OPTION value="2011-09" > September-2011 </option><OPTION value="2011-08" > August-2011 </option><OPTION value="2011-07" > July-2011 </option><OPTION value="2011-06" > June-2011 </option><OPTION value="2011-05" > May-2011 </option><OPTION value="2011-04" > April-2011 </option><OPTION value="2011-03" > March-2011 </option><OPTION value="2011-02" > February-2011 </option><OPTION value="2011-01" > January-2011 </option><OPTION value="2010-12" > December-2010 </option><OPTION value="2010-11" > November-2010 </option><OPTION value="2010-10" > October-2010 </option><OPTION value="2010-09" > September-2010 </option><OPTION value="2010-08" > August-2010 </option><OPTION value="2010-07" > July-2010 </option><OPTION value="2010-06" > June-2010 </option><OPTION value="2010-05" > May-2010 </option><OPTION value="2010-04" > April-2010 </option><OPTION value="2010-03" > March-2010 </option><OPTION value="2010-02" > February-2010 </option><OPTION value="2010-01" > January-2010 </option><OPTION value="2009-12" > December-2009 </option><OPTION value="2009-11" > November-2009 </option><OPTION value="2009-10" > October-2009 </option><OPTION value="2009-09" > September-2009 </option><OPTION value="2009-08" > August-2009 </option><OPTION value="2009-07" > July-2009 </option><OPTION value="2009-06" > June-2009 </option><OPTION value="2009-05" > May-2009 </option><OPTION value="2009-04" > April-2009 </option><OPTION value="2009-03" > March-2009 </option><OPTION value="2009-02" > February-2009 </option><OPTION value="2009-01" > January-2009 </option><OPTION value="2008-12" > December-2008 </option><OPTION value="2008-11" > November-2008 </option><OPTION value="2008-10" > October-2008 </option><OPTION value="2008-09" > September-2008 </option><OPTION value="2008-08" > August-2008 </option><OPTION value="2008-07" > July-2008 </option><OPTION value="2008-06" > June-2008 </option><OPTION value="2008-05" > May-2008 </option><OPTION value="2008-04" > April-2008 </option><OPTION value="2008-03" > March-2008 </option><OPTION value="2008-02" > February-2008 </option><OPTION value="2008-01" > January-2008 </option><OPTION value="2007-12" > December-2007 </option><OPTION value="2007-11" > November-2007 </option><OPTION value="2007-10" > October-2007 </option><OPTION value="2007-09" > September-2007 </option><OPTION value="2007-08" > August-2007 </option><OPTION value="2007-07" > July-2007 </option><OPTION value="2007-06" > June-2007 </option><OPTION value="2007-05" > May-2007 </option><OPTION value="2007-04" > April-2007 </option><OPTION value="2007-03" > March-2007 </option><OPTION value="2007-02" > February-2007 </option><OPTION value="2007-01" > January-2007 </option><OPTION value="2006-12" > December-2006 </option><OPTION value="2006-11" > November-2006 </option><OPTION value="2006-10" > October-2006 </option><OPTION value="2006-09" > September-2006 </option><OPTION value="2006-08" > August-2006 </option><OPTION value="2006-07" > July-2006 </option><OPTION value="2006-06" > June-2006 </option><OPTION value="2006-05" > May-2006 </option><OPTION value="2006-04" > April-2006 </option><OPTION value="2006-03" > March-2006 </option><OPTION value="2006-02" > February-2006 </option><OPTION value="2006-01" > January-2006 </option><OPTION value="2005-12" > December-2005 </option><OPTION value="2005-11" > November-2005 </option><OPTION value="2005-10" > October-2005 </option><OPTION value="2005-09" > September-2005 </option><OPTION value="2005-08" > August-2005 </option><OPTION value="2005-07" > July-2005 </option><OPTION value="2005-06" > June-2005 </option><OPTION value="2005-05" > May-2005 </option><OPTION value="2005-04" > April-2005 </option><OPTION value="2005-03" > March-2005 </option><OPTION value="2005-02" > February-2005 </option><OPTION value="2005-01" > January-2005 </option><OPTION value="2004-12" > December-2004 </option><OPTION value="2004-11" > November-2004 </option><OPTION value="2004-10" > October-2004 </option><OPTION value="2004-09" > September-2004 </option><OPTION value="2004-08" > August-2004 </option><OPTION value="2004-07" > July-2004 </option><OPTION value="2004-06" > June-2004 </option><OPTION value="2004-05" > May-2004 </option><OPTION value="2004-04" > April-2004 </option><OPTION value="2004-03" > March-2004 </option><OPTION value="2004-02" > February-2004 </option><OPTION value="2004-01" > January-2004 </option>					</select>
					</td></tr></table>
	  			</td>
    		</tr>
		...
		<!-- compare with a value //-->
				...
				<tr><td class="fontstyle_searchoptions">&nbsp;&nbsp;<INPUT TYPE="text" NAME="username_refill" value=""></td>
				<td class="fontstyle_searchoptions" align="center" ><input type="radio" NAME="username_refilltype" value="1" checked>Exact </td>
				<td class="fontstyle_searchoptions" align="center" ><input type="radio" NAME="username_refilltype" value="2" > Begins with</td>
				<td class="fontstyle_searchoptions" align="center" ><input type="radio" NAME="username_refilltype" value="3" > Contains</td>
				<td class="fontstyle_searchoptions" align="center" ><input type="radio" NAME="username_refilltype" value="4" > Ends with</td>
				</tr></table></td>
			</tr>

						<tr>
				<td class="bgcolor_002" align="left">
					<font class="fontstyle_003">&nbsp;&nbsp;LASTNAME_REFILL</font>
				</td>
				<td class="bgcolor_003" align="left" >
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr><td class="fontstyle_searchoptions">&nbsp;&nbsp;<INPUT TYPE="text" NAME="lastname_refill" value=""></td>
				<td class="fontstyle_searchoptions" align="center" ><input type="radio" NAME="lastname_refilltype" value="1" checked>Exact </td>
				<td class="fontstyle_searchoptions" align="center" ><input type="radio" NAME="lastname_refilltype" value="2" > Begins with</td>
				<td class="fontstyle_searchoptions" align="center" ><input type="radio" NAME="lastname_refilltype" value="3" > Contains</td>
				<td class="fontstyle_searchoptions" align="center" ><input type="radio" NAME="lastname_refilltype" value="4" > Ends with</td>
				</tr></table></td>
			</tr>

						<tr>
				<td class="bgcolor_004" align="left">
					<font>&nbsp;&nbsp;FIRSTNAME_REFILL</font>
				</td>
				<td class="bgcolor_005" align="left" >
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr><td class="fontstyle_searchoptions">&nbsp;&nbsp;<INPUT TYPE="text" NAME="firstname_refill" value=""></td>
				<td class="fontstyle_searchoptions" align="center" ><input type="radio" NAME="firstname_refilltype" value="1" checked>Exact </td>
				<td class="fontstyle_searchoptions" align="center" ><input type="radio" NAME="firstname_refilltype" value="2" > Begins with</td>
				<td class="fontstyle_searchoptions" align="center" ><input type="radio" NAME="firstname_refilltype" value="3" > Contains</td>
				<td class="fontstyle_searchoptions" align="center" ><input type="radio" NAME="firstname_refilltype" value="4" > Ends with</td>
				</tr></table></td>
			</tr>
...
$fromday_refill                                    = isset($_POST['fromday_refill']) ? $_POST['fromday_refill'] : ''; //checked from
$fromstatsday_sday_refill                          = isset($_POST['fromstatsday_sday_refill']) ? $_POST['fromstatsday_sday_refill'] : ''; //day selected
$fromstatsmonth_sday_refill                        = isset($_POST['fromstatsmonth_sday_refill']) ? $_POST['fromstatsmonth_sday_refill'] : ''; //month selected
$today_refill                                      = isset($_POST['today_refill']) ? $_POST['today_refill'] : ''; 
$tostatsday_sday_refill                            = isset($_POST['tostatsday_sday_refill']) ? $_POST['tostatsday_sday_refill'] : '';
$tostatsmonth_sday_refill                          = isset($_POST['tostatsmonth_sday_refill']) ? $_POST['tostatsmonth_sday_refill'] : '';
$username_refill                                   = isset($_POST['username_refill']) ? $_POST['username_refill'] : '';
$username_refilltype                               = isset($_POST['username_refilltype']) && $username_refill!='' ? $_POST['username_refilltype'] : '';
$firstname_refill                                  = isset($_POST['firstname_refill']) ? $_POST['firstname_refill'] : '';
$firstname_refilltype                              = isset($_POST['firstname_refilltype']) && $firstname_refill!='' ? $_POST['firstname_refilltype'] : '';  
$lastname_refill                                   = isset($_POST['lastname_refill']) ? $_POST['lastname_refill'] : '';
$lastname_refilltype                               = isset($_POST['lastname_refilltype']) && $lastname_refill!='' ? $_POST['lastname_refilltype'] : '';  
$from_date_refill                                  = implode('-', array($fromstatsmonth_sday_refill, $fromstatsday_sday_refill));
$to_date_refill                                    = implode('-', array($tostatsmonth_sday_refill, $tostatsday_sday_refill));  


if((isset($_POST['username_refill']) && isset($_POST['username_refill'])) || isset($_POST['lastname_refill'])  || isset($_POST['firstname_refill'])){
    if(isset($_POST['fromday_refill']) && isset($_POST['today_refill']) && $from_date_refill!='' && $to_date_refill!=''){    
            $sql_from_to_day = isset($_POST['fromday_refill']) && isset($_POST['today_refill']) && $from_date_refill!='' && $to_date_refill!='' ? "(`cc_logrefill`.`date` BETWEEN $from_date_refill AND $to_date_refill)" : "";    
    }elseif(isset($_POST['fromday_refill']) && $from_date_refill!=''){
            $sql_from_to_day = isset($_POST['fromday_refill']) && $from_date_refill!='' ? "`cc_logrefill`.`date`>=$from_date_refill" : "";    
    }elseif(isset($_POST['today_refill']) && $to_date_refill!='' ){
            $sql_from_to_day = isset($_POST['today_refill']) && $to_date_refill!='' ? "`cc_logrefill`.`date`<=$to_date_refill" : "";
    }else{
            $sql_from_to_day = "";
    }
}else{
    if(isset($_POST['fromday_refill']) && isset($_POST['today_refill'])){    
            $sql_from_to_day = isset($_POST['fromday_refill']) && isset($_POST['today_refill']) && $from_date_refill!='' && $to_date_refill!='' ? "`cc_logrefill`.`date` BETWEEN $from_date_refill AND $to_date_refill" : "";    
    }elseif(isset($_POST['fromday_refill']) && $from_date_refill!=''){
            $sql_from_to_day = isset($_POST['fromday_refill']) && $from_date_refill!='' ? "`cc_logrefill`.`date`>='$from_date_refill 00:00:00'" : "";    
    }elseif(isset($_POST['today_refill']) && $to_date_refill!='' ){
            $sql_from_to_day = isset($_POST['today_refill']) && $to_date_refill!='' ? "`cc_logrefill`.`date`<='$to_date_refill 23:59:59'" : "";
    }else{
            $sql_from_to_day = "";
    }
}

$sql_connector_from_to_day_with_username_refill    = isset($_POST['fromday_refill']) && isset($_POST['today_refill']) && isset($_POST['username_refill']) && $username_refill!='' ? "AND" : "";

if($username_refilltype == '1' && $username_refill!=''){
$sql_username_refill                               = isset($_POST['username_refill']) ? "`cc_card`.`username`='$username_refill'" : "";
}elseif($username_refilltype == '2' && $username_refill!=''){
$sql_username_refill                               = isset($_POST['username_refill']) ? "`cc_card`.`username` LIKE '$username_refill%'" : "";
}elseif($username_refilltype == '3' && $username_refill!=''){
$sql_username_refill                               = isset($_POST['username_refill']) ? "`cc_card`.`username` LIKE '%$username_refill%'" : "";
}elseif($username_refilltype == '4' && $username_refill!=''){
$sql_username_refill                               = isset($_POST['username_refill']) ? "`cc_card`.`username` LIKE '%$username_refill'" : "";
}else{
$sql_username_refill                               = "";
}
...
$sql_connector_from_to_day_with_lastname_refill    = isset($_POST['fromday_refill']) && isset($_POST['today_refill']) && isset($_POST['lastname_refill']) && $lastname_refill!='' && is_null($_POST['username_refill']) && $username_refill='' && is_null($_POST['firstname_refill']) && $firstname_refill='' ? "AND" : "";

$sql_connector_username_refill_with_lastname_refill       = isset($_POST['username_refill']) && $username_refill!='' && isset($_POST['lastname_refill']) && $lastname_refill!='' ? "AND" : "";

if($lastname_refilltype == '1' && $lastname_refill!=''){
$sql_lastname_refill                               = isset($_POST['lastname_refill']) ? "`cc_card`.`lastname`='$lastname_refill'" : "";
}elseif($lastname_refilltype == '2' && $lastname_refill!=''){
$sql_lastname_refill                               = isset($_POST['lastname_refill']) ? "`cc_card`.`lastname` LIKE '$lastname_refill%'" : "";
}elseif($lastname_refilltype == '3' && $lastname_refill!=''){
$sql_lastname_refill                               = isset($_POST['lastname_refill']) ? "`cc_card`.`lastname` LIKE '%$lastname_refill%'" : "";
}elseif($lastname_refilltype == '4' && $lastname_refill!=''){
$sql_lastname_refill                               = isset($_POST['lastname_refill']) ? "`cc_card`.`lastname` LIKE '%$lastname_refill'" : "";
}else{
$sql_lastname_refill                               = "";
}
...
$sql_connector_from_to_day_with_firstname_refill   = isset($_POST['fromday_refill']) && isset($_POST['today_refill']) && isset($_POST['firstname_refill']) && $firstname_refill!='' && is_null($_POST['lastname_refill']) && $lastname_refill='' && isset($_POST['username_refill']) && $username_refill!='' ? "AND" : "";

$sql_connector_username_refill_with_firstname_refill      = isset($_POST['username_refill']) && $username_refill!='' && isset($_POST['firstname_refill']) && $firstname_refill!='' && is_null($_POST['lastname_refill']) && $lastname_refill='' && is_null($_POST['fromday_refill']) && is_null($_POST['today_refill']) ? "AND" : "";

$sql_connector_lastname_refill_with_firstname_refill      = isset($_POST['lastname_refill']) && $lastname_refill!='' && isset($_POST['firstname_refill']) && $firstname_refill!='' ? "AND" : "";

if($firstname_refilltype == '1' && $firstname_refill!=''){
$sql_firstname_refill                              = isset($_POST['firstname_refill']) ? "`cc_card`.`firstname`='$firstname_refill'" : "";
}elseif($firstname_refilltype == '2' && $firstname_refill!=''){
$sql_firstname_refill                              = isset($_POST['firstname_refill']) ? "`cc_card`.`firstname` LIKE '$firstname_refill%'" : "";
}elseif($firstname_refilltype == '3' && $firstname_refill!=''){
$sql_firstname_refill                              = isset($_POST['firstname_refill']) ? "`cc_card`.`firstname` LIKE '%$firstname_refill%'" : "";
}elseif($firstname_refilltype == '4' && $firstname_refill!=''){
$sql_firstname_refill                              = isset($_POST['firstname_refill']) ? "`cc_card`.`firstname` LIKE '%$firstname_refill'" : "";
}else{
$sql_firstname_refill                              = "";    
}

$sql_where                                  = (isset($_POST['fromday_refill']) && isset($_POST['today_refill']) && $to_date_refill!='' && $from_date_refill!='') || (isset($_POST['username_refill']) && $username_refill!='' && $username_refilltype!='') || (isset($_POST['lastname_refill']) && $lastname_refill!='') || (isset($_POST['firstname_refill']) && $firstname_refill!='') ? "WHERE" : "";
...
$sql_cc_logrefill = mysql_query("SELECT `cc_logrefill`.`id`, `cc_logrefill`.`date`, `cc_logrefill`.`credit`, `cc_logrefill`.`card_id`,
                                                                        ...
                                                                        FROM `cc_logrefill`, `cc_card` $sql_where $sql_from_to_day $sql_connector_from_to_day_with_username_refill $sql_username_refill $sql_connector_from_to_day_with_lastname_refill $sql_connector_username_refill_with_lastname_refill $sql_lastname_refill $sql_connector_from_to_day_with_firstname_refill $sql_connector_username_refill_with_firstname_refill $sql_connector_lastname_refill_with_firstname_refill $sql_firstname_refill", $conn_voip);
...
echo "SELECT `cc_logrefill`.`id`, `cc_logrefill`.`date`, `cc_logrefill`.`credit`, `cc_logrefill`.`card_id`,
                                                                        ...
                                                                        `cc_card`.`id_group`, `cc_card`.`company_name`, `cc_card`.`company_website`, `cc_card`.`vat_rn`, `cc_card`.`traffic`, `cc_card`.`traffic_target`, `cc_card`.`discount`, `cc_card`.`restriction`,
                                                                        `cc_card`.`id_seria`, `cc_card`.`serial`, `cc_card`.`block`, `cc_card`.`lock_pin`, `cc_card`.`lock_date`
                                                                        FROM `cc_logrefill`, `cc_card` $sql_where $sql_from_to_day $sql_connector_from_to_day_with_username_refill $sql_username_refill $sql_connector_from_to_day_with_lastname_refill $sql_connector_username_refill_with_lastname_refill $sql_lastname_refill $sql_connector_from_to_day_with_firstname_refill $sql_connector_username_refill_with_firstname_refill $sql_connector_lastname_refill_with_firstname_refill $sql_firstname_refill";
}else{
$sql_cc_logrefill = mysql_query("SELECT `cc_logrefill`.`id`, `cc_logrefill`.`date`, `cc_logrefill`.`credit`, `cc_logrefill`.`card_id`,
                                                                        `cc_logrefill`.`description`, `cc_logrefill`.`refill_type`, `cc_logrefill`.`added_invoice`, `cc_logrefill`.`agent_id`,
                                                                        `cc_card`.`id`, `cc_card`.`creationdate`, `cc_card`.`firstusedate`, `cc_card`.`expirationdate`, `cc_card`.`enableexpire`,
