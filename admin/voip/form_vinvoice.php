...
if(isset($_POST["save"]))
{
	...
	window.location.href='".URL_ADMIN."voip/vinvoice.php';
	</script>";
    ...
    $content = '
                ...
                <section class="content">
					...
					<div class="row">
						...
						<a href="'.URL_ADMIN.'voip/data_subscription.php?r=form_invoice" class="btn bg-olive btn-flat margin pull-right" onclick="return valideopenerform(\''.URL_ADMIN.'voip/data_subscription.php?r=form_invoice\',\'invoice\');">Select</a>
					    </div>
                                        </div>
					</div>
