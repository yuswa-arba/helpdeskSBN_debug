...
if($loggedin["group"] == 'admin'){
    ...
    $content ='<section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="form_cust">Form Customer</a></li>
                    </ol>
                </section>
	...
	<table cellspacing="2" class="addform_table1"  style="display: table;border-collapse: separate;border-spacing: 2px;border-color: gray;">
		...
		<td width="%75" valign="top" class="tableBodyRight" >
		    <input class="form_input_text" name="username" size="30" value="'.(isset($_GET["cust_id"]) ? $row_data_cust["username"] : "").'" readonly="" maxlength="40">
		...
		<td width="%75" valign="top" class="tableBodyRight" >
		    <input class="form_input_text" name="useralias" size="20" value="'.(isset($_GET["cust_id"]) ? $row_data_cust["useralias"] : "").'" maxlength="40">
		    <span class="liens"></span> 
		</td>
	    </tr>
	    <tr>
		...
		<td width="%75" valign="top" class="tableBodyRight" >
	            <input class="form_input_text" name="uipass" size="20" value="'.(isset($_GET["cust_id"]) ? $row_data_cust["uipass"] : "").'" maxlength="20">
		    <span class="liens"></span> 
		...
		<td width="%75" valign="top" class="tableBodyRight" >
	            <input class="form_input_text" name="credit" size="30" maxlength="30" value="'.(isset($_GET["cust_id"]) ? Nominal($row_data_cust["credit"]) : "").'">
		    <span class="liens"> </span> 
	    ...
	    <tr>
		<td width="%25" valign="middle" class="form_head"> LAST NAME </td>  
		<td width="%75" valign="top" class="tableBodyRight" >
		     <input class="form_input_text" name="lastname" size="30" maxlength="50" value="'.$row_data_cust["lastname"].'">
		    <span class="liens"> </span> 
		</td>
	    </tr>
	    <tr>
		<td width="%25" valign="middle" class="form_head"> FIRST NAME </td>  
		<td width="%75" valign="top" class="tableBodyRight" >
	            <input class="form_input_text" name="firstname" size="30" maxlength="50" value="'.$row_data_cust["firstname"].'">
		    <span class="liens"></span> 
	       </td>
	    </tr>
	    <tr>
		...
		<td width="%75" valign="top" class="tableBodyRight" >
			...
			while($row_country = mysql_fetch_array($sql_country)){
			    $content .='<option value="'.$row_country["countrycode"].'" '.((isset($_GET["cust_id"] )&& ($row_data_cust["country"] == $row_country["countrycode"])) ? 'selected=""' : "").'> '.$row_country["countryname"].'</option>';    
			}
		...
		<td width="%75" valign="top" class="tableBodyRight" >
	            <input class="form_input_text" name="expirationdate" size="40" maxlength="40" value="'.$row_data_cust["expirationdate"].'">
		    <span class="liens"></span> 
		...
		<td width="%75" valign="top" class="tableBodyRight" >
	            <input class="form_input_text" name="expiredays" size="10" maxlength="6" value="'.$row_data_cust["expiredays"].'">
		    <span class="liens">  </span> 
		...
		<td width="%75" valign="top" class="tableBodyRight" >
	            <input class="form_input_text" name="mac_addr" size="20" maxlength="17" value="'.$row_data_cust["mac_addr"].'">
		    <span class="liens"></span> 
		...
		<td width="%75" valign="top" class="tableBodyRight" >
	            <input class="form_input_text" name="vat" size="10" maxlength="6" value="'.$row_data_cust["vat"].'">
		    <span class="liens"> </span> 
