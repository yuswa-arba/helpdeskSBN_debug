	...
	*/
	...
	<table cellspacing="2" class="addform_table1"  style="display: table;border-collapse: separate;border-spacing: 2px;border-color: gray;">
		...
		<td width="%75" valign="top" class="tableBodyRight" >
		    ...
		    <a href="'.URL_ADMIN.'voip/data_voipnumb.php?r=myForm" class="btn btn-primary" onclick="return valideopenerform(\''.URL_ADMIN.'voip/data_voipnumb.php?r=myForm\',\'notelp\');">Search</a>
		    <span class="liens"></span> 
		</td>
	    </tr>
	    <tr>
	...
	<a href="'.URL_ADMIN.'voip/data_cust.php?r=myForm" class="btn btn-primary" onclick="return valideopenerform(\''.URL_ADMIN.'voip/data_cust.php?r=myForm\',\'cust\');">Search Customer</a>
	<br />
	<br />
	<table cellspacing="2" class="addform_table1"  style="display: table;border-collapse: separate;border-spacing: 2px;border-color: gray;">
	    <tbody>
