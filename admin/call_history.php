...
if(isset($_POST["search"])){
    ...
    $sql_callhistory = "SELECT t1.starttime, t1.src, t1.calledstation, t1.destination, t1.sessiontime, t1.terminatecauseid, t1.sipiax, t1.sessionbill
                    FROM `cc_call` t1
                    WHERE `src` != 0 
...
//echo $sql_callhistory;
    ...
    $content ='<!-- Content Header (Page header) -->
				...
				<form action="call_history.php" method="post" name="form_callhistory" id="form_callhistory">
                    ...
                    <table border="0" cellspacing="0" cellpadding="2" class="gwlines arborder">
			<tbody><tr>
...
$content.='                                        </select>
			...
			<tr>
              ...
              <table  id="callhistory" class="table table-bordered table-hover">
                <thead><tr>
                  <th width="20">#</th>
                  <th >Date</th>
                  <th >CallerID</th>
		...
		while ($row_callhistory = mysql_fetch_array($sql_call)){
		    ...
		    $tc	 .= ($row_callhistory["terminatecauseid"]=="4") ? '4' : '';
                ...
                <tr bgcolor="#F2F8FF" onmouseover="bgColor=\'#C4FFD7\'" onmouseout="bgColor=\'#F2F8FF\'"> 
                    ...
                    <td valign="top" align="center" class="tableBody">'.$row_country["countryname"].'</td>
