                                ...
                                <div class="box-body">
                                    ...
                                    <form role="form" method="POST" action="">
										<div class="form-group">
											<div class="row">
												<div class="col-xs-4">
													<h5>Dari Bandwidth</h5>
												</div>
												<div class="col-xs-4">
													<select class="form-control" name="GroupName1">
										...
										<div class="form-group">
											<div class="row">
												...
												<div class="col-xs-4">
													<select class="form-control" name="GroupName2">
														<option value="h.10">h.10</option>
														<option value="h.09">h.09</option>
														<option value="h.08">h.08</option>
														<option value="h.07">h.07</option>
...
{
	$GroupName1	= isset($_POST['GroupName1']) ? ($_POST['GroupName1']) : '';
	$GroupName2	= isset($_POST['GroupName2']) ? ($_POST['GroupName2']) : '';
	
	$sql_group1	= ($GroupName1 == "") ? "" : "[Users].[GroupName] = '".$GroupName1."'";
	...
	foreach ($row_all_user as $rows)
	{
		...
		VALUES (NULL, '".$rows["cUserID"]."', '".$GroupName1."', '".$GroupName2."', '".$loggedin["username"]."', NOW());";
		mysql_query($sql_log, $conn);
		
		
		$query_bw = "UPDATE [dbo].[Users] SET [GroupName] = '".$GroupName2."' WHERE [Users].[UserIndex] = '".$rows["UserIndex"]."'";
