                                    ...
                                    <div class="box-body">
										...
										<div class="row">
											...
											<div class="col-xs-3">
												...
												<input class="form-control" readonly="" name="nama_teknisi_2" placeholder="Nama Teknisi" type="text" value="'.(isset($_GET['id']) ? $data_jawab_spk_aktivasi_konversi_teknisi_2['cNama'] :"") .'">
											</div>
											<div class="col-xs-3">
											...
											<div class="col-xs-3">
												...
												<input class="form-control" readonly="" name="nama_teknisi_4" placeholder="Nama Teknisi" type="text" value="'.(isset($_GET['id']) ? $data_jawab_spk_aktivasi_konversi_teknisi_4['cNama'] :"") .'">
											</div>
										</div>
										</div>
										...
										<div class="row">
											...
											<div class="col-xs-3">
												<input class="form-control" readonly="" name="id_teknisi_3" type="hidden" value="'.(isset($_GET['id']) ? $row_jawab_spk_aktivasi_konversi['id_teknisi_3'] :"") .'">
													<input class="form-control" readonly="" name="nama_teknisi_3" placeholder="Nama Teknisi" type="text" value="'.(isset($_GET['id']) ? $data_jawab_spk_aktivasi_konversi_teknisi_3['cNama'] :"") .'">
											</div>
											<div class="col-xs-3">
											...
											<div class="col-xs-3">
												...
												<input class="form-control" readonly="" name="nama_teknisi_5" placeholder="Nama Teknisi" type="text" value="'.(isset($_GET['id']) ? $data_jawab_spk_aktivasi_konversi_teknisi_5['cNama'] :"") .'">
											</div>
										</div>
										</div>
