...
include ("../../config/configuration_admin.php");
    ...
    $id_spk_pasang_konversi	        = isset($_GET['id']) ? mysql_real_escape_string(strip_tags(trim($_GET['id']))) : "";
    $sql_spk_pasang_konversi	= mysql_query("SELECT * FROM `gx_spk_pasang_konversi` WHERE  `gx_spk_pasang_konversi`.`id_spk_pasang_konversi` = '$id_spk_pasang_konversi'", $conn);
    ...
    $row_spk        = mysql_fetch_array($sql_spk_pasang_konversi);
...
<table width="860" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#333333">
  ...
  <tr>
    <td><table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td width="221" ><img src="http://www.globalxtreme.net/new/payment/img/logoweb.png" width="221" height="51"></td>
      ...
      <tr>
        ...
        <td width="700" colspan="2"> <br /><table width="700" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td width="10" valign="top">:</td>
            <td width="275" valign="top"><strong>'.$row_spk["kode_spk_pasang_konversi"].'</strong></td>
          </tr>
          <tr>
        ...
        <td colspan="2"><table width="800" align="center" cellpadding="0" cellspacing="0" style="padding-left: 50px;padding-top: 20px;">
         <tr>
          ...
          <tr>
            ...
            <td valign="top">:</td>
            <td valign="top"><strong> Pasang Konversi </strong></td>
          </tr>
          <tr>
