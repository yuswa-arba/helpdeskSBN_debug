...
$jumlah_table_trouble_ticket_upd = mysql_num_rows(mysql_query("SELECT * FROM `gx_helpdesk_complaint` WHERE `trouble_ticket` = '1' AND `date_upd`>='$waktu_mins' AND `date_upd`<= NOW() AND `date_add` != `date_upd`", $conn));
