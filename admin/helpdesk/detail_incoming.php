...
if ($loggedin = logged_inAdmin()) { // Check if they are logged in
    ...
    if ($loggedin["group"] == 'admin') { // jika yang login adalah admin
        ...
        enableLog("", $loggedin["username"], $loggedin["id_employee"], "Open Detail Incoming"); // for create log in newfunction2.php
	                                ...
	                                <fieldset>
		                                <div class="table-container table-form">
                                            ...
                                            <table class="form" width="100%">
                                                <tbody>
                                                    <tr>
                                                        <td colspan="2" ><legend>Detail Complaint:</legend></td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="2"></td>
                                                    </tr>
                                                    <tr>
                                                        <td width="15%"><label>Media Complaint</label></td>
                                                        <td width="85%">
