...
if ($loggedin = logged_inAdmin()) { // Check if they are logged in
    ...
    if ($loggedin["group"] == 'admin') {
		        ...
		        <div class="row">
			        <div class="col-xs-12">
                        <ul class="nav nav-tabs" role="tablist" id="myTab">
                            <li role="presentation" class="active"><a href="#customer" aria-controls="customer" role="tab" data-toggle="tab">Data Customer</a></li>
                            <li role="presentation"><a href="#complaint" aria-controls="complaint" role="tab" data-toggle="tab">Complaint</a></li>
                            <li role="presentation"><a href="#spk" aria-controls="spk" role="tab" data-toggle="tab">Detail SPK</a></li>
                            <li role="presentation"><a href="#jawabspk" aria-controls="jawabspk" role="tab" data-toggle="tab">History Jawab SPK</a></li>
                        </ul>
        ...
        $content .= '
                        ...
                        <div role="tabpanel" class="tab-pane" id="spk">
                            <div class="box">
                                <div class="box-header">
        ...
        if ($row_user["cKode"] != "") {
            ...
            while ($row_spk = mysql_fetch_array($query_history_spk)) {
                $sql_tech = "SELECT * FROM `gx_pegawai`
        ...
        $content .= '
                        ...
                        <div role="tabpanel" class="tab-pane" id="jawabspk">
                            <div class="box">
                                <div class="box-header">
