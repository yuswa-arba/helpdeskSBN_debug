...
try {
   ...
   $mail->SetFrom( $from, 'GlobalXtreme Helpdesk');
   //$mail->AddCC('cso@globalxtreme.net', 'GlobalXtreme Helpdesk');
   $mail->AddCC($email_cc);
 ...
 //echo date("Y-m-d H:i:s");
    ...
    $content ='<section class="content-header">
		...
		<td>
		    <div class="box-body pad">
			<textarea name="footer" rows="6" cols="50" id="editor2" style="resize: none;">Best Regards,<br><br>

'.ucfirst($loggedin["username"]).'<br><br><br>
