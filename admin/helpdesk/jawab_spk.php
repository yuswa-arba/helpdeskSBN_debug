...
if ($loggedin = logged_inAdmin()) { // Check if they are logged in
    ...
    if ($loggedin["group"] == 'admin') { // jika yang login adalah admin
        ...
        $save = isset($_POST["save_spk"]) ? $_POST["save_spk"] : ""; // menambil nilai/string yang ada pada url
        ...
        $data_spk = mysql_fetch_array(mysql_query("SELECT `gx_helpdesk_spk`.*, `gx_helpdesk_complaint`.`phone`, `gx_helpdesk_complaint`.`email`, `gx_pegawai`.`nama`,
			...
			AND `gx_helpdesk_spk`.`id_teknisi` = '0'
			AND `gx_helpdesk_spk`.`level` = '0'
			AND `gx_helpdesk_spk`.`id_spk` = '$id';", $conn));
                                        ...
                                        <table class="form">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <input name="name_technician" class="form-control" placeholder="Technician" type="text" value="' . (isset($_GET["id_spk"]) ? $data_spk["nama"] : "") . '" readonly="" style="width:350px;">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colspan="2"></td>
                                            ...
                                            <tr>
                                                ...
                                                <td> 
                                                    <input class="form-control" name="id_complaint" placeholder="id complaint" type="hidden" value="' . (isset($_GET["id_spk"]) ? $data_spk["id_complaint"] : "") . '" readonly="" >
                                            ...
                                            <tr style="vertical-align: middle;">
                                                <td style="vertical-align: middle;"><label>Solusi</label></td>
                                                <td>
