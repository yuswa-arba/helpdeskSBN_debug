 ...
 //echo date("Y-m-d H:i:s");   
	...
	<div >
		...
		<div class="table-container table-form">
		    <!--<a href="'.URL_ADMIN.'helpdesk/data_cust.php?r=form_troubleticket" class="btn btn-sm bg-navy btn-flat margin pull-right"
						onclick="return valideopenerform(\''.URL_ADMIN.'helpdesk/data_cust.php?r=form_troubleticket\',\'troubleticket\');">Search Customer</a>
		    <br>-->
