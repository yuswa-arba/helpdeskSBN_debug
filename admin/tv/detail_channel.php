...
if($loggedin["group"] == 'admin'){
    ...
    $perhalaman = 20;
	 ...
	 $sql_provider		= mysqli_query($conn, "SELECT `id_provider` FROM `gx_tv_channel_provider` WHERE `id_channel` = '".$id_channel."' LIMIT 0, 1;");
                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">List Data '.$row_channel["channelName"].'</h3>                                    
                                </div><!-- /.box-header -->
