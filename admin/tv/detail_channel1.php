...
if($loggedin["group"] == 'admin'){
	...
	if(isset($_POST["hapus"]))
    {
        ...
        {
            $sql_update = mysql_query("UPDATE `gx_tv_channel_provider` SET `level` = '1', `date_upd` = NOW() WHERE `id_channel_provider` = '".$value."';", $conn) or die (mysql_error());
        }
...
$content = '<!-- Content Header (Page header) -->
		    ...
		    <div class="row">
			    ...
			    <div class="box">
				<div class="box-body">
				    <a href="form_channel.php?id='.$id.'" class="btn bg-maroon btn-flat margin">Add Channel</a>
				</div>
			    </div>
			</div>
		    </div>
                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">List Channel ('.$row_data_provider["nama"].')</h3>                                    
                                </div><!-- /.box-header -->
...
//select data
	...
	$content .='<tr>
			<td>'.$no.'.</td>
			<td><a href="data_subscriber.php?id='.$row_data["id_channel"].'">'.$row_data_tv["channelName"].'</a></td>
