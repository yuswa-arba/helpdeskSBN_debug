...
//SELECT
    ...
    $select_all_data_valid = "SELECT * FROM `gx_kontrak` WHERE `level` =  '0'";
...
//UPDATE
    ...
    //$sql_update_lock 
    $table_update_lock = "gx_kontrak";
    $redirect_action_lock = "master_kontrak";
...
//String Data View
    //Judul Form
    $judul_form = "Kontrak";
    $link_form_add_data = '<a href="form_kontrak.php" class="btn bg-maroon btn-flat margin">Create Kontrak</a><a href="form_perpanjangan_kontrak.php" class="btn bg-maroon btn-flat margin">Create Perpanjangan Kontrak</a><a href="master_perpanjangan_kontrak.php" class="btn bg-maroon btn-flat margin">Master Perpanjangan Kontrak</a>';
    $judul_table = "List Data Kontrak";
    $data_field = array("No. Kontrak", "Cabang", "Nama Customer", "Lama Kontrak", "Tanggal");
    $data_sql_field = array("kode_kontrak", "nama_cabang", "nama_customer", "lama_kontrak", "tanggal");
    $index_field_sql = "id";
