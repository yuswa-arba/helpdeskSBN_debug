...
}elseif(isset($_POST["update"]))
{
	...
	$sql_update = "UPDATE `gx_perpanjangan_kontrak` SET `kode_kontrak`='$kode_kontrak',`kode_cabang`='$kode_cabang',`nama_cabang`='$nama_cabang',`kode_customer`='$kode_customer',`nama_customer`='$nama_customer',`lama_kontrak`='$lama_kontrak',`periode_kontrak_mulai`='$periode_kontrak_mulai',`periode_kontrak_akhir`='$periode_kontrak_akhir',`user_upd`='".$loggedin['username']."',`date_upd`=NOW() WHERE `id`='$id'";
    ...
    $content = '<section class="content-header">
                ...
                <section class="content">
					...
					$content.=' <div class="col-xs-2">
					    ...
					    <div class="col-xs-3">
						<input type="text" readonly="" class="form-control" required="" name="kode_perpanjangan_kontrak" value="'.(isset($_GET['id']) ? $row["kode_perpanjangan_kontrak"] : "PK-".rand(0000000, 9999999) ).'">
					    </div>';
				    ...
				    <div class="col-xs-2">
					    ...
					    <div class="col-xs-3">
						<input type="text" readonly="" class="form-control" required="" name="kode_kontrak" value="'.(isset($_GET['id']) ? $row["kode_kontrak"] : "" ).'" onclick="return valideopenerform(\'data_kontrak.php?r=form_perpanjangan_kontrak&f=data_kontrak\',\'kontrak\');">
					    </div>
					    ...
					    <div class="col-xs-3">
						<input type="text" class="form-control" readonly="" required="" name="nama_cabang" id="nama_cabang" value="'.(isset($_GET['id']) ? $row["nama_cabang"] : '').'" onclick="return valideopenerform(\'data_cabang.php?r=form_perpanjangan_kontrak&f=data_cabang\',\'cabang\');">
