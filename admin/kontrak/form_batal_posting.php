...
//INSERT 
    ...
    $url_redirect_insert = "master_batal_posting";
...
//UPDATE
    ...
    $redirect_update_data = "master_batal_posting";
...
//String Data View
    //Judul Form
    $judul_form = "Batal Posting";
    $header_form = "Data Batal Posting";
    $index_field_sql = "id";
    $unix_field_sql = "kode_batal_posting";
    $url_form_detail = "detail_batal_posting";
    $url_form_edit = "form_batal_posting";
    
    $form_name = "form_batal_posting";
    $form_id = "";
    
    //id web
    $title_header = 'Master Batal Posting';
    $submenu_header = 'master_batal_posting';
...
if(isset($_POST["save"]))
{
    ...
    $kode_batal_posting					= isset($_POST['kode_batal_posting']) ? mysql_real_escape_string(trim($_POST['kode_batal_posting'])) : '';
    $nama_batal						= isset($_POST['nama_batal']) ? mysql_real_escape_string(trim($_POST['nama_batal'])) : '';
    $kode_batal						= isset($_POST['kode_batal']) ? mysql_real_escape_string(trim($_POST['kode_batal'])) : '';
    $alasan_batal					= isset($_POST['alasan_batal']) ? mysql_real_escape_string(trim($_POST['alasan_batal'])) : '';
    $data_asli						= isset($_POST['data_asli']) ? mysql_real_escape_string(trim($_POST['data_asli'])) : '';
    $data_baru						= isset($_POST['data_baru']) ? mysql_real_escape_string(trim($_POST['data_baru'])) : '';
    
    if($kode_batal_posting != ""){
...
}elseif(isset($_POST["update"]))
{
	...
	$sql_update = "UPDATE `gx_batal_posting` SET `date_upd`=NOW(),`level`='1',`user_upd`='$loggedin[username]' WHERE `kode_batal_posting`='$c'";
	$sql_insert = "INSERT INTO `gx_batal_posting`(`id`, `kode_batal_posting`, `nama_batal`, `kode_batal`, `alasan_batal`, `data_asli`, `data_baru`, `date_add`, `date_upd`, `level`, `user_add`, `user_upd`)
	VALUES (NULL,'$kode_batal_posting','$nama_batal','$kode_batal','$alasan_batal','$data_asli','$data_baru',NOW(),NOW(),'0','".$loggedin['username']."','".$loggedin['username']."')";
...
if(isset($_GET["c"]))
{
    ...
    $query 	= "SELECT * FROM `".$table_main."` WHERE  `".$unix_field_sql."` ='".$c."' LIMIT 0,1"; 
    ...
    $content = '<section class="content-header">
                ...
                <section class="content">
				    ...
				    $content.=' <div class="col-xs-2">
					    ...
					    <div class="col-xs-3">
						<input type="text" readonly="" class="form-control" required="" name="kode_batal_posting" value="'.(isset($_GET['c']) ? $row["kode_batal_posting"] : "BP-".rand(0000000, 9999999) ).'">
					    </div>';
					...
					$content .= '
					    ...
					    <div class="col-xs-3">
						<input type="text" readonly="" class="form-control" required="" name="nama_batal" value="'.(isset($_GET['c']) ? $row["nama_batal"] : $loggedin['username']).'">
					    </div>
                                        </div>
					</div>
					...
					<div class="row">
					    ...
					    <div class="col-xs-3">
						<input type="text"  class="form-control" name="kode_batal" value="'.(isset($_GET['c']) ? $row["kode_batal"] : '').'">
					    </div>
					...
					<div class="row">
					    ...
					    <div class="col-xs-8">
						<textarea class="form-control" required="" name="alasan_batal" id="alasan_batal">'.(isset($_GET['c']) ? $row["alasan_batal"] : '').'</textarea>
					    </div>
					...
					<div class="row"> 
					    ...
					    <div class="col-xs-8">
						<textarea class="form-control"  required="" name="data_asli" id="data_asli">'.(isset($_GET['c']) ? $row["data_asli"] : '').'</textarea>
					    </div>
					</div>
					</div>
					...
					<div class="row">
					    ...
					    <div class="col-xs-8">
						<textarea class="form-control"  required="" name="data_baru">'.(isset($_GET['c']) ? $row["data_baru"] : '').'</textarea>
					    </div>
