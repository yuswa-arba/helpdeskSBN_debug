...
//SQL 
$table_main = "gx_pengeluaran_barang";
$table_detail = "";

//SELECT 
    $urutan = "ORDER BY `id_pengeluaran_barang` DESC";
    $select_all_data_valid = "SELECT * FROM `gx_pengeluaran_barang` WHERE `level` =  '0'";

//INSERT 

//UPDATE
    //$sql_update_lock 
    $table_update_lock = "gx_pengeluaran_barang";
    $redirect_action_lock = "master_pengeluaran_barang.php";
...
//String Data View
    //Judul Form
    $judul_form = "Detail Kontrak";
    $judul_table = "detail kontrak";
    
    //id web
    $title_header = 'Detail Kontrak';
    $submenu_header = 'detail_kontrak';
...
if($loggedin["group"] == 'admin'){
    ...
    $sql_d = "SELECT * FROM `gx_kontrak` WHERE `kode_kontrak`='$c_d'";
	...
	$lama_kontrak			= $data_d['lama_kontrak'];
