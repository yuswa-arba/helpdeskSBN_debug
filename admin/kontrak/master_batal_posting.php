...
//UPDATE
    ...
    $redirect_action_lock = "master_batal_posting";
...
//String Data View
    ...
    $link_form_add_data = '<a href="form_batal_posting.php" class="btn bg-maroon btn-flat margin">Create New</a>';
    $judul_table = "List Data Batal Posting";
    $data_field = array("No. Batal Posting", "Nama Batal", "Kode yang ingin dibatal", "Alasan Batal");
    $data_sql_field = array("kode_batal_posting", "nama_batal", "kode_batal", "alasan_batal");
    $index_field_sql = "id";
...
if($loggedin["group"] == 'admin'){
    enableLog("", $loggedin["username"], $loggedin["id_employee"], "Open Master Batal Posting");
    global $conn;
...
if(isset($_GET["c"]) & isset($_GET["action"]))
{
	...
	$sql_update_lock = "UPDATE `$table_main` SET `status`='1' WHERE `kode_batal_posting`='".$c."';";
