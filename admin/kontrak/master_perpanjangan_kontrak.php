...
//SELECT
    ...
    $select_all_data_valid = "SELECT * FROM `gx_perpanjangan_kontrak` WHERE `level`='0'";
...
//UPDATE
    ...
    //$sql_update_lock 
    $table_update_lock = "gx_perpanjangan_kontrak";
    $redirect_action_lock = "master_perpanjangan_kontrak";
...
//String Data View
    ...
    //$link_form_add_data = '<a href="form_kontrak.php" class="btn bg-maroon btn-flat margin">Create Kontrak</a><a href="form_perpanjangan_kontrak.php" class="btn bg-maroon btn-flat margin">Create Perpanjangan Kontrak</a><a href="master_kontrak.php" class="btn bg-maroon btn-flat margin">Master Kontrak</a>';
    $link_form_add_data = '<a href="form_perpanjangan_kontrak.php" class="btn bg-maroon btn-flat margin">Create Perpanjangan Kontrak</a>';
    $judul_table = "List Data Perpanjangan Kontrak";
    $data_field = array("No. Perpanjangan Kontrak", "No. Kontrak", "Cabang", "Nama Customer", "Lama Kontrak", "Tanggal");
    $data_sql_field = array("kode_perpanjangan_kontrak", "kode_kontrak", "nama_cabang", "nama_customer", "lama_kontrak", "tanggal");
    $index_field_sql = "id";
...
if(isset($_GET["id"]) & isset($_GET["action"]))
{
	...
	$sql_update_lock = "UPDATE `$table_main` SET `level`='1', `date_upd` = NOW(), `user_upd` = '".$loggedin["username"]."'  WHERE `".$index_field_sql."`='".$id."'";
	
	//echo $sql_update_lock;
	mysql_query($sql_update_lock, $conn) or die (mysql_error("data belum terupdate"));
	//log
