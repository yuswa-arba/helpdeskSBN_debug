...
//SELECT
    ...
    $select_all_data_valid = "SELECT * FROM `gx_perpanjangan_kontrak`";
...
//select data
	...
	$content .= '<tr>
			...
			$content .= '
			<td>'.(($row_data["level"] == "1") ? '
					<a href="'.$url_form_detail.'?id='.$row_data[$index_field_sql].'"><span class="label label-info">Detail</span></a>'
			       :
				   '<a href="'.$url_form_detail.'?id='.$row_data[$index_field_sql].'"><span class="label label-info">Detail</span></a>
