...
//UPDATE
    ...
    $redirect_action_lock = "master_gaji";
...
//String Data View
    //Judul Form
    $judul_form = "Master Gaji";
    $link_form_add_data = '<a href="form_gaji.php" class="btn bg-maroon btn-flat margin">Create New</a>';
    $judul_table = "List Data Gaji";
    $data_field = array("Gaji Pokok", "Tunjangan Jabatan", "Dana Pensiun", "Jamsostek", "Insentif Hadir", "Bonus Bulanan", "Potongan Absen Per Hari");
    $data_sql_field = array("A1", "A2", "A3", "A4", "A5", "A6", "A7");
    $index_field_sql = "id_master_gaji";
    $unix_field_sql = "id_master_gaji";
    $url_form_detail = "detail_gaji";
    $url_form_edit = "form_gaji";
    
    
    //id web
    $title_header = 'Master Gaji';
    $submenu_header = 'master_gaji';
    
    
if($loggedin["group"] == 'admin'){
    enableLog("", $loggedin["username"], $loggedin["id_employee"], "Open Master Gaji");
    global $conn;
