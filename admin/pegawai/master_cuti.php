...
//SQL 
$table_main = "gx_master_cuti";
$table_detail = "";

//SELECT
    //SELECT `id_cuti`, `tahun`, `bulan`, `masa_kerja`, `limit_karyawan_cuti`, `jumlah_limit_per_divisi`, `remarks`, `tanggal`, `date_add`, `date_upd`, `user_add`, `user_upd`, `level` FROM `gx_master_cuti` WHERE 1
    $urutan = "ORDER BY `id_cuti` DESC";
    $select_all_data_valid = "SELECT * FROM `gx_master_cuti` WHERE `level`='0'";
...
//UPDATE
    ...
    //$sql_update_lock 
    $table_update_lock = "gx_master_cuti";
    $redirect_action_lock = "master_cuti";
...
//String Data View
    //Judul Form
    $judul_form = "Master Cuti";
    $link_form_add_data = '<a href="form_cuti.php" class="btn bg-maroon btn-flat margin">Create New</a>';
    $judul_table = "List Data Cuti";
    $data_field = array("Tahun", "Bulan", "Masa Kerja", "Limit Karyawan Cuti", "Jumlah Limit per Divisi");
    $data_sql_field = array("tahun", "bulan", "masa_kerja", "limit_karyawan_cuti", "jumlah_limit_per_divisi");
    $index_field_sql = "id_cuti";
    $unix_field_sql = "id_cuti";
    $url_form_detail = "detail_cuti";
    $url_form_edit = "form_cuti";
    
    
    //id web
    $title_header = 'Master Cuti';
    $submenu_header = 'master_cuti';
