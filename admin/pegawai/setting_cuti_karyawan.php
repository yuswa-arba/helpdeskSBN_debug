...
$plugins = '<!-- datepicker -->
	...
	<link href="'.URL.'js/fullcalendar/fullcalendar.css" rel="stylesheet" />
	<link href="'.URL.'js/fullcalendar/fullcalendar.print.css" rel="stylesheet" media="print" />
	...
	<script>
		...
		$(document).ready(function() {
			...
			$(\'#calendar\').fullCalendar({
				...
				events: {
					url: \''.URL.'js/fullcalendar/demos/php/get-events.php\',
					error: function() {
						$(\'#script-warning\').show();
					}
				},
