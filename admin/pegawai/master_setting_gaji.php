...
//SQL 
$table_main = "gx_master_acc_kenaikan_gaji";
$table_detail = "";
...
//SELECT
    ...
    $urutan = "ORDER BY `id_acc_kenaikan_gaji` DESC";
    $select_all_data_valid = "SELECT * FROM `gx_master_acc_kenaikan_gaji` WHERE `level`='0'";
...
//UPDATE
    ...
    //$sql_update_lock 
    $table_update_lock = "gx_master_acc_kenaikan_gaji";
    $redirect_action_lock = "master_acc_kenaikan_gaji";
...
//String Data View
    //Judul Form
    $judul_form = "Master ACC Kenaikan Gaji";
    $link_form_add_data = '<a href="form_acc_kenaikan_gaji.php" class="btn bg-maroon btn-flat margin">Create New</a>';
    $judul_table = "List Data ACC Kenaikan Gaji";
    $data_field = array("Nama", "No ACC", "Tanggal", "Total Gaji Lama", "Total Gaji Kenaikan");
    $data_sql_field = array("nama", "no_acc_kenaikan_gaji", "tanggal", "total_gaji_lama", "total_gaji_naik");
    $index_field_sql = "id_acc_kenaikan_gaji";
    $unix_field_sql = "id_acc_kenaikan_gaji";
    $url_form_detail = "detail_acc_kenaikan_gaji";
    $url_form_edit = "form_acc_kenaikan_gaji";
    
    
    //id web
    $title_header = 'Master ACC Kenaikan Gaji';
    $submenu_header = 'master_acc_kenaikan_gaji';
    
    
if($loggedin["group"] == 'admin'){
    enableLog("", $loggedin["username"], $loggedin["id_employee"], "Open Master ACC Kenaikan Gaji");
    global $conn;
