...
//SELECT
    ...
    $urutan = "ORDER BY `id_kenaikan_gaji` DESC";
...
//UPDATE
    ...
    $redirect_action_lock = "master_kenaikan_gaji";
...
//String Data View
    //Judul Form
    $judul_form = "Master Kenaikan Gaji";
    $link_form_add_data = '<a href="form_kenaikan_gaji.php" class="btn bg-maroon btn-flat margin">Create New</a>';
    $judul_table = "List Data Kenaikan Gaji";
    $data_field = array("Nama", "Tanggal", "Total Gaji Lama", "Total Gaji Kenaikan");
    $data_sql_field = array("nama", "tanggal", "total_gaji_lama", "total_gaji_naik");
    $index_field_sql = "id_kenaikan_gaji";
    $unix_field_sql = "id_kenaikan_gaji";
    $url_form_detail = "detail_kenaikan_gaji";
    $url_form_edit = "form_kenaikan_gaji";
    
    
    //id web
    $title_header = 'Master Kenaikan Gaji';
    $submenu_header = 'kenaikan_gaji';
    
    
if($loggedin["group"] == 'admin'){
    enableLog("", $loggedin["username"], $loggedin["id_employee"], "Open Master Kenaikan Gaji");
    global $conn;
