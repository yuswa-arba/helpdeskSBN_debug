...
//INSERT 
    ...
    $url_redirect_insert = "master_generate_va";
...
//UPDATE
    ...
    $redirect_update_data = "master_generate_va";
    ...
    $content = '<section class="content-header">
                ...
                <section class="content">
				    ...
				    $content.=' <div class="col-xs-2">
						<label>Upload File VA</label>
					    </div>
					    <div class="col-xs-3">
						<input type="file" readonly="" class="form-control" required="" name="file">
						<input type="hidden" readonly="" class="form-control" required="" name="c" value="'.(isset($_GET['c']) ? $row["id_table"] : '').'">
					    </div>
                                        </div>
					</div>
