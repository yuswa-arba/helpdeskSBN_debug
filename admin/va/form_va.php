...
if($loggedin = logged_inAdmin()){ // Check if they are logged in
    ...
    enableLog("", $loggedin["username"], $loggedin["id_employee"], "create new form Master VA");
    ...
    $content ='
                ...
                <section class="content">
                        ...
                        <div class="col-xs-8">
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">Form Master VA</h3>
                                </div><!-- /.box-header -->
                                <!-- form start -->
					...
					<div class="row">
					    ...
					    <div class="col-xs-8">
						<input type="text"  class="form-control" required="" name="nama_va" value="">
					...
					<div class="row">    
					    ...
					    <div class="col-xs-3">
						<input type="text" readonly="" class="form-control" required="" name="kode_bank1" value="" onclick="return valideopenerform(\'data_bank.php?r=form_master_va&f=va\',\'bank\');">
					    </div>
						<div class="col-xs-5">
