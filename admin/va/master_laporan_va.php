...
if($loggedin["group"] == 'admin'){
    enableLog("", $loggedin["username"], $loggedin["id_employee"], "Open Master Laporan Virtual Account");
    global $conn;
                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">Laporan Virtual Account</h3>                                    
                                </div><!-- /.box-header -->
...
$plugins = '<link type="text/css" rel="stylesheet" href="'.URL.'css/gx_pagination.css" />';
    ...
    $title	= 'Master Laporan Virtual Account';
    $submenu	= "laporan_va";
    //$plugins	= '';
