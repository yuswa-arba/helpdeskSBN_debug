...
if ($loggedin = logged_inAdmin()) { // Check if they are logged in
    ...
    if ($loggedin["group"] == 'admin') { // jika yang login adalah admin
        ...
        if (isset($_GET["id"])) {
            ...
            $query_menu = "SELECT * FROM `v_menu` WHERE `id_role`='" . $id_menu . "' LIMIT 0,1;";
                            ...
                            <form role="form" method="POST" action="">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-xs-4">
                                                <label>Dapat diakses di</label>
                                            </div>
                                            <div class="col-xs-8">
                                                <input type="text" class="form-control" readonly="" name="menu" value="' . (isset($_GET['id']) ? $row_menu["group_nama"] : "") . '">
                                            </div>
                                        </div>
                                    </div>
