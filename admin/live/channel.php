        ...
        while ($row_data = mysqli_fetch_array($sql_data)) {
            $content .= '
                <tr>
                    ...
                    <td>' . $row_data["islock"] . '</td>
                    <td>' . $row_data["icon"] . '</td>
                    <td>' . $row_data["referencePrice"] . '</td>
                    <td><a href="detail_channel.php?id=' . $row_data["channelId"] . '" onclick="return valideopenerform(\'detail_channel.php?id=' . $row_data["channelId"] . '\',\'channel\');">Details</a>  ||
                    <a href="form_channel.php?id=' . $row_data["channelId"] . '">edit</a></td>
                    <td><input type="checkbox" name="channelId[]" value="' . $row_data["channelId"] . '"></td>
                </tr>';
            $no++;
        }
