                ...
                <section class="content">
					...
					<div class="row">
						...
						<option value="">--Pilih Kota--</option>';
							...
							$sql_kota	= mysql_query("SELECT DISTINCT `kabupaten` FROM `gx_master_kota` ORDER BY `kabupaten`;", $conn);
							while($data = mysql_fetch_array($sql_kota)){
								 $content .= '<option value="'.$data['kabupaten'].'">'.$data['kabupaten'].'</option>';
							}
						 $content .= '</select>
					    ...
					    <div class="col-xs-4">
							<select name="kecamatan" id="kecamatan" style="width: 300px;">
					...
					<div class="row">
					    ...
					    <div class="col-xs-4">
						<select name="kelurahan" id="kelurahan" style="width: 300px;">
					    ...
					    <div class="col-xs-4">
						<select name="kode_pos" id="kodepos" style="width: 300px;">
					...
					<div class="row">
					    ...
					    <div class="col-xs-4">
						<input type="text" readonly="" required="" class="form-control" name="nama_marketing" value="'.(isset($_GET["id_prospek"]) ? $data_prospek['marketing'] :"") .'" > <a href="data_marketing.php?r=myForm" onclick="return valideopenerform(\'data_marketing.php?r=myForm\',\'cust\');">Search Employee</a>
		...
		$(function() {
			 ...
			 $("#kota").change(function(){
			  ...
			  $("#kecamatan").change(function(){
				var gkecamatan = $("#kecamatan").val();
				$.ajax({
					url: "getkelurahan.php",
					data: "gkecamatan="+gkecamatan,
					cache: false,
					success: function(msg){
						$("#kelurahan").html(msg);
					}
			  ...
			  $("#kelurahan").change(function(){
				var gkelurahan = $("#kelurahan").val();
				$.ajax({
					url: "getkodepos.php",
					data: "gkelurahan="+gkelurahan,
					cache: false,
					success: function(msg){
						$("#kodepos").html(msg);
					}
