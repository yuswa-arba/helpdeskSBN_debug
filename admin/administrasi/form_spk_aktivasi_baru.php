...
if ($loggedin = logged_inAdmin()) { // Check if they are logged in
    ...
    if ($loggedin["group"] == 'admin') { // jika yang login adalah admin
        ...
        if (isset($_POST["save"])) {
            ...
            if ($kode_spkaktivasi != "" AND $id_linkbudget != "") {
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-xs-3">
                                                <input type="text" readonly="" class="form-control" id="kode_spkaktivasi" name="kode_spkaktivasi" required="" value="' . (isset($_GET['id']) ? $row_spk_aktivasi["kode_spkaktivasi"] : $kode_cabang) . '">
                                            </div>
                                            <div class="col-xs-3">
                                                <label>Tanggal</label>
                                            </div>
