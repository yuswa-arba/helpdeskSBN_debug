    ...
    $content = '
			...
			<section class="col-lg-9"> 
					...
					<div class="row">
					    ...
					    <div class="col-xs-3">
						'.$row_periksa_pembelian["nama_cabang"].'
					    </div>
					...
					<div class="row">
					    ...
					    <div class="col-xs-3">
						'.$row_periksa_pembelian["kode_periksa_pembelian"].'
					    ...
					    <div class="col-xs-3">
						'.$row_periksa_pembelian["user_add"].'
					...
					<div class="row">
					    ...
					    <div class="col-xs-3">
						'.$row_periksa_pembelian["nama_divisi"].'
					    </div>
					...
					<div class="row">
					    ...
					    <div class="col-xs-8">
						'.$row_periksa_pembelian["remarks_permintaanbeli"].'
					    </div>
                                        </div>
					</div>
					...
					<div class="row">
					    ...
					    <div class="col-xs-8">
						'.$row_periksa_pembelian["remarks_periksabeli"].'
					    </div>
                                        </div>
					</div>
