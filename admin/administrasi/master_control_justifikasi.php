...
$content .= '
 <table id="example1" class="table table-bordered table-striped">
    ...
    $sql_total_control_justifikasi	= mysql_num_rows(mysql_query("SELECT * FROM `gx_control_justifikasi`
			    WHERE `id_cabang` = '".$loggedin['cabang']."' AND `level` =  '0'
	...
	$content .='<tr>
			...
			<td>'.$r_control_justifikasi['kontrak'].' bulan</td>
			
			<td><a href="detail_control_justifikasi.php?id='.$r_control_justifikasi["id_control_justifikasi"].'" target="_blank"> View </a> || <a href="form_control_justifikasi.php?id='.$r_control_justifikasi["id_control_justifikasi"].'">edit</a></td>
...
$content .='</tbody>
				...
				<div class="box-footer">
				    ...
				    '.(halaman($sql_total_control_justifikasi, $perhalaman, 1, $hal)).'
				    </div>
				    <br style="clear:both;">
				</div>
                            </div><!-- /.box -->
