    ...
    $content ='
                ...
                <section class="content">
					...
					<div class="row">
					    ...
					    <div class="col-xs-8">
						<input type="text" class="form-control" name="folder_va" value="'.(isset($_GET['id']) ? $row_data["folder_va"] : "").'">
					...
					<div class="row">
					    ...
					    <div class="col-xs-8">
						<input type="text" class="form-control" name="nama_file" value="'.(isset($_GET['id']) ? $row_data["nama_file"] : "").'">
					    </div>
                                        </div>
					</div>
					<div class="form-group">
...
$plugins = '';
    ...
    $title	= 'Download Virtual Account';
    $submenu	= "download_va";
    //$plugins	= '';
