...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-bottom:solid; border-bottom-color:#000">
      <tr>
        <td width="75%"><img src="https://172.16.79.194'.URL.'pdf/logo-inv.png" height="70"></td>
        <td width="25%">
	<table width="248" border="0" align="right" cellpadding="0" cellspacing="0">
            <tr>
              <td colspan="2"><b>'.$row_invoice_config["title"].'</b></td>
	    </tr>
	    <tr>
              <td>Call Center</td>
              <td>'.$row_invoice_config["call_center"].'</td>
            </tr>
	    <tr>
              <td>SMS Gateway</td>
              <td>'.$row_invoice_config["sms_gtw"].'</td>
            </tr>
	    <tr>
              <td>Email</td>
              <td>'.$row_invoice_config["email"].'</td>
            </tr>
	    <tr>
              <td>Payment</td>
              <td>'.$row_invoice_config["instant_payment"].'</td>
            </tr>
	    <tr>
              <td colspan="2">'.$row_invoice_config["website"].'</td>
	    </tr>
	    <tr>
              <td colspan="2">'.$row_invoice_config["lain"].'</td>
	    </tr>
          </table></td>
        </tr>
    </table>
          ...
          <td width="40%">
            <table width="100%" border="0" align="right" cellpadding="0" cellspacing="0">
              ...
              <tr>
                ...
                <td width="67%" bgcolor="#DADADA" style="text-align:right;">'.Rupiah($total_price/10).'</td>
              </tr>
              <tr>
