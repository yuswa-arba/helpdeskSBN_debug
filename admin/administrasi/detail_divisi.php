...
if($loggedin["group"] == 'admin'){
     ...
     if(isset($_GET['id'])){
	  ...
	  $sql_data	= "SELECT * FROM `gx_divisi` WHERE `id_divisi` = '".$id_data."' LIMIT 0,1;";
			 ...
			 <div class="col-xs-12">
			    ...
			    <div class="box">
				   <div class="box-header">
					<h2 class="box-title">Data Divisi</h2>
				   </div>
				   ...
				   <table style="margin-bottom: 0;width:60%">
				     ...
				     <tr>
					 <td>Kode Divisi</td>
					 <td>'.(isset($_GET["id"]) ? $row_data['kode_divisi'] :"").'</td>
				     </tr>
				     <tr>
					 <td>Nama Divisi</td>
					 <td>'.(isset($_GET["id"]) ? $row_data['nama_divisi'] :"").'</td>
				     </tr>
