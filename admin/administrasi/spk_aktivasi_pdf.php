...
$sql_spk = mysql_query("SELECT * FROM `gx_spk_aktivasi` WHERE  `gx_spk_aktivasi`.`id_spkaktivasi` = '$id_spk';", $conn);

$row_spk = mysql_fetch_array($sql_spk);
$sql_teknisi = mysql_query("SELECT `gx_pegawai`.* FROM `gx_pegawai`
    WHERE `gx_pegawai`.`kode_pegawai` = '$row_spk[id_teknisi]';", $conn);

$row_teknisi = mysql_fetch_array($sql_teknisi);
$sql_marketing = mysql_query("SELECT `gx_pegawai`.* FROM `gx_pegawai`
...
$html = '
<div style="top:0;margin-bottom:20px;">
        ...
        <tr>
            <td>
                <table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <td colspan="2">
                            <table width="800" align="center" cellpadding="0" cellspacing="0" style="padding-left: 50px;padding-top: 20px;">
                               <tr>
                    ...
                    <tr>
                        <td colspan="2">
                            <table width="800" align="center" cellpadding="15px" cellspacing="0" >
                                <tr>
