...
if(isset($_GET['id'])){
    ...
    $sql_data	= "SELECT * FROM `gx_cetak_barcode` WHERE `id_cetak` = '".$id_data."';";
    ...
    $content ='<!-- Main content -->
                <section class="content">
					...
					<div class="row">
						...
						onclick="return valideopenerform(\'data_cabang.php?r=cetak_barcode&f=cetak\',\'cabang\');">
						<input type="hidden" readonly="" class="form-control" name="id_cabang" id="id_cabang" value="'.(isset($_GET["id"]) ? $row_data_cabang['id_cabang'] :"").'">
						<input type="hidden" readonly="" class="form-control" name="id_cetak" id="id_cetak" value="'.(isset($_GET["id"]) ? $row_data_cabang['id_cetak'] :"").'">
					    </div>
                                        </div>
					</div>
					<div class="form-group">
					<div class="row">
					    ...
					    <div class="col-xs-9">
						<input type="text" readonly="" class="form-control" id="kode_barang" name="kode_barang" value="'.(isset($_GET["id"]) ? $row_data['kode_barang'] :"").'"
					...
					<div class="row">    
					    ...
					    <div class="col-xs-9">
						<input type="text" class="form-control" readonly="" name="barcode" value="'.(isset($_GET["id"]) ? $row_data["barcode"] :"").'">
					    </div>
                                        </div>
					</div>
					<div class="form-group">
