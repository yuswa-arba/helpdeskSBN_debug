...
*/   
    $content ='
		...
		<table class="form" width="80%">
			...
			<td>
			  <input class="form-control" name="cNama" placeholder="Nama" type="text" value="">
			</td>
		      </tr>
		      <tr>
			<td>
...
$no = 1;
 ...
 $content .='<tr>
		    ...
		    <td>'.$row_customer["cAlamat1"].'</td>
                    <td>
                      <a href="" onclick="validepopupform2(\''.mysql_real_escape_string($row_customer["cKode"]).'\',';
		      $content .='\''.mysql_real_escape_string($row_customer["cUserID"]).'\',';
		      $content .='\''.mysql_real_escape_string($row_customer["cNama"]).'\',';
		      $content .='\''.mysql_real_escape_string($row_customer_cabang["id_cabang"]).'\',';
			  $content .='\''.mysql_real_escape_string($row_customer_cabang["nama_cabang"]).'\',';
		      $content .='\''.mysql_real_escape_string($row_customer["cKdPaket"]).'\',';
		      $content .='\''.mysql_real_escape_string($row_customer["cPaket"]).'\',';
		      $content .='\''.mysql_real_escape_string($row_customer["ctelp"]).'\',';
		      $content .='\''.mysql_real_escape_string($row_customer["cAlamat1"]).'\',';
		      $content .='\''.mysql_real_escape_string($row_customer["cSales"]).'\')">Select</a>
                    </td>
                  </tr>';
	$no++;
    }
...
<script type="text/javascript">
 	function validepopupform2(f_idcustomer, f_user_id, f_namacustomer, f_id_cabang, f_nama_cabang, f_paket_koneksi, f_nama_koneksi, f_telpon, f_alamat, f_sales){
		...
		window.opener.document.'.$return_form.'.nama_customer.value=f_namacustomer;
		...
		window.opener.document.'.$return_form.'.nama_marketing.value=f_sales;
		self.close();
        }
</script>
