...
if(isset($_GET["c"]))
{
    ...
    $query_data 	= "SELECT * FROM `gx_retur_barang`
			    WHERE `kode_retur` = '".$kode_data."' LIMIT 0,1;";
    ...
    $content = '
			...
			<section class="col-lg-12"> 
					...
					<div class="row">
					    ...
					    <div class="col-xs-3">
						<input type="text" readonly="" class="form-control" required="" name="kode_retur" value="'.(isset($_GET["c"]) ? $row_data["kode_retur"] : $kode_pinjam).'">
						<input type="hidden" readonly="" class="form-control" name="id_retur" value="'.(isset($_GET["c"]) ? $row_data["id_retur"] : "").'" >
					    </div>
					    <div class="col-xs-3">
						<label>Tanggal</label>
					    </div>
