...
$content .='							    <tr>
	    ...
	    <td>
		    &nbsp;
					...
					<div class="row">
					    <div class="col-xs-4">
						<label>No Serial Number Awal</label>
					    </div>
					    <div class="col-xs-8">
						<input type="text" class="form-control" required="" name="sn_awal" id="sn" value="">
					    </div>
                                        </div>
					</div>
					<div class="form-group">
					<div class="row">
					    <div class="col-xs-4">
						<label>No Serial Number Akhir</label>
					    </div>
					    <div class="col-xs-8">
						<input type="text" class="form-control" required="" name="sn_akhir" id="sn" value="">
					    </div>
                                        </div>
					</div>
					<div class="form-group">
