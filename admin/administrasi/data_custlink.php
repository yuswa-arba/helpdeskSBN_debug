...
$no = 1;
	...
	$content .='<tr>
		    ...
		    <td>'.$row_customer["cNonAktiv"].'</td>-->
		      ...
		      $content .='\''.mysql_real_escape_string($row_customer["cLongi"]).'\',';
		      $content .='\''.mysql_real_escape_string($row_customer["cLati"]).'\')">Select</a>
                    </td>
                  </tr>';
	$no++;
    }
...
<script type="text/javascript">
	...
	function validepopupform2(custNumber, nama, longi, lati){
		...
		window.opener.document.'.$return_form.'.longitude.value=longi;
		window.opener.document.'.$return_form.'.latitude.value=lati;
