...
if(isset($_GET["id"]))
{
    ...
    $query_invoice 	= "SELECT `gx_cc_invoice`.* , `tbCustomer`.`cKode`,  `tbCustomer`.`cNama`
			
			FROM `gx_cc_invoice`, `tbCustomer`
			WHERE `gx_cc_invoice`.`id_card` = `tbCustomer`.`cKode`
			AND `gx_cc_invoice`.`id` ='".$id_invoice."' LIMIT 0,1;";
    ...
    <td width="97%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="25%"><table width="248" border="0" align="right" cellpadding="0" cellspacing="0">
            <tr>
              <td width="119"><span class="inv1"></span> </td>
              <td width="119"><div align="left"></div></td>
              <td width="10">&nbsp;</td>
            </tr>
          </table></td>
        </tr>
...
$query_invoice_item	= "SELECT * FROM `gx_cc_invoice_item` WHERE `id_invoice` ='".$id_invoice."';";
