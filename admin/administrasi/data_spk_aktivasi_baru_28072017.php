...
if($loggedin["group"] == 'admin'){
 enableLog("", $loggedin["username"], $loggedin["id_employee"], "Open data SPK Aktivasi Baru");
    global $conn;
...
if(isset($_POST["save_search"])){
 ...
 $sql_spk_aktivasi_baru	= "SELECT * FROM `gx_spk_aktivasi` WHERE `level` = '0' ORDER BY `id_spkaktivasi` DESC ;";
}
