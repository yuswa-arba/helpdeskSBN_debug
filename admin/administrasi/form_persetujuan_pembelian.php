...
if(isset($_POST["save"]))
{
	...
	window.location.href='form_periksabeli_detail.php?c=$kode_periksa_pembelian';
	</script>";
    ...
    $content = '
                ...
                <section class="content">
					...
					<div class="row">
					    ...
					    <div class="col-xs-8">
						<textarea class="form-control" name="remarks_periksabeli" style="resize:none;">'.(isset($_GET['id']) ? $row_periksa_pembelian["remarks_periksabeli"] : "").'</textarea>
					    </div>
                                        </div>
					</div>
