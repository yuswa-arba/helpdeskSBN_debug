    ...
    $content = '
			...
			<section class="col-lg-12"> 
					...
					<div class="row">
					    ...
					    <div class="col-xs-2">
						<input type="text" readonly="" class="form-control" id="acc_hutang" name="acc_hutang" value="'.(isset($_GET["c"]) ? $row_data["acc_hutang"] : "").'">
					    </div>
					    <div class="col-xs-2">
					...
					<div class="row">
					    ...
					    <div class="col-xs-2">
						<input type="text" readonly="" maxlength="30" class="form-control" id="shipping_cost" name="shipping_cost" value="'.(isset($_GET["c"]) ? $row_data["shipping_cost"] : "").'">
