...
if(isset($_POST["posting"]))
{
	...
	{
		//detail_bankmasuk
		$query_bm	= "SELECT `gx_km_detail`.* FROM `gx_kas_masuk`, `gx_km_detail`
		...
		$sql_update_lock = "UPDATE `gx_kas_masuk` SET `posting`='1', `status`='1', `date_upd` = NOW(), `user_upd`= '".$loggedin["username"]."'
    ...
    $content = '
			...
			<section class="col-lg-9"> 
					...
					<div class="row">
					    ...
					    <div class="col-xs-3">
							<input type="text" class="form-control" readonly="" id="transaction_id" name="transaction_id" required="" value="'.(isset($_GET['km']) ? $row_data["transaction_id"] : "").'">
							<input type="hidden" name="id_kasmasuk" value="'.(isset($_GET['km']) ? $row_data["id_kasmasuk"] : "").'">
						</div>
					    <div class="col-xs-3">
						<label>Tanggal</label>
					    </div>
					    <div class="col-xs-3">
						<input type="text" class="form-control" readonly="" id="tgl_transaction" name="tgl_transaction" value="'.(isset($_GET['km']) ? $row_data["tgl_transaction"] : date("Y-m-d")).'">
					    </div>
                                        </div>
					</div>
					...
					<div class="row">
						...
						<div class="col-xs-3">
							<input type="text" class="form-control" readonly="" name="id_customer" placeholder="Kode Customer" 
							value="'.(isset($_GET['km']) ? $row_data["id_customer"] : "").'">
						</div>
					    <div class="col-xs-3">
							<label>Nama Customer</label>
					    </div>
					    <div class="col-xs-3">
						<input type="text" class="form-control" readonly="" name="nama" placeholder="Nama Customer" 
						value="'.(isset($_GET['km']) ? $row_data["nama"] : "").'">
					    </div>
                                        </div>
					</div>
					...
					<div class="row">
					    ...
					    <div class="col-xs-3">
						<input type="text" class="form-control" readonly="" name="acc_cash" value="'.(isset($_GET['km']) ? $row_data["acc_cash"] : "").'">
					...
					<div class="row">
					    ...
					    <div class="col-xs-3">
						<input type="text" class="form-control" readonly="" name="mu" value="'.((isset($_GET['km'])) ? $row_data["mu"] : "").'">
					    ...
					    <div class="col-xs-3">
					        <input type="text" class="form-control" readonly="" name="rate" value="'.(isset($_GET['km']) ? $row_data["rate"] : "").'">
					    </div>
                                        </div>
					</div>
					...
					<div class="row">
					    ...
					    <div class="col-xs-9">
						<input type="text" class="form-control" readonly name="remarks" value="'.(isset($_GET['km']) ? $row_data["remarks"] : "").'">
					    </div>
                                        </div>
					</div>
...
if(isset($_GET["km"]))
{
	...
	//<a href="form_km_detail?km='.$kode_data.'&id='.$row_item["id_km_detail"].'&act=del"><span class="label label-danger">Hapus</span></a>
    }
}else{
