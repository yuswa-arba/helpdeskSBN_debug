...
if(isset($_POST["save"]))
{
    ...
    $sql_insert = "INSERT INTO `gx_kkecil_detail` (`id_kk_detail`, `id_kaskecil`,
...
}elseif(isset($_POST["update"]))
{
    ...
    $sql_update = "UPDATE `gx_kkecil_detail` SET `id_kaskecil`='".$kode_kk."', `no_acc`='".$no_acc."',
...
if(isset($_GET["kk"]))
{
    ...
    $query_data 	= "SELECT * FROM `gx_kas_kecil`
    ...
    $return_url = 'form_kkecil_detail.php?kk='.$kode_data;
			...
			<section class="col-lg-9"> 
					...
					<div class="row">
					    ...
					    <div class="col-xs-3">
							...
							<input type="hidden" name="id_kaskecil" value="'.(isset($_GET['kk']) ? $row_data["id_kaskecil"] : "").'">
						</div>
					    <div class="col-xs-3">
						<label>Tanggal</label>
					    </div>
...
if(isset($_GET["kk"]))
{
    $id_kaskecil	= $row_data["id_kaskecil"];
    $query_item	= "SELECT * FROM `gx_kkecil_detail` WHERE `id_kaskecil` ='".$id_kaskecil."';";
    $sql_item	= mysql_query($query_item, $conn);
    
    $id_kkecil_detail  = isset($_GET['id']) ? (int)$_GET['id'] : '';
    $query_detail = "SELECT * FROM `gx_kkecil_detail` WHERE `id_kaskecil` ='".$id_kaskecil."' AND `id_kk_detail` = '".$id_kkecil_detail."' LIMIT 0,1;";
	...
	<td><a href="form_kkecil_detail?kk='.$kode_data.'&id='.$row_item["id_kk_detail"].'"><span class="label label-info">Edit</span></a>
	</td>
	</tr>';
	$no++;
...
$content .='<tr>
                        ...
                        <section class="col-lg-9"> 
                            <div class="box box-solid box-info">
                                ...
                                <!-- form start -->
                                <form action="" role="form" name="form_kkecil_item" id="form_kkecil_item" method="post" enctype="multipart/form-data">
					...
					<div class="row">
						...
						<input type="hidden" name="kode_kk" value="'.(isset($_GET['kk']) ? $row_data["id_kaskecil"] : '').'" readonly="">
					...
					<div class="row">
						...
						onclick="return valideopenerform(\'data_acc.php?r=form_kkecil_item&f=no_acc\',\'acc_cash\');">
