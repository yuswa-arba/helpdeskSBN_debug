...
[UserPaymentBalance], [TimeOnline], [CallBackNumber], [CallerID], [Lockout], 
[LockoutTime], [LockoutCount], [GracePeriodExpiration], [NASAttributes]) 
VALUES ('".$UserIndex."', 'dwiwar', 'gl0b4l', NULL, '0',
'dl.shared', '0', '".$ip_address."', NULL, '".date("Y-m-d")."',
'".date("Y-m-d")."', NULL, NULL, '1',
'409', '0',	'0', '0', '0',
'0', '0', NULL, NULL, '0',
NULL, NULL, '".date("Y-m-d")."', NULL);
...
VALUES ('".$UserIndex."', 'Dwi', '', 'Wardiansah', 'test', 'malang', '', 'malang', 'jawa', '', '65123', '0817', '08766', 
'', 'email@email.com', '".date("Y-m-d H:i:s.000")."', '".date("Y-m-d H:i:s.000")."',  '0', '0', '0', '0', '0', '0', '".date("Y-m-d H:i:s.000")."', NULL, '0', NULL, NULL, '0', NULL, 
NULL, NULL,NULL,NULL,NULL,'192.168.1.10', 'P-D000001', '','', '', NULL, NULL, '0', '0', '0', NULL, '0', NULL, '0', '0', '0', '0', NULL, 
NULL, NULL, NULL, NULL);";
