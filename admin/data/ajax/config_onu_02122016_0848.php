...
$replace_uplink = array_merge($uplink1, $uplink2, $uplink3, $uplink4, $uplink5, $uplink6);
			...
			$fstatus = fopen('/usr/script/olt/status_onu.exp', 'w');
			fwrite($fstatus, $script_status_onu);
			fclose($fstatus);
			chmod("/usr/script/olt/status_onu.exp",0755);
			...
			$output_status_onu = shell_exec('expect /usr/script/olt/status_onu.exp');
			$status_onu = '-';
			$output_inactive = '-';
										...
										<div class="col-xs-10">
											...
											<div class="box box-solid box-info collapsed-box">
												...
												<div class="box-body">
													...
													<pre>'.$status_onu.' ('.$output_inactive.') </pre>
