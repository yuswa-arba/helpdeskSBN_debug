...
if(isset($_POST["save"]))
{
    ...
    $sql_insert = "INSERT INTO `gx_inet_listServer` (`id_server`, `nama_server`, `desc_server`, `ip_address`,
	...
	window.location.href='".URL_ADMIN."data/list_server_ras.php';
	</script>";
...
}elseif(isset($_POST["update"]))
{
    ...
    $sql_update = "UPDATE `gx_inet_listServer` SET `nama_server` = '".$nama_server."', `desc_server` = '".$desc_server."',
...
if(isset($_GET["id"]))
{
    ...
    $sql_server = mysql_query("SELECT * FROM `gx_inet_listServer` WHERE `id_server` = '".$id_server."' AND `level` = '0' LIMIT 0,1;", $conn);
                        ...
                        <div class="col-xs-7">
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">Form Server RAS</h3>
                                </div><!-- /.box-header -->
...
$content .='</select>
					...
					<div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xs-3">
                                                <input type="text" class="form-control" name="username" value="'.(isset($_GET["id"]) ? $row_server["username"] : "").'">
                                            </div>
                                        </div>
                                    </div>
									<div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-xs-3">
                                                <input type="text" class="form-control" name="password" value="'.(isset($_GET["id"]) ? $row_server["password"] : "").'">
                                            </div>
                                        </div>
                                    </div>
					<div class="form-group">
