...
if($loggedin["group"] == 'admin'){
    ...
    if(isset($_POST["hapus"]))
    {
        ...
        {
            $query = "UPDATE `software`.`gx_inet_listolt` SET `level` = '1', `user_upd` = '".$loggedin["username"]."', `date_upd` = NOW()
                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="box box-primary">
                                ...
                                <div class="box-body table-responsive">
                                    <div>
                                        <a href="'.URL_ADMIN.'data/form_server_olt">New OLT Server</a>
                                    </div><br>
...
while ($row_server_ras = mysql_fetch_array($sql_server_ras))
{
    $content .= '<tr>
		    ...
		    <td align="center"><a href="form_server_olt?id='.$row_server_ras["id_server"].'">Update</a></td>
