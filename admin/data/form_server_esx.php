...
if(isset($_POST["save"]))
{
    ...
    $sql_insert = "INSERT INTO `software`.`gx_inet_esx` (`id_server`, `nama_server`, `desc_server`, `ip_address`,
...
elseif(isset($_POST["update"]))
{
    ...
    $sql_update = "UPDATE `software`.`gx_inet_esx` SET `nama_server` = '".$nama_server."', `desc_server` = '".$desc_server."',
...
if(isset($_GET["id"]))
{
    ...
    $sql_server = mysql_query("SELECT * FROM `software`.`gx_inet_esx` WHERE `id_server` = '".$id_server."' AND `level` = '0' LIMIT 0,1;", $conn);
                                ...
                                <div class="box-body table-responsive">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xs-7">
                                                <input type="text" class="form-control" name="nama_server" value="'.(isset($_GET["id"]) ? $row_server["nama_server"] : "").'">
...
$content .='</select>
					...
					<div class="row">
									...
									<div class="form-group" hidden>
                                        <div class="row">
                                            ...
                                            <div class="col-xs-3">
                                                <input type="text" class="form-control" maxlength="10" name="downlink_port" value="'.(isset($_GET["id"]) ? $row_server["downlink_port"] : "").'">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xs-3">
                                                <input type="text" class="form-control" maxlength="64" name="username" value="'.(isset($_GET["id"]) ? $row_server["username"] : "").'">
                                            </div>
                                        </div>
                                    </div>
									<div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-xs-3">
                                                <input type="text" class="form-control" maxlength="64" name="password" value="'.(isset($_GET["id"]) ? $row_server["password"] : "").'">
                                            </div>
                                        </div>
                                    </div>
					<div class="form-group">
					<div class="row">
                                            ...
                                            <div class="col-xs-7">
                                                <input type="text" class="form-control" maxlength="100" name="desc_server" value="'.(isset($_GET["id"]) ? $row_server["desc_server"] : "").'">
                                            </div>
                                        </div>
                                        </div>
									<div class="form-group">
