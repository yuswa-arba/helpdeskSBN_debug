...
if(isset($_POST["save"]))
{
    ...
    $sql_insert = "INSERT INTO `gx_inet_command` (`id_cmd`, `nama_cmd`, `command`, `desc_cmd`,
	...
	window.location.href='".URL_ADMIN."data/list_command.php';
	</script>";
...
}elseif(isset($_POST["update"]))
{
    ...
    $sql_update = "UPDATE `gx_inet_command` SET `command` = '".$command."', `desc_cmd` = '".$desc_cmd."',
...
if(isset($_GET["id"]))
{
    ...
    $sql_command = mysql_query("SELECT * FROM `gx_inet_command` WHERE `id_cmd` = '".$id_cmd."' AND `level` = '0' LIMIT 0,1;", $conn);
