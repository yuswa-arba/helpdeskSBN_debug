                    ...
                    <div class="row">
                        <div class="col-xs-10">
                            <div class="box">
                                ...
                                <div class="box-body">
                                    <form name="ajaxform" id="ajaxform" action="step1.php" method="POST">
						...
						$content .= '
                                        ...
                                        <div class="form-group">
											<div class="row">
												...
												<div class="col-xs-3">
													<input type="text" required="" class="form-control" name="id" maxlength="2" value="">
												</div>
											</div>
                                        </div>
										<div class="form-group">
...
while($row_olt = mysql_fetch_array($sql_olt)){
	$selected = isset($_GET["id"]) ? $row_data["id_timpasang"] : "";
	$selected = ($selected == $row_olt["id_timpasang"]) ? ' selected=""' : "";
	
	$content .= '<option value="'.$row_olt["id_timpasang"].'">'.$row_olt["namapegawai_timpasang"].'</option>';
										...
										<div id="simple-msg">
											<div class="form-group">
												<div class="row">
													...
													<div class="col-xs-3">
														<button type="submit" name="step1" id="simple-post" class="btn btn-primary">Register Onu Test</button>
													</div>
...
if(isset($_POST["aktifasi"]))
{
	...
	if($userid != "")
	{
		...
		$logFile = '/usr/script/olt/show-vlan.txt';
		//echo $logFile;
		$lines = file($logFile); // Get each line of the file and store it as an array
...
$(document).ready(function()
{
		...
		$("#simple-post").click(function()
		{
			...
			{
				$("#simple-msg").html("<img src=\'/software/beta/img/ajax-loader.gif\'/>");
