...
if($loggedin["group"] == 'admin'){
    ...
    if(isset($_POST["hapus"]))
    {
        ...
        {
            $query = "UPDATE `software`.`gx_inet_listswitch` SET `level` = '1', `user_upd` = '".$loggedin["username"]."', `date_upd` = NOW()
                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="box box-primary">
                                <div class="box-header">
                                    ...
                                    <h3 class="box-title">List Server Switch</h3>
                                ...
                                <div class="box-body table-responsive">
                                    <div>
                                        <a href="'.URL_ADMIN.'data/form_server_switch">New Switch Server</a>
                                    </div><br>
...
if(isset($_POST["search"])){
    ...
    $sql_server_ras = mysql_query("SELECT * FROM `software`.`gx_inet_listswitch`, `software`.`gx_inet_listgroup`
				  WHERE `software`.`gx_inet_listswitch`.`group_server` = `software`.`gx_inet_listgroup`.`id_inet_listgroup`
				  AND `level` = '0'
                                  $sql_search
...
while ($row_server_ras = mysql_fetch_array($sql_server_ras))
{
    $content .= '<tr>
		    ...
		    <td align="center">
			<a href="list_switch_port?id='.$row_server_ras["id_server"].'">List Port</a> | 
			<a href="form_server_switch?id='.$row_server_ras["id_server"].'">Update</a></td>
