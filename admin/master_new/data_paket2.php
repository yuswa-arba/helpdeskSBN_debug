...
$no = 1;
	...
	$content .='<tr>
                    ...
                    <td>
                      <a href="" onclick="validepopupform2(\''.$row_paket["id_paket"].'\',\''.$row_paket["nama_paket"].'\',\''.number_format($row_paket["monthly_fee"],2).'\',\''.number_format($tagihanperhari,2).'\',\''.$sum_aktivasi_sd_akhirbulan.'\',\''.number_format($total_tagihan,2).'\',\''.number_format($ppn,2).'\',\''.number_format($totalppn,2).'\')">Select</a>
                    </td>
                  </tr>';
	$no++;
    }
