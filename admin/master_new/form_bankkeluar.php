    ...
    $content ='<section class="content-header">
                ...
                <section class="content">
					...
					<div class="row">
					    ...
					    <div class="col-xs-3">
						<input type="text" class="form-control" id="transaction_id" name="transaction_id" required="" value="'.(isset($_GET['id']) ? $row_bankkeluar["transaction_id"] : "").'">
					    </div>
					    <div class="col-xs-3">
						<label>Tanggal</label>
					    </div>
					    <div class="col-xs-3">
						<input type="text" class="form-control" id="tgl_transaction" name="tgl_transaction" required="" value="'.(isset($_GET['id']) ? $row_bankkeluar["tgl_transaction"] : "").'">
					    </div>
                                        </div>
					</div>
					...
					<div class="row">
					    ...
					    <div class="col-xs-3">
						<input type="text" class="form-control" required="" name="bank_code" value="'.(isset($_GET['id']) ? $row_bankkeluar["bank_code"] : "").'">
					    ...
					    <div class="col-xs-3">
						<input type="text" class="form-control" required="" name="nama_suplier" value="'.(isset($_GET['id']) ? $row_bankkeluar["nama_suplier"] : "").'">
					...
					<div class="row">
					    ...
					    <div class="col-xs-3">
						<input type="text" class="form-control"  name="acc_debet" value="'.(isset($_GET['id']) ? $row_bankkeluar["acc_debet"] : "").'">
					    </div>
                                        </div>
					</div>
					<div class="form-group">
					<div class="row">
					    ...
					    <div class="col-xs-3">
						<input type="text" class="form-control" name="mu" value="'.(isset($_GET['id']) ? $row_bankkeluar["mu"] : "").'">
					    </div>
