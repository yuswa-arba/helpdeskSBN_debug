...
if($loggedin["group"] == 'admin'){
    ...
    $content ='<section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="spk_aktivasi">Master SPK Aktivasi</a></li>
                    </ol>
                </section>
				...
				<div class="box-header">
				    ...
				    <a href="'.URL_ADMIN.'master_anyar/form_spk_aktivasi_baru" class="btn bg-olive btn-flat margin pull-right">Add</a>
                                </div><!-- /.box-header -->
						...
						<th>Action</th>
                                        ...
                                        <tbody>';
$sql_spk_aktivasi = mysql_query("SELECT * FROM `gx_spk_aktivasi` WHERE `level` = '0' ORDER BY `id_spkaktivasi` ASC LIMIT 0,100;",$conn);
$no = 1;
while ($row_spk_aktivasi= mysql_fetch_array($sql_spk_aktivasi))
{
    $content .= '<tr>
		    ...
		    <td align="center">
		    <a href="spk_aktivasi_pdf?id_spk='.$row_spk_aktivasi['id_spkaktivasi'].'">View PDF</a> ||
		    <a href="form_spk_aktivasi_baru?id='.$row_spk_aktivasi['id_spkaktivasi'].'"><span class="label label-info">Edit</span></a>
		    </td>
		</tr>';
		$no++;
}
