    ...
    $content ='<section class="content-header">
                ...
                <section class="content">
					...
					<div class="row">
						...
						<a href="'.URL_ADMIN.'master_anyar/data_cabang.php?r=myForm&f=survey"  onclick="return valideopenerform(\''.URL_ADMIN.'master_anyar/data_cabang.php?r=myForm&f=survey\',\'cabang\');">Search cabang</a>
					    </div>
                                        </div>
					</div>
					...
					<div class="row">
					    ...
					    <div class="col-xs-4">
						<input type="text" class="form-control" id="tanggal" name="tanggal" readonly="" required="" value="'.(isset($_GET["id_survey"]) ? $data_survey['tanggal'] : date("Y-m-d")).'">
					    </div>
                                        </div>
					</div>
					...
					<div class="row">
						...
						<a href="'.URL_ADMIN.'master_anyar/data_prospek.php?r=myForm"  onclick="return valideopenerform(\''.URL_ADMIN.'master_anyar/data_prospek.php?r=myForm\',\'prospek\');">Search Survey</a>
					    </div>
					    <div class="col-xs-2">
					...
					<div class="row">
					    ...
					    <div class="col-xs-4">
						<input type="text" readonly="" class="form-control" name="nama_marketing" value="'.(isset($_GET["id_survey"]) ? $data_marketing['cNama'] :"") .'" > <a href="'.URL_ADMIN.'master_anyar/data_marketing.php?r=myForm" onclick="return valideopenerform(\''.URL_ADMIN.'master_anyar/data_marketing.php?r=myForm\',\'cust\');">Search Employee</a>
						<input type="hidden" class="form-control" name="id_employee" value="'.(isset($_GET["id_survey"]) ? $data_survey['marketing'] :"") .'">
					    </div>
                                        </div>
					</div>
...
$update = isset($_POST["update"]) ? $_POST["update"] : "";
	...
	if($save == "Save"){
	    ...
	    $no_survey		= isset($_POST['no_survey']) ? mysql_real_escape_string(strip_tags(trim($_POST['no_survey']))) : "";
	    ...
	    $marketing		= isset($_POST['id_employee']) ? mysql_real_escape_string(strip_tags(trim($_POST['id_employee']))) : "";
	    
	    if(($no_survey != "") && ($no_prospek != "") && ($cabang != "") && ($kode_cust != "")){
		$insert_survey   	= "INSERT INTO `gx_survey`(`id_survey`, `no_spk_survey`, `no_prospek`, `tanggal`, `cabang`, `kode_cust`, `nama_cust`, `nama_perusahaan`, `alamat`, `kelurahan`, `kecamatan`, `kota`, `kode_pos`, `no_telp`, `no_hp_1`, `no_hp_2`, `contact_person`, `email`, `longitude`, `latitude`, `marketing`, `date_add`, `date_upd`, `user_add`, `user_upd`, `level`)
					    VALUES (NULL, '$no_survey', '$no_prospek',NOW(),'$cabang','$kode_cust','$nama_cust','$nama_perusahaan','$alamat','$kelurahan','$kecamatan','$kota','$kode_pos','$no_telp','$no_hp_1','$no_hp_2','$contact_person','$email','$longitude','$latitude','$marketing',NOW(),NOW(),'$loggedin[username]','$loggedin[username]','0');";
		//echo $insert_prospek;
