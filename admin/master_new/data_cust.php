...
if(isset($_GET["f"]) == "aktivasi"){
 while ($row_customer = mysql_fetch_array($query_customer)) {
	$content .='<tr>
		    ...
		    <td>'.$row_customer["cNonAktiv"].'</td>-->
                    <td>
                      <a href="" onclick="validepopupform2(\''.$row_customer["cUserID"].'\',\''.$row_customer["cKode"].'\',\''.$row_customer["cNama"].'\',\''.$row_customer["cAlamat1"].'\',\''.$row_customer["ctelp"].'\')">Select</a>
                    </td>
                  </tr>';
	$no++;
    }
 ...
 while ($row_customer = mysql_fetch_array($query_customer)) {
	$content .='<tr>
		    ...
		    <td>'.$row_customer["cNonAktiv"].'</td>-->
                    <td>
                      <a href="" onclick="validepopupform2(\''.$row_customer["cUserID"].'\',\''.$row_customer["cKode"].'\',\''.$row_customer["cNama"].'\',\''.$row_customer["cAlamat1"].'\',\''.$row_customer["cNamaPers"].'\',\''.$row_customer["cKota"].'\',\''.$row_customer["cfax"].'\',\''.$row_customer["ctelp"].'\',\''.$row_customer["cEmail"].'\',\''.$row_customer["cPaket"].'\',\''.$row_customer["cNoHp1"].'\',\''.$row_customer["cNoHp2"].'\',\''.$row_customer["cContact"].'\')">Select</a>
                    </td>
                  </tr>';
	$no++;
    }
