...
if($loggedin["group"] == 'admin'){
    ...
    $content ='<section class="content-header">
                    <h1>
                        Master Persetujuan Justifikasi
                        
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="home"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li><a href="persetujuan_justifikasi">Master Persetujuan Justifikasi</a></li>
                    </ol>
                </section>
				...
				<div class="box-header">
				    ...
				    <a href="'.URL_ADMIN.'master_anyar/form_persetujuan_justifikasi" class="btn bg-olive btn-flat margin pull-right">Add</a>
                                </div><!-- /.box-header -->
						...
						<th>Action</th>
                                        ...
                                        <tbody>';
$sql_persetujuan_justifikasi = mysql_query("SELECT * FROM `gx_persetujuan_justifikasi` WHERE `level` = '0' ORDER BY `id_persetujuan_justifikasi` ASC LIMIT 0,100;",$conn);
$no = 1;
