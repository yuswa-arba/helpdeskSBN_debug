...
if(isset($_GET["id"]))
{
    ...
    $query_bankmasuk 	= "SELECT * FROM `gx_bank_masuk` WHERE `id_bankmasuk`='$id_bankmasuk' LIMIT 0,1;";
    ...
    $content ='<section class="content-header">
                ...
                <section class="content">
					...
					<div class="row">
					    ...
					    <div class="col-xs-3">
						<input type="text" class="form-control" id="transaction_id" name="transaction_id" required="" value="'.(isset($_GET['id']) ? $row_bankmasuk["transaction_id"] : "").'">
					    </div>
					    <div class="col-xs-3">
						<label>Tanggal</label>
					    </div>
					    <div class="col-xs-3">
						<input type="text" class="form-control" id="tgl_transaction" name="tgl_transaction" required="" value="'.(isset($_GET['id']) ? $row_bankmasuk["tgl_transaction"] : "").'">
					    </div>
                                        </div>
					</div>
					...
					<div class="row">
					    ...
					    <div class="col-xs-3">
						<input type="text" class="form-control" required="" name="bank_code" value="'.(isset($_GET['id']) ? $row_bankmasuk["bank_code"] : "").'">
						'.(isset($_GET['id']) ? '<input type="hidden" name="id_bankmasuk" value="'.$id_bankmasuk.'">' : "").'
					    </div>
					    <div class="col-xs-3">
						<label>Nama Customer</label>
					    </div>
					    <div class="col-xs-3">
						<input type="text" class="form-control" required="" name="nama" value="'.(isset($_GET['id']) ? $row_bankmasuk["nama"] : "").'">
						'.(isset($_GET['id']) ? '<input type="hidden" name="id_customer" value="'.(isset($_GET['id']) ? $row_bankmasuk["id_customer"] : "").'">' : "").'
					    </div>
                                        </div>
					</div>
					<div class="form-group">
					<div class="row">
					    ...
					    <div class="col-xs-3">
						<input type="text" class="form-control"  name="acc_credit" value="'.(isset($_GET['id']) ? $row_bankmasuk["acc_credit"] : "").'">
					    </div>
                                        </div>
					</div>
					<div class="form-group">
					<div class="row">
					    ...
					    <div class="col-xs-3">
						<input type="text" class="form-control" name="mu" value="'.(isset($_GET['id']) ? $row_bankmasuk["mu"] : "").'">
					    </div>
