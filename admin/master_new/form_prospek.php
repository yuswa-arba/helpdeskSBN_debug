    ...
    $content ='<section class="content-header">
                ...
                <section class="content">
					...
					<div class="row">
					    ...
					    <div class="col-xs-4">
						<input type="text" readonly="" class="form-control" id="tanggal" name="tanggal" required="" value="'.date("Y-m-d").'">
					    </div>
                                        </div>
					</div>
					...
					<div class="row">
					    ...
					    <div class="col-xs-4">
						<input type="text" readonly="" class="form-control" required="" name="kode_customer" value="'.(isset($_GET["id_prospek"]) ? $data_prospek['kode_cust'] :"").'"><a href="'.URL_ADMIN.'master_anyar/data_cust.php?r=myForm" onclick="return valideopenerform(\''.URL_ADMIN.'master_anyar/data_cust.php?r=myForm\',\'cust\');">Search Customer</a>
					    </div>
                                        </div>
					</div>
					<div class="form-group">
					...
					<div class="row">
					    ...
					    <div class="col-xs-4">
						<input type="text" readonly="" required="" class="form-control" name="nama_marketing" value="'.(isset($_GET["id_prospek"]) ? $data_prospek['marketing'] :"") .'" > <a href="'.URL_ADMIN.'master_anyar/data_marketing.php?r=myForm" onclick="return valideopenerform(\''.URL_ADMIN.'master_anyar/data_marketing.php?r=myForm\',\'cust\');">Search Employee</a>
