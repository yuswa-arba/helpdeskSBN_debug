    ...
    $content ='<section class="content-header">
                ...
                <section class="content">
					...
					<div class="row">
						...
						<a href="'.URL_ADMIN.'master_anyar/data_cabang.php?r=myForm&f=linkbudget"  onclick="return valideopenerform(\''.URL_ADMIN.'master_anyar/data_cabang.php?r=myForm&f=linkbudget\',\'cabang\');">Search cabang</a>
					    </div>
                                        </div>
					</div>
					<div class="form-group">
					...
					<div class="row">
						...
						<a href="'.URL_ADMIN.'master_anyar/data_custlink.php?r=myForm"  onclick="return valideopenerform(\''.URL_ADMIN.'master_anyar/data_custlink.php?r=myForm\',\'cust\');">Search customer</a>
					    </div>
                                            <div class="col-xs-2">
