...
$content = '<!-- Content Header (Page header) -->
                <section class="content-header">
                    <h1>
                        Master Jawaban SPK Pasang Baru
                    </h1>
...
$content .= '
 <table id="example1" class="table table-bordered table-striped">
    ...
    $sql_jawaban_spk_pasang_baru	= mysql_query("SELECT * FROM `gx_jawab_spkpasang` WHERE `level` =  '0'
	...
	$content .='<tr>
			<td>'.$no.'.</td>
			<td>'.$r_jawaban_spk_pasang_baru['tanggal'].'</td>
			<td>'.$r_jawaban_spk_pasang_baru['kode_jawab_spk'].'</td>
			<td>'.$r_jawaban_spk_pasang_baru['nama_customer'].'</td>
			<td>'.$r_jawaban_spk_pasang_baru['nama_cabang'].'</td>
			<td>'.$r_jawaban_spk_pasang_baru['paket_koneksi'].'</td>
			<td>'.$r_jawaban_spk_pasang_baru['pekerjaan'].'</td>
			<td><a href="detail_jawaban_spk_pasang_baru.php?id_jawaban_spk_pasang_baru='.$r_jawaban_spk_pasang_baru["id_jawab_spkpasang"].'" onclick="return valideopenerform(\'detail_jawaban_spk_pasang_baru.php?id_jawaban_spk_pasang_baru='.$r_jawaban_spk_pasang_baru["id_jawab_spkpasang"].'\',\'SPK Pasang Baru\');">Details</a>  || <a href="form_jawaban_spk_pasang_baru.php?id_jawaban_spk_pasang_baru='.$r_jawaban_spk_pasang_baru["id_jawab_spkpasang"].'">edit</a></td>
			<!--<td><input type="checkbox" name="id_jawaban_spk_pasang_baru[]" value="'.$r_jawaban_spk_pasang_baru["id_jawab_spkpasang"].'"></td>-->
		    </tr>';
	$no++;
    }
