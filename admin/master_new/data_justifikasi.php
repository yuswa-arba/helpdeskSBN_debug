...
if(isset($_POST["save_search"])){
	...
	$sql_email
	$sql_phone
	ORDER BY `id_permohonan_justifikasi` ASC LIMIT 0,10;";
}else{
	$sql_justifikasi	= "SELECT * FROM `gx_permohonan_justifikasi`
...
$no = 1;
	...
	$content .='<tr>
		    ...
		    <td>'.$row_justifikasi["no_justifikasi"].'</td>
                    ...
                    <td>
                      <a href="" onclick="validepopupform2(\''.$row_justifikasi["no_justifikasi"].'\',\''.$row_justifikasi["kode_customer"].'\',\''.$row_justifikasi["nama_customer"].'\',\''.$row_justifikasi["longitude"].'\',\''.$row_justifikasi["latitude"].'\',\''.$row_justifikasi["tiang_terdekat"].'\',\''.$row_justifikasi["kode_paket"].'\',\''.$row_justifikasi["nama_paket"].'\',\''.$row_justifikasi["kontrak"].'\',\''.$row_justifikasi["setup_fee_normal"].'\',\''.$row_justifikasi["abonemen_normal"].'\',\''.$row_justifikasi["monthly_fee_normal"].'\',\''.$row_justifikasi["bandwith_normal"].'\',\''.$row_justifikasi["setup_fee_justifikasi"].'\',\''.$row_justifikasi["abonemen_justifikasi"].'\',\''.$row_justifikasi["monthly_fee_justifikasi"].'\',\''.$row_justifikasi["bandwith_justifikasi"].'\')">Select</a>
                    </td>
                  </tr>';
	$no++;
    }
...
<script type="text/javascript">
	...
	function validepopupform2(nojustifikasi,kodecustomer,namacustomer,clongitude,clatitude,notiang,nopaket,namapaket,kontrak,setupfeenormal,abonemennormal,monthlyfeenormal,bandwithnormal,setupfeejustifikasi,abonemenjustifikasi,monthlyfeejustifikasi,bandwithjustifikasi){
