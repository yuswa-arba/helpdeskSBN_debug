...
if($loggedin["group"] == 'admin'){
    ...
    $content ='<section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="link_budget">Master Link Budget</a></li>
                    </ol>
                </section>
				...
				<div class="box-header">
				    ...
				    <a href="'.URL_ADMIN.'master_anyar/form_link_budget" class="btn bg-olive btn-flat margin pull-right">Add</a>
                                </div><!-- /.box-header -->
...
while ($row_master_link_budget= mysql_fetch_array($sql_master_linkbudget))
{
    $content .= '<tr>
		    ...
		    <td align="center">
		    <a href="form_link_budget?id_link='.$row_master_link_budget['id_link_budget'].'"><span class="label label-info">Edit</span></a>
		    </td>
		</tr>';
		$no++;
}
