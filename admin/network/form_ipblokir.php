...
if(isset($_POST["save"]))
{
    ...
    if($ip_address != ""){
	//insert into gx_bts
	$sql_insert = "INSERT INTO `gx_ip_blokir` (`id_ip`, `ip_address`, `keterangan_ip`, `flag_ip`, `user_add`, `user_upd`, `date_add`, `date_upd`, `level`)
	VALUES (NULL, '".ip2long($ip_address)."', '".$keterangan_ip."', '".$flag_ip."',
	...
	echo "<script language='JavaScript'>
	    ...
	    window.location.href='ip_blokir.php';
	    </script>";
    }else{
		echo "<script language='JavaScript'>
...
}elseif(isset($_POST["update"]))
{
    ...
    if($id_ip != ""){
		//insert into gx_bts
		$sql_update = "UPDATE `gx_ip_blokir` SET `level` = '1',
...
if(isset($_GET["id"]))
{
    ...
    $query_data	= "SELECT * FROM `gx_ip_blokir` WHERE `id_ip`='".$id_data."' LIMIT 0,1;";
