...
if(isset($_POST["save"]))
{
    ...
    if($ip_address != ""){
	//insert into gx_bts
	$sql_insert = "INSERT INTO `gx_master_ipvm` (`id_ip`, `ip_address`, `keterangan_ip`, `userid_ip`, `flag_ip`, `type_ip`, `user_add`, `user_upd`, `date_add`, `date_upd`, `level`)
...
}elseif(isset($_POST["update"]))
{
    ...
    if($id_ip != ""){
		//insert into gx_bts
		$sql_update = "UPDATE `gx_master_ipvm` SET `level` = '1',
