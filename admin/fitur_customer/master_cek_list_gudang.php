...
//SELECT
    ...
    $urutan = "ORDER BY `gx_cek_list_gudang`.`id` DESC";
...
//UPDATE
    ...
    $redirect_action_lock = "gx_cek_list_gudang";
...
//String Data View
    //Judul Form
    $judul_form = "Master Cek List Gudang";
    $link_form_add_data = '<a href="form_cek_list_gudang.php" class="btn bg-maroon btn-flat margin">Create New</a>';
    $judul_table = "Cek List Gudang";
...
if($loggedin["group"] == 'admin'){
    enableLog("", $loggedin["username"], $loggedin["id_employee"], "Open Master Cek List Gudang");
    global $conn;
