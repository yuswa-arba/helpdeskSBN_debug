...
//UPDATE
    ...
    $redirect_action_lock = "master_jawaban_spk_bongkar";
...
//String Data View
    //Judul Form
    $judul_form = "Master Jawaban SPK Bongkar";
    $link_form_add_data = '<a href="form_jawaban_spk_bongkar.php" class="btn bg-maroon btn-flat margin">Create New</a>';
    $judul_table = "List Data Jawaban SPK Bongkar";
    $data_field = array("Kode Jawaban", "Tanggal", "Kode Customer", "Nama", "Cabang");
    $data_sql_field = array("kode_jawaban_spk_bongkar", "tanggal", "kode_customer", "nama_customer", "cabang");
    $index_field_sql = "id";
...
if($loggedin["group"] == 'admin'){
    enableLog("", $loggedin["username"], $loggedin["id_employee"], "Open Master Jawaban SPK Bongkar");
    global $conn;
