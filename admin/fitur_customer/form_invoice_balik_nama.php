    ...
    $content = '<section class="content-header">
                ...
                <section class="content">
				    ...
				    $content.=' <div class="col-xs-2">
					    ...
					    <div class="col-xs-3">
						<input type="text" readonly="" class="form-control" required="" name="kode_balik_nama" value="'.(isset($_GET['c']) ? $row["kode_balik_nama"] : '').'" onclick="return valideopenerform(\'data_balik_nama.php?r=form_invoice_balik_nama&f=data_invoice_balik_nama\',\'invoice_balik_nama\');">
					    ...
					    <div class="col-xs-3">
						<input type="text" readonly="" class="form-control" required="" name="nama_pelanggan" value="'.(isset($_GET['c']) ? $row["nama_pelanggan"] : '').'">
					    </div>
					...
					<div class="row">
					    ...
					    <div class="col-xs-3">
						<input  type="text" readonly="" class="form-control" id="datepicker" required="" name="periode_tagihan" value="'.(isset($_GET['c']) ? $row["periode_tagihan"] : '').'">
					    </div>
					...
					<div class="row">
					    ...
					    <div class="col-xs-3">
						<input type="text" readonly="" id="datepicker2" required="" class="form-control" name="tanggal_tagihan" value="'.(isset($_GET['c']) ? $row["tanggal_tagihan"] : '').'">
					    </div>
					    <div class="col-xs-2">
						<label>Kode Invoice</label>
					    </div>
					    <div class="col-xs-3">
						<input readonly="" required="" type="text" required="" class="form-control" name="kode_invoice" value="'.(isset($_GET['c']) ? $row["kode_invoice"] : "INV-".rand(000000,999999)).'">
					    </div>
                                        </div>
					</div>
					...
					<div class="row">
					    ...
					    <div class="col-xs-3">
						<input type="text" readonly="" id="datepicker3" required="" class="form-control" name="tanggal_jatuh_tempo" value="'.(isset($_GET['c']) ? $row["tanggal_jatuh_tempo"] : '').'">
					    </div>
					    ...
					    <div class="col-xs-3">
						<input type="text"  required="" class="form-control" name="npwp" value="'.(isset($_GET['c']) ? $row["npwp"] : '').'">
					    </div>
                                        </div>
					</div>
					...
					<div class="row">
					    ...
					    <div class="col-xs-3">
						<input type="text" required="" class="form-control" name="no_virtual_account_bca" value="'.(isset($_GET['c']) ? $row["no_virtual_account_bca"] : '').'">
					    </div>
					    ...
					    <div class="col-xs-3">
						<input type="text" required="" class="form-control" name="nama_virtual_account" value="'.(isset($_GET['c']) ? $row["nama_virtual_account"] : '').'">
					    </div>
					</div>
					</div>
					...
					<div class="row">    
					    ...
					    <div class="col-xs-3">
						<input type="text" required="" class="form-control" name="no_faktur_pajak" value="'.(isset($_GET['c']) ? $row["no_faktur_pajak"] : '').'">
					    </div>    
					    <div class="col-xs-2">
						<label>Note</label>
					    </div>
					    <div class="col-xs-3">
						<input type="text" required="" class="form-control" name="note" value="'.(isset($_GET['c']) ? $row["note"] : '').'">
					    </div>
                                        </div>
					</div>
					...
					<div class="row">
					    ...
					    <div class="col-xs-3">
						<input type="text" required="" class="form-control" name="invoice_change_name" value="'.(isset($_GET['c']) ? $row["invoice_change_name"] : '').'">
					    </div>
					    ...
					    <div class="col-xs-3">
						<input type="text" required="" class="form-control" name="invoice_total" value="'.(isset($_GET['c']) ? $row["invoice_total"] : '').'">
					    </div>
					...
					<div class="row">
					    ...
					    <div class="col-xs-3">
						<input type="text" required="" class="form-control" name="invoice_ppn" value="'.(isset($_GET['c']) ? $row["invoice_ppn"] : '').'">
					    </div>
					    ...
					    <div class="col-xs-3">
						<input type="text" required="" class="form-control" name="invoice_grand_total" value="'.(isset($_GET['c']) ? $row["invoice_grand_total"] : '').'">
					    </div>
                                        </div>
					</div>
					...
					<div class="row">
					    ...
					    <div class="col-xs-3">
						<input type="text" required="" class="form-control" name="invoice_uang_muka" value="'.(isset($_GET['c']) ? $row["invoice_uang_muka"] : '').'">
					    </div>
					    ...
					    <div class="col-xs-3">
						<input type="text" required="" class="form-control" name="invoice_sisa" value="'.(isset($_GET['c']) ? $row["invoice_sisa"] : '').'">
					    </div>
