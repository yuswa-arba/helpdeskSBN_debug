...
//String Data View
    ...
    $submenu_header = 'master_spk_bongkar';
...
if(isset($_POST["save"]))
{
    ...
    $kode_spk_bongkar					= isset($_POST['kode_spk_bongkar']) ? mysql_real_escape_string(trim($_POST['kode_spk_bongkar'])) : '';
    ...
    */
    ...
    $sql_insert = "INSERT INTO `gx_spk_bongkar`(`id`, `kode_spk_bongkar`, `tanggal`,`kode_cabang`, `cabang`, `user_id`, `kode_customer`, `nama_customer`, `no_inactive`, `no_off_connection`, `telp`, `teknisi`, `alamat`, `pekerjaan`, `status`, `date_add`, `date_upd`, `level`, `user_add`, `user_upd`)
    VALUES (NULL,'".$kode_spk_bongkar."','".$tanggal."','".$kode_cabang."','".$cabang."','".$user_id."','".$kode_customer."','".$nama_customer."','".$no_inactive."','".$no_off_connection."','".$telp."','".$teknisi."','".$alamat."','".$pekerjaan."','0',NOW(),NOW(),'0','".$loggedin['username']."','".$loggedin['username']."')";
...
}elseif(isset($_POST["update"]))
{
	...
	*/
	...
	$sql_update = "UPDATE `gx_spk_bongkar` SET `date_upd`=NOW(),`level`='1',`user_upd`='".$loggedin['username']."' WHERE  `kode_spk_bongkar`='".$c."'";
	
	$sql_insert = "INSERT INTO `gx_spk_bongkar`(`id`, `kode_spk_bongkar`, `tanggal`,`kode_cabang`, `cabang`, `user_id`, `kode_customer`, `nama_customer`, `no_inactive`, `no_off_connection`, `telp`, `kode_teknisi`, `teknisi`, `alamat`, `pekerjaan`, `status`, `date_add`, `date_upd`, `level`, `user_add`, `user_upd`)
	VALUES (NULL,'".$kode_spk_bongkar."','".$tanggal."','".$kode_cabang."','".$cabang."','".$user_id."','".$kode_customer."','".$nama_customer."','".$no_inactive."','".$no_off_connection."','".$telp."','".$kode_teknisi."','".$teknisi."','".$alamat."','".$pekerjaan."','0',NOW(),NOW(),'0','".$loggedin['username']."','".$loggedin['username']."')";
	//echo $sql_insert."<br>";
    ...
    $content = '<section class="content-header">
                ...
                <section class="content">
					...
					<div class="row">
					    ...
					    <div class="col-xs-4">
						<input readonly="" type="text"  class="form-control" name="cabang" value="'.(isset($_GET['c']) ? $row["cabang"] : '').'" onclick="return valideopenerform(\'data_cabang.php?r=form_spk_bongkar&f=data_spk_bongkar\',\'cabang\');" >
					    </div>
					    <div class="col-xs-2">
						<label>User ID</label>
					    </div>
					    <div class="col-xs-4">
						<input type="text" readonly="" class="form-control" name="user_id" value="'.(isset($_GET['c']) ? $row["user_id"] : '').'" onclick="return valideopenerform(\'data_customer.php?r=form_spk_bongkar&f=data_spk_bongkar\',\'user_id\');">
					    </div>
                                        </div>
					</div>
					...
					<div class="row">
					    ...
					    <div class="col-xs-4">
						<input type="text" readonly="" class="form-control" name="no_off_connection" value="'.(isset($_GET['c']) ? $row["no_off_connection"] : '').'" onclick="return valideopenerform(\'data_off_connection.php?r=form_spk_bongkar&f=data_spk_bongkar\',\'off_connection\');">
					    </div>
                                        </div>
					</div>					
					...
					<div class="row">
					    ...
					    <div class="col-xs-4">
						    <input type="text" readonly="" class="form-control" name="teknisi" value="'.(isset($_GET['c']) ? $row["teknisi"] : '').'" onclick="return valideopenerform(\'data_teknisi.php?r=form_spk_bongkar&f=data_spk_bongkar\',\'teknisi\');">
					    </div>
					</div>
					</div>
					...
					<div class="row">
					    ...
					    <div class="col-xs-12">
						<textarea class="form-control" name="pekerjaan">'.(isset($_GET['c']) ? $row["pekerjaan"] : '').'</textarea>
					    </div>
