...
$table_main_2 = "gx_list_barang_customer_detail";
$table_detail = "";
...
//INSERT 
    ...
    $url_redirect_insert = "form_detail_list_barang_customer";
...
//UPDATE
    ...
    $redirect_update_data = "form_detail_list_barang_customer";
...
//String Data View
    //Judul Form
    $judul_form = "Form Detail List Barang Customer";
    $header_form = "Data List Barang Customer";
    $index_field_sql = "id";
    $unix_field_sql = "kode_list_barang_customer";
    $unix_field_sql_2 = "kode_list_barang_customer_detail";
