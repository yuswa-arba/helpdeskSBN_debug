...
//UPDATE
    ...
    $redirect_update_data = "master_list_barang_customer";
...
if(isset($_POST["save"]))
{
    ...
    */
    ...
    /*
    $sql_insert = "INSERT INTO `gx_list_barang_customer`(`id`, `no_spk_bongkar`, `tanggal`, `kode_jawaban_spk_bongkar`, `kode_customer`, `nama_customer`, `kode_cabang`, `cabang`, `user_id`, `telp`, `alamat`, `kode_teknisi_1`, `teknisi_1`, `kode_teknisi_2`, `teknisi_2`, `kode_teknisi_3`, `teknisi_3`, `kode_teknisi_4`, `teknisi_4`, `kode_teknisi_5`, `teknisi_5`, `status_spk`, `pekerjaan`, `solusi`, `kode_list_alat`, `status`, `date_add`, `date_upd`, `user_add`, `user_upd`, `level`)
...
}elseif(isset($_POST["update"]))
{
	...
	$sql_update = "UPDATE `gx_list_barang_customer` SET `date_upd`=NOW(),`user_upd`='".$loggedin['username']."',`level`=[value-14] WHERE  `kode_jawaban_spk_bongkar`='".$c."'";
    ...
    $content = '<section class="content-header">
                ...
                <section class="content">
				    ...
				    $content.=' <div class="col-xs-2">
					    ...
					    <div class="col-xs-4">
						<input type="text" readonly="" class="form-control" required="" name="cabang" value="'.(isset($_GET['c']) ? $row["cabang"] : '').'" onclick="return valideopenerform(\'data_cabang.php?r=form_list_barang_customer&f=data_cabang\',\'list_barang_customer\');">
					    ...
					    <div class="col-xs-4"> 
						<input type="text" readonly="" class="form-control" required="" name="tanggal" value="'.(isset($_GET['c']) ? $row["tanggal"] : date("Y-m-d")).'" onclick="return valideopenerform(\'data_customer.php?r=form_list_barang_customer&f=data_customer\',\'list_barang_customer\');">
					    </div>
				...
				<!-- form start -->
					...
					<div class="row">
					    ...
					    <div class="col-xs-4">
						<input type="text"  class="form-control" name="tanggal" value="'.(isset($_GET['c']) ? $row2["tanggal"] : '').'" readonly="">
					...
					<div class="row">
					    ...
					    <div class="col-xs-4">
						<input type="text"  class="form-control" name="qty" value="'.(isset($_GET['c']) ? $row2["nama_barang"] : '').'" readonly="">
					...
					<div class="row">
					    ...
					    <div class="col-xs-4">
						<input type="text"  class="form-control" name="serial_number" value="'.(isset($_GET['c']) ? $row2["serial_number"] : '').'" readonly="">
					    </div>
					...
					<div class="row">
						...
						<table class="table table-hover">
						    <thead>
							<tr><th>Kode Barang</th><th>Nama Barang</th><th>Qty</th><th>No Seri Number</th></tr>
						    </thead>
						    <tbody>';
						...
						if(isset($c)){
							...
							$content .= '<tr><td>'.$row_2['kode_barang'].'</td><td>'.$row_2['nama_barang'].'</td><td>'.$row_2['qty'].'</td><td>'.$row_2['no_seri_number'].'</td></tr>';
						    } 
						}
						    $content .= '
						    </tbody>';
