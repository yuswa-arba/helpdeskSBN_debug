...
//UPDATE
    ...
    $redirect_action_lock = "master_balik_nama";
...
//String Data View
    //Judul Form
    $judul_form = "Master Balik Nama";
    $link_form_add_data = '<a href="form_balik_nama.php" class="btn bg-maroon btn-flat margin">Create New</a>';
    $judul_table = "List Data Balik Nama";
    $data_field = array("Cabang", "Tanggal", "Nama Lama", "Nama Baru");
    $data_sql_field = array("nama_cabang", "tanggal", "nama_lama", "nama_baru");
    $index_field_sql = "id";
