...
//INSERT 
    ...
    $url_redirect_insert = "master_setting_jadwal_pegawai";
...
//UPDATE
    ...
    $redirect_update_data = "master_setting_jadwal_pegawai";
    ...
    $content = '<section class="content-header">
                ...
                <section class="content">
					...
					<div class="row">
					    ...
					    <div class="col-xs-8">
						<input type="text"  class="form-control" name="break" value="'.(isset($_GET['c']) ? $row["break"] : '').'">
					    </div>
