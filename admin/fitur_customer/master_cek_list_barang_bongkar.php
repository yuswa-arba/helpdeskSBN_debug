...
//SELECT
    ...
    $urutan = "ORDER BY `gx_cek_list_barang_bongkar`.`id` DESC";
...
//UPDATE
    ...
    $redirect_action_lock = "gx_cek_list_barang_bongkar";
...
//String Data View
    //Judul Form
    $judul_form = "Master Cek List Barang Bongkar";
    $link_form_add_data = '<a href="form_cek_list_barang_bongkar.php" class="btn bg-maroon btn-flat margin">Create New</a>';
    $judul_table = "Cek List Barang Bongkar";
    $data_field = array("Tanggal", "Cabang", "SPK Bongkar", "Nama Customer");
    $data_sql_field = array("tanggal", "cabang", "spk_bongkar", "nama_customer");
    $index_field_sql = "id";
