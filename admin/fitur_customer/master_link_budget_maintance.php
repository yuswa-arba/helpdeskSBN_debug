...
//SELECT
    ...
    $urutan = "ORDER BY `gx_link_budget_maintance`.`id` DESC";
...
//UPDATE
    ...
    $redirect_action_lock = "gx_link_budget_maintance";
...
//String Data View
    //Judul Form
    $judul_form = "Master Link Budget Maintance";
    $link_form_add_data = '<a href="form_link_budget_maintance.php" class="btn bg-maroon btn-flat margin">Create New</a>';
    $judul_table = "Link Budget Maintance";
    $data_field = array("Tanggal", "Cabang", "SPK Maintance", "Nama Customer");
    $data_sql_field = array("tanggal", "cabang", "spk_maintance", "nama_customer");
    $index_field_sql = "id";
...
if($loggedin["group"] == 'admin'){
    enableLog("", $loggedin["username"], $loggedin["id_employee"], "Open Master Link Budget Maintance");
    global $conn;
