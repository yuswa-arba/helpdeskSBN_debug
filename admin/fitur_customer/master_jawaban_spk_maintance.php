...
//UPDATE
    ...
    $redirect_action_lock = "master_jawaban_spk_maintance";
...
//String Data View
    //Judul Form
    $judul_form = "Master Jawaban SPK Maintance";
    $link_form_add_data = '<a href="form_jawaban_spk_maintance.php" class="btn bg-maroon btn-flat margin">Create New</a>';
    $judul_table = "List Data Jawaban SPK Maintance";
    $data_field = array("Kode Jawaban", "Tanggal", "Kode Customer", "Nama", "Cabang");
    $data_sql_field = array("kode_jawaban_spk_maintance", "tanggal", "kode_customer", "nama_customer", "cabang");
    $index_field_sql = "id";
...
if($loggedin["group"] == 'admin'){
    enableLog("", $loggedin["username"], $loggedin["id_employee"], "Open Master Jawaban SPK Maintance");
    global $conn;
