...
//UPDATE
    ...
    $redirect_action_lock = "master_invoice_reaktivasi";
...
//String Data View
    //Judul Form
    $judul_form = "Master Invoice Reaktivasi";
    $link_form_add_data = '<a href="form_invoice_reaktivasi.php" class="btn bg-maroon btn-flat margin">Create New</a>';
    $judul_table = "List Data Invoice Reaktivasi";
    $data_field = array("Nama Pelanggan", "Kode Customer", "Periode Tagihan", "Tanggal Tagihan", "Kode Invoice");
    $data_sql_field = array("nama_pelanggan", "kode_customer", "periode_tagihan", "tanggal_tagihan", "kode_invoice");
    $index_field_sql = "id";
	...
	$content .= '<tr>
			...
			<td>'.(($row_data["status"] == "1") ? '
				   ...
				   '<a href="'.$url_form_detail.'?c='.$row_data[$unix_field_sql].'"><span class="label label-info">Detail</span></a>
					...
					<a href="pdf_invoice_reaktivasi?c='.$row_data[$unix_field_sql].'"><span class="label label-info">PDF</span></a>
