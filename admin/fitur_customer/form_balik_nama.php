...
if(isset($_POST["save"]))
{
  ...
  //  VALUES (NULL,'$kode_batal_posting','$nama_batal','$kode_batal','$alasan_batal','$data_asli','$data_baru',NOW(),NOW(),'0','".$loggedin['username']."','".$loggedin['username']."')";
    ...
    $sql_insert = "INSERT INTO `gx_balik_nama`(`id`, `kode_cabang`, `nama_cabang`, `tanggal`, `kode_balik_nama`, `kode_customer`, `nama_lama`, `nama_baru`, `type_connection`, `fiber_optic`, `wireless`, `status`, `date_add`, `date_upd`, `level`, `user_add`, `user_upd`)
    VALUES (NULL,'$kode_cabang','$nama_cabang','$tanggal','$kode_balik_nama','$kode_customer','$nama_lama','$nama_baru','$type_connection','$fiber_optic','$wireless','0',NOW(),NOW(),'0','".$loggedin['username']."','".$loggedin['username']."')";
    ...
    $content = '<section class="content-header">
                ...
                <section class="content">
					...
					<div class="row">
					    ...
					    <div class="col-xs-3">
						<input readonly="" type="text" class="form-control" required="" name="kode_customer" value="'.(isset($_GET['c']) ? $row["kode_customer"] : '').'" onclick="return valideopenerform(\'data_customer.php?r=form_balik_nama&f=data_balik_nama\',\'customer\');">
					...
					<div class="row">
					  <div class="col-xs-2">
					    ...
					    <div class="col-xs-2">
						<input type="radio"  class="form-control" name="type_connection" value="fiber_optic" '.(isset($_GET['c']) ? ($row["type_connection"] == 'fiber_optic' ? 'checked' : '') : '').'>
						<label>Fiber Optic</label>
					    </div>
					   

					    <div class="col-xs-2">
						<input type="radio"  class="form-control" name="type_connection" value="wireless" '.(isset($_GET['c']) ? ($row["type_connection"] == 'wireless' ? 'checked' : '') : '').'>
