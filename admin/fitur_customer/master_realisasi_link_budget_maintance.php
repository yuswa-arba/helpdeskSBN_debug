...
//SELECT
    ...
    $urutan = "ORDER BY `gx_realisasi_link_budget_maintance`.`id` DESC";
...
//UPDATE
    ...
    $redirect_action_lock = "gx_realisasi_link_budget_maintance";
...
//String Data View
    //Judul Form
    $judul_form = "Master Realisasi Link Budget Maintance";
    $link_form_add_data = '<a href="form_realisasi_link_budget_maintance.php" class="btn bg-maroon btn-flat margin">Create New</a>';
    $judul_table = "Realisasi Link Budget Maintance";
...
if($loggedin["group"] == 'admin'){
    enableLog("", $loggedin["username"], $loggedin["id_employee"], "Open Master Realisasi Link Budget Maintance");
    global $conn;
