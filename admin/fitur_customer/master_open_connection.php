...
//UPDATE
    ...
    $redirect_action_lock = "master_open_connection";
...
//String Data View
    //Judul Form
    $judul_form = "Master Open Connection";
    $link_form_add_data = '<a href="form_open_connection.php" class="btn bg-maroon btn-flat margin">Create New</a>';
    $judul_table = "List Data Open Connection";
    ...
    $submenu_header = 'master_open_connection';
    
    
if($loggedin["group"] == 'admin'){
    enableLog("", $loggedin["username"], $loggedin["id_employee"], "Open Master Off Connection");
    global $conn;
