...
//String Data View
    //Judul Form
    $judul_form = "Form Jawaban SPK Maintance";
    $header_form = "Data Jawaban SPK Maintance";
    $index_field_sql = "id";
    ...
    $form_name = "form_jawaban_spk_maintance";
    $form_id = "form_jawaban_spk_maintance";
...
if(isset($_POST["save"]))
{
   ...
   $no_spk_maintance							= isset($_POST['no_spk_maintance']) ? mysql_real_escape_string(trim($_POST['no_spk_maintance'])) : '';
   $tanggal							= isset($_POST['tanggal']) ? mysql_real_escape_string(trim($_POST['tanggal'])) : '';
   $kode_jawaban_spk_maintance							= isset($_POST['kode_jawaban_spk_maintance']) ? mysql_real_escape_string(trim($_POST['kode_jawaban_spk_maintance'])) : '';
    ...
    */
	...
	window.location.href='".$url_redirect_insert."?c=".$kode_jawaban_spk_maintance."';
	</script>";
...
}elseif(isset($_POST["update"]))
{
	...
	$sql_update = "UPDATE `gx_jawaban_spk_maintance` SET `date_upd`=NOW(),`level`='1',`user_upd`='".$loggedin['username']."' WHERE  `kode_jawaban_spk_maintance`='".$c."'";
	...
	$sql_insert = "INSERT INTO `gx_jawaban_spk_maintance`(`id`, `no_spk_maintance`, `tanggal`, `kode_jawaban_spk_maintance`, `kode_customer`, `nama_customer`, `kode_cabang`, `cabang`, `user_id`, `telp`, `alamat`, `kode_marketing`, `marketing`,  `kode_teknisi_1`, `teknisi_1`, `kode_teknisi_2`, `teknisi_2`, `kode_teknisi_3`, `teknisi_3`, `kode_teknisi_4`, `teknisi_4`, `kode_teknisi_5`, `teknisi_5`, `status_spk`, `pekerjaan`, `solusi`, `kode_list_alat`, `status`, `date_add`, `date_upd`, `user_add`, `user_upd`, `level`)
	VALUES (NULL,'".$no_spk_maintance."','".$tanggal."','".$kode_jawaban_spk_maintance."','".$kode_customer."','".$nama_customer."','".$kode_cabang."','".$cabang."','".$user_id."','".$telp."','".$alamat."','".$kode_marketing."','".$marketing."','".$kode_teknisi_1."','".$teknisi_1."','".$kode_teknisi_2."','".$teknisi_2."','".$kode_teknisi_3."','".$teknisi_3."','".$kode_teknisi_4."','".$teknisi_4."','".$kode_teknisi_5."','".$teknisi_5."','".$status_spk."','".$pekerjaan."','".$solusi."','".$kode_list_alat."','0',NOW(),NOW(),'".$loggedin['username']."','".$loggedin['username']."','0')";
    ...
    $content = '<section class="content-header">
                ...
                <section class="content">
				    ...
				    $content.=' <div class="col-xs-2">
					    ...
					    <div class="col-xs-4">
						<input type="text" readonly="" class="form-control" required="" name="no_spk_maintance" value="'.(isset($_GET['c']) ? $row["no_spk_maintance"] : '').'" onclick="return valideopenerform(\'data_spk_maintance.php?r=form_jawaban_spk_maintance&f=data_jawaban_spk_maintance\',\'jawaban_spk_maintance\');">
					...
					<div class="row">
					    ...
					    <div class="col-xs-10">
						<input readonly="" type="text" class="form-control" required="" name="kode_jawaban_spk_maintance" value="'.(isset($_GET['c']) ? $row["kode_jawaban_spk_maintance"] : "JSB-".rand(0000000, 9999999)).'">
					    </div>
					...
					<div class="row">
					    ...
					    <div class="col-xs-4">
						<input type="text"  class="form-control" name="teknisi_1" value="'.(isset($_GET['c']) ? $row["teknisi_1"] : '').'"  readonly="" onclick="return valideopenerform(\'data_5_teknisi.php?r=form_jawaban_spk_maintance&t=1\',\'teknisi 1\');">
						...
						<div class="col-xs-4">
						<input type="text"  class="form-control" name="marketing" value="'.(isset($_GET['c']) ? $row["marketing"] : '').'"  readonly="" onclick="return valideopenerform(\'data_5_teknisi.php?r=form_jawaban_spk_maintance&t=m\',\'marketing\');">
					...
					<div class="row">
					    ...
					    <div class="col-xs-4">
						<input type="text"  class="form-control" name="teknisi_2" value="'.(isset($_GET['c']) ? $row["teknisi_2"] : '').'" readonly="" onclick="return valideopenerform(\'data_5_teknisi.php?r=form_jawaban_spk_maintance&t=2\',\'teknisi 2\');">
						...
						<div class="col-xs-4">
						<input type="text"  class="form-control" name="teknisi_4" value="'.(isset($_GET['c']) ? $row["teknisi_4"] : '').'"  readonly="" onclick="return valideopenerform(\'data_5_teknisi.php?r=form_jawaban_spk_maintance&t=4\',\'teknisi 4\');">
					...
					<div class="row">
					    ...
					    <div class="col-xs-4">
						<input type="text"  class="form-control" name="teknisi_3" value="'.(isset($_GET['c']) ? $row["teknisi_3"] : '').'" readonly="" onclick="return valideopenerform(\'data_5_teknisi.php?r=form_jawaban_spk_maintance&t=3\',\'teknisi 3\');">
						...
						<div class="col-xs-4">
						<input type="text"  class="form-control" name="teknisi_5" value="'.(isset($_GET['c']) ? $row["teknisi_5"] : '').'"  readonly="" onclick="return valideopenerform(\'data_5_teknisi.php?r=form_jawaban_spk_maintance&t=5\',\'teknisi 5\');">
				...
				$sql2 = "SELECT `id`, `kode_jawaban_spk_maintance`, `kode_list_alat`, `kode_barang`, `nama_barang`, `qty`, `no_seri_number`, `status`, `date_add`, `date_upd`, `user_add`, `user_upd`, `level` FROM `gx_jawaban_spk_maintance_list_alat` WHERE `kode_jawaban_spk_maintance`='".$c."' AND `kode_list_alat`='".$l."'";
