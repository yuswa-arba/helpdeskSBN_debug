                                    ...
                                    <div class="box-body">
										...
										<div class="row">
											...
											if(isset($_GET["id"])){
												...
												$content .='<input type="hidden" class="form-control" id="kode_cabang" name="kode_cabang" required="" value="'.(isset($_GET['id']) ? $row_data["kode_cabang"] : "").'">
                                                <input type="text" readonly="" class="form-control" id="nama_cabang" name="nama_cabang" required="" value="'.(isset($_GET['id']) ? $row_data["nama_cabang"] : "").'"  onclick="return valideopenerform(\'data_cabang.php?r=myForm&f=proposal\',\'cabang\');">';
											}
											$content .='</div>
											<div class="col-xs-3">
												<label>Tanggal</label>
										...
										<div class="row">
											...
											<div class="col-xs-3">
												<input type="text" readonly="" class="form-control" id="kode_proposal" name="kode_proposal" required="" value="'.(isset($_GET['id']) ? $row_data["kode_proposal"] : "").'" >
											</div>
											<div class="col-xs-3">
										...
										<div class="row">
											...
											<div class="col-xs-3">
												<input type="text" class="form-control" id="jangka_waktu_penawaran" name="jangka_waktu_penawaran" required="" value="'.(isset($_GET['id']) ? $row_data["jangka_waktu"] : "").'">
											</div>
											<div class="col-xs-1">
												<label>Hari</label>
											</div>
										...
										<div class="row">
											...
											<div class="col-xs-3">
												<input type="text"  class="form-control" id="setup_fee" name="setup_fee" required="" value="'.(isset($_GET['id']) ? $row_data["setup_fee"] : "").'">
											</div>
										</div>
										</div>
										...
										<div class="row">
											...
											<div class="col-xs-3">
												...
												<input type="text" readonly="" class="form-control" id="nama_paket1" name="nama_paket1" required="" value="'.(isset($_GET['id']) ? $row_data["nama_paket1"] : "").'" onclick="return valideopenerform(\'data_paket.php?r=myForm&f=proposal1\',\'paket\');">
											</div>
											<div class="col-xs-3">
												<label>Monthly Fee</label>
											</div>
											<div class="col-xs-3">
												<input type="text" readonly="" class="form-control" id="monthly_fee1" name="monthly_fee1" required="" value="'.(isset($_GET['id']) ? $row_data["monthly_fee1"] : "").'">
											</div>
										</div>
										</div>
										...
										<div class="row">
											...
											<div class="col-xs-3">
												...
												<input type="text" readonly="" class="form-control" id="nama_paket2" name="nama_paket2" required="" value="'.(isset($_GET['id']) ? $row_data["nama_paket2"] : "").'" onclick="return valideopenerform(\'data_paket.php?r=myForm&f=proposal2\',\'paket\');">
											</div>
											<div class="col-xs-3">
												<label>Monthly Fee</label>
											</div>
											<div class="col-xs-3">
												<input type="text" readonly="" class="form-control" id="monthly_fee2" name="monthly_fee2" required="" value="'.(isset($_GET['id']) ? $row_data["monthly_fee2"] : "").'">
											</div>
										</div>
										</div>
										...
										<div class="row">
											...
											<div class="col-xs-3">
												<input type="hidden" readonly="" class="form-control" id="kode_paket3" name="kode_paket3" required="" value="'.(isset($_GET['id']) ? $row_data["kode_paket3"] : "").'">
												<input type="text" readonly="" class="form-control" id="nama_paket3" name="nama_paket3" required="" value="'.(isset($_GET['id']) ? $row_data["nama_paket3"] : "").'" onclick="return valideopenerform(\'data_paket.php?r=myForm&f=proposal3\',\'paket\');">
											</div>
											<div class="col-xs-3">
												<label>Monthly Fee</label>
											</div>
											<div class="col-xs-3">
												<input type="text" readonly="" class="form-control" id="monthly_fee3" name="monthly_fee3" required="" value="'.(isset($_GET['id']) ? $row_data["monthly_fee3"] : "").'">
											</div>
										</div>
										</div>
										...
										<div class="row">
											...
											<div class="col-xs-3">
												<input type="hidden" readonly="" class="form-control" id="kode_paket4" name="kode_paket4" required="" value="'.(isset($_GET['id']) ? $row_data["kode_paket4"] : "").'">
												<input type="text" readonly="" class="form-control" id="nama_paket4" name="nama_paket4" required="" value="'.(isset($_GET['id']) ? $row_data["nama_paket4"] : "").'" onclick="return valideopenerform(\'data_paket.php?r=myForm&f=proposal4\',\'paket\');">
											</div>
											<div class="col-xs-3">
												<label>Monthly Fee</label>
											</div>
											<div class="col-xs-3">
												<input type="text" readonly="" class="form-control" id="monthly_fee4" name="monthly_fee4" required="" value="'.(isset($_GET['id']) ? $row_data["monthly_fee4"] : "").'">
											</div>
										</div>
										</div>
										...
										<div class="row">
											...
											<div class="col-xs-3">
												<input type="hidden" readonly="" class="form-control" id="kode_paket5" name="kode_paket5" required="" value="'.(isset($_GET['id']) ? $row_data["kode_paket5"] : "").'">
												<input type="text" readonly="" class="form-control" id="nama_paket5" name="nama_paket5" required="" value="'.(isset($_GET['id']) ? $row_data["nama_paket5"] : "").'" onclick="return valideopenerform(\'data_paket.php?r=myForm&f=proposal5\',\'paket\');">
											</div>
											<div class="col-xs-3">
												<label>Monthly Fee</label>
											</div>
											<div class="col-xs-3">
												<input type="text" readonly="" class="form-control" id="monthly_fee5" name="monthly_fee5" required="" value="'.(isset($_GET['id']) ? $row_data["monthly_fee5"] : "").'">
											</div>
										</div>
										</div>
...
if(isset($_POST["save"]))
{
    ...
    $monthly_fee1		= isset($_POST['monthly_fee1']) ? mysql_real_escape_string(trim($_POST['monthly_fee1'])) : '';
    ...
    $monthly_fee2		= isset($_POST['monthly_fee2']) ? mysql_real_escape_string(trim($_POST['monthly_fee2'])) : '';
    ...
    $monthly_fee3		= isset($_POST['monthly_fee3']) ? mysql_real_escape_string(trim($_POST['monthly_fee3'])) : '';
    ...
    $monthly_fee4		= isset($_POST['monthly_fee4']) ? mysql_real_escape_string(trim($_POST['monthly_fee4'])) : '';
    ...
    $monthly_fee5		= isset($_POST['monthly_fee5']) ? mysql_real_escape_string(trim($_POST['monthly_fee5'])) : '';
