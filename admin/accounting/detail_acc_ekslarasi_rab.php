...
if($loggedin = logged_inAdmin()){ // Check if they are logged in
 ...
 enableLog("", $loggedin["username"], $loggedin["id_employee"], "Open Detail ACC Ekslarasi Rencana Anggaran Belanja");
                        ...
                        <div class="col-xs-12">
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">Detail ACC Ekslarasi Rencana Anggaran Belanja</h3>
                                </div><!-- /.box-header -->
                                <!-- form start -->
...
$plugins = '<!-- datepicker -->
    ...
    $title	= 'Detail ACC Ekslarasi RAB Detail';
