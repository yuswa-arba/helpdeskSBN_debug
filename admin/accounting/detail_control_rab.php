...
if(isset($_GET["c"]))
{
	...
	$return_url = 'form_contorl_rab_detail.php?c='.$row_data["kode_rab_control"];
                        ...
                        <div class="col-xs-11">
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">Detail Control Rencana Anggaran Belanja</h3>
                                </div><!-- /.box-header -->
                                <!-- form start -->
