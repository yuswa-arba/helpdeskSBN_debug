...
if(isset($_GET["id"]))
{
    ...
    $query_data		= "SELECT * FROM `gx_rab_ekslarasi` WHERE `id_rab_ekslarasi`='$id_data' LIMIT 0,1;";
                                    ...
                                    <div class="box-body">
										...
										<div class="row">
											...
											<div class="col-xs-3">
                                                ...
                                                <input type="text" readonly="" class="form-control" id="nama_cabang" name="nama_cabang" required="" value="'.(isset($_GET['id']) ? $row_data["nama_cabang"] : "").'"  onclick="return valideopenerform(\'data_cabang.php?r=myForm&f=ekslarasi_rab\',\'cabang\');">
											</div>
											<div class="col-xs-3">
												<label>Tanggal</label>
											</div>
										...
										<div class="row">
											...
											<div class="col-xs-3">
												<input type="text" readonly="" class="form-control" id="kode_rab_ekslarasi" name="kode_rab_ekslarasi" required="" value="'.(isset($_GET['id']) ? $row_data["kode_rab_ekslarasi"] : "").'">
											</div>
											<div class="col-xs-3">
												<label>No ACC RAB</label>
											</div>
											<div class="col-xs-3">
												<input type="text" readonly="" class="form-control" id="kode_rab_persetujuan" name="kode_rab_persetujuan" required="" value="'.(isset($_GET['id']) ? $row_data["kode_rab_persetujuan"] : "").'" onclick="return valideopenerform(\'data_persetujuan_rab.php?r=myForm&f=ekslarasi_rab\',\'cabang\');">
											</div>
										</div>
										</div>
...
if(isset($_POST["save"]))
{
	...
	if($nama_cabang != "" && $kode_rab_persetujuan != "" && $keterangan != ""){
	$sql_insert = "INSERT INTO `gx_rab_ekslarasi` (`id_rab_ekslarasi`, `kode_cabang`, `nama_cabang`,
						  `tanggal`, `kode_rab_ekslarasi`, `kode_rab_persetujuan`, `periode`, `keterangan`, `probability_index`,
	...
	$query_data_detail = "SELECT * FROM `gx_rab_persetujuan_detail` WHERE `kode_rab_persetujuan` ='".$kode_rab_persetujuan."' ;";
    ...
    $sql_insert_detail = "INSERT INTO `gx_rab_ekslarasi_detail` (`id_rab_ekslarasi_detail`, `kode_rab_ekslarasi`, `no_perkiraan`,
					    ...
					    VALUES ('', '".$kode_rab_ekslarasi."', '".$row_data_detail["no_perkiraan"]."',
						    '".$row_data_detail["nama_account"]."', '".$pendapatan_sekarang."', '".$biaya_sekarang."', '".$row_data_detail["pendapatan_sekarang"]."', '".$row_data_detail["biaya_sekarang"]."', '', '', '".$row_data_detail["remarks"]."',
	...
	echo "<script language='JavaScript'>
			...
			window.location.href='".URL_ADMIN."accounting/form_ekslarasi_rab_detail.php?c=$kode_rab_ekslarasi';
			</script>";
...
}elseif(isset($_POST["update"]))
{
    ...
    $sql_update = "UPDATE `gx_rab_ekslarasi` SET `level` = '1',
		    `date_upd` = NOW(), `user_upd`= '".$loggedin["username"]."'
		    WHERE `id_rab_ekslarasi` = '$_GET[id]';";
	...
	$sql_insert_update	=  "INSERT INTO `gx_rab_ekslarasi` (`id_rab_ekslarasi`, `kode_cabang`, `nama_cabang`,
						  `tanggal`, `kode_rab_ekslarasi`, `kode_rab_persetujuan`, `periode`, `keterangan`, `probability_index`,
						  `target_user_baru`, `pembuat_rab`, `pemeriksa_rab`, `status`,
						  `user_add`, `user_upd`, `date_add`, `date_upd`,  `level`) 
					  VALUES ('', '".$kode_cabang."', '".$nama_cabang."',
	...
	echo "<script language='JavaScript'>
			alert('Data telah disimpan');
			window.location.href='".URL_ADMIN."accounting/master_ekslarasi_rab.php';
			</script>";
