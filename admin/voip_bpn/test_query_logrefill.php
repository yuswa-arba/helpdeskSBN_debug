...
if((isset($_POST['username']) && $username!='' && $usernametype!='') || (isset($_POST['lastname']) && $lastname!='') || (isset($_POST['firstname']) && $firstname!='')){
    if(isset($_POST['fromday']) && isset($_POST['today']) && $from_date!='' && $to_date!=''){    
            $sql_from_to_day = isset($_POST['fromday']) && isset($_POST['today']) && $from_date!='' && $to_date!='' ? "(`cc_logrefill`.`date` BETWEEN $from_date AND $to_date)" : "";    
    }elseif(isset($_POST['fromday']) && $from_date!=''){
            $sql_from_to_day = isset($_POST['fromday']) && $from_date!='' ? "`cc_logrefill`.`date`>=$from_date" : "";    
    }elseif(isset($_POST['today']) && $to_date!='' ){
            $sql_from_to_day = isset($_POST['today']) && $to_date!='' ? "`cc_logrefill`.`date`<=$to_date" : "";
    }else{
            $sql_from_to_day = "";
    }
}else{
...
$sql_where                                  = (isset($_POST['fromday']) && isset($_POST['today']) && $to_date!='' && $from_date!='') || (isset($_POST['username']) && $username!='' && $usernametype!='') || (isset($_POST['lastname']) && $lastname!='') || (isset($_POST['firstname']) && $firstname!='') ? "WHERE" : "";
