...
$no = 1;
	...
	$content .='<tr>
		    ...
		    <td>'.$row_customer["cNonAktiv"].'</td>-->
                    <td>
                      <a href="" onclick="validepopupform2(\''.$row_customer["cUserID"].'\',\''.$row_customer["cKode"].'\',\''.$row_customer["cNama"].'\',\''.$row_customer["cAlamat1"].'\',\''.$row_customer["cNamaPers"].'\',\''.$row_customer["cKota"].'\',\''.$row_customer["cfax"].'\',\''.$row_customer["ctelp"].'\',\''.$row_customer["cEmail"].'\',\''.$row_customer["cPaket"].'\')">Select</a>
                    </td>
                  </tr>';
	$no++;
    }
...
<script type="text/javascript">
	...
	function validepopupform2(uid, custNumber, nama, alamat, namaperusahaan, kota, fax, ctelp, cemail, con_type){
