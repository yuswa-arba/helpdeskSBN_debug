...
if(isset($_POST["save"]))
{
	...
	window.location.href='".URL_ADMIN."voip_bpn/payment.php';
	</script>";
    ...
    $content = '
                ...
                <section class="content">
					...
					<div class="row">
						...
						<a href="'.URL_ADMIN.'voip_bpn/data_subscription.php?r=form_payment" class="btn bg-olive btn-flat margin pull-right" onclick="return valideopenerform(\''.URL_ADMIN.'voip_bpn/data_subscription.php?r=form_payment\',\'payment\');">Select</a>
					    </div>
                                        </div>
					</div>
