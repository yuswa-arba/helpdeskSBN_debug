...
if($loggedin["group"] == 'admin'){
	...
	*/
	...
	<table cellspacing="2" class="addform_table1"  style="display: table;border-collapse: separate;border-spacing: 2px;border-color: gray;">
		...
		<td width="%75" valign="top" class="tableBodyRight" >
		    <input class="form_input_text" name="useralias" size="20" value="'.(isset($_GET["cust_id"]) ? $row_data_cust["useralias"] : $random_15_number).'" maxlength="40">
		    <span class="liens"></span> 
		</td>
	    </tr>
	    <tr>
		...
		<td width="%75" valign="top" class="tableBodyRight" >
	            <input class="form_input_text" name="uipass" size="20" value="'.(isset($_GET["cust_id"]) ? $row_data_cust["uipass"] : $random_10_number).'" maxlength="20">
		    <span class="liens"></span> 
