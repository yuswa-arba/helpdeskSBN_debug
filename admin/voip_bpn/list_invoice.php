    ...
    $content ='
                ...
                <section class="content">
					...
					<div class="btn bg-olive btn-flat margin">
					     <a href="'.URL_ADMIN.'voip/form_invoice.php">Create Invoice</a>
					</div>
...
while($row_invoice = mysql_fetch_array($query_invoice))
{
    ...
    $content .='<tr>
                    <td>'.$no.'.</td>
                    <td><a href="'.URL_ADMIN.'voip/invoice.php?id='.$row_invoice["id_invoice"].'" target="_blank">
                    ...
                    <td>'.$status.'</td>
                    <td><a href="'.URL_ADMIN.'voip/invoice.php?id='.$row_invoice["id_invoice"].'" target="_blank">Detail</a> | 
                    <a href="'.URL_ADMIN.'voip/detail_invoice.php?id='.$row_invoice["id_invoice"].'" target="_blank">PDF</a> | 
                    <a href="'.URL_ADMIN.'voip/detail_invoice.php?id='.$row_invoice["id_invoice"].'" target="_blank">Pay</a></td>
                </tr>';
    $no++;
}
