...
if($loggedin["group"] == 'admin'){
    enableLog("", $loggedin["username"], $loggedin["id_employee"], "Open List data numb cust");
    global $conn;
    global $conn_voip;
...
<script type=\'text/javascript\'>
	function validepopupform(n_cust){
		window.opener.document.myForm.numb_customer.value=n_cust;
		self.close();
        }
</script>';
?>
...
$no = 1;
	...
	$content .='<tr>
		    ...
		    <td>
                      <a href="" onclick="validepopupform(\''.$row_card['username'].'\')">Select</a>
                    </td>
                  </tr>';
	$no++;
    }
