...
if(isset($_POST["save_search"])){
	...
	$sql_voipnumber	= "SELECT * FROM `gx_voip_nomerTelpon` WHERE `status` = '2' AND `kode` = '0542' AND `level` = '0' $sql_voip_number ORDER BY `id` ASC LIMIT 0,10;";
}else{
 $sql_voipnumber	= "SELECT * FROM `gx_voip_nomerTelpon` WHERE `status` = '2' AND `kode` = '0542' AND `level` = '0' ORDER BY `id` ASC LIMIT 0,10;";
