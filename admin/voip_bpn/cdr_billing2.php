...
{
	$sql_prefix = mysql_query("SELECT `dialprefix` FROM `cc_ratecard`;",$conn_voip);
	$prefix = array();
...
//echo toSeconds(date("H") , date("i"), date("N"));
//echo date("H").', '.date("i").', '.date("N");
$no = $start + 1;
