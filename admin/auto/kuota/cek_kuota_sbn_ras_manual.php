...
foreach ($row_all_user as $rows)
{
    ...
    // kuota 1-10GB : 10Mbps
    if(($total_kuota_rbs_ras > 1) AND ($total_kuota_rbs_ras <= (5*1000*1024*1024)) )
    {
	...
	// kuota 10-15GB : 5Mbps
    elseif(($total_kuota_rbs_ras > (5*1000*1024*1024)) AND ($total_kuota_rbs_ras <= (8*1000*1024*1024)) )
    {
	...
	// kuota 15-19GB : 2Mbps
    elseif(($total_kuota_rbs_ras > (8*1000*1024*1024)) AND ($total_kuota_rbs_ras <= (15*1000*1024*1024)) )
    {
	...
	// kuota >19GB : 1Mbps
    elseif(($total_kuota_rbs_ras > (15*1000*1024*1024)) )
    {
