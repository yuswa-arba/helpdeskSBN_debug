...
if(isset($_POST["save"]))
{
    ...
    $id_vod         = isset($_POST['id_vod']) ? mysql_real_escape_string(trim($_POST['id_vod'])) : '';
    ...
    $sql_insert = "INSERT INTO `gx_vod_invoice` (`id_invoice`, `invoice_number`, `id_vod`, `id_paket`,
                    `invoice_date`, `invoice_duedate`, `invoice_amount`, `invoice_status`, `invoice_desc`,
                    `user_add`, `user_upd`, `date_add`, `date_upd`, `level`)
                    VALUES (NULL, '".$invoice_number."', '".$id_vod."', '".$id_paket."',
...
}elseif(isset($_POST["update"]))
{
    ...
    $sql_update = "UPDATE `gx_vod_invoice` SET `invoice_number` = '".$invoice_number."',
                    `id_vod` = '".$id_vod."', `id_paket` = '".$id_paket."',
    ...
    $content ='<section class="content-header">
                ...
                <section class="content">
					...
					<div class="row">
					    ...
					    <div class="col-xs-6">
						<input type="text" class="form-control" name="id_vod" value="'.(isset($_GET['id']) ? $row_invoice["id_vod"] : "").'">
					    </div>
                                        </div>
					</div>
