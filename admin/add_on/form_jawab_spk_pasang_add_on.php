                        ...
                        <div class="col-xs-10">
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">Form Jawab SPK Pasang add_on</h3>
                                </div><!-- /.box-header -->
                                <!-- form start -->
                                <form role="form" method="POST" name="myForm" action="" enctype="multipart/form-data" >
                                    <div class="box-body">
										...
										<div class="row">
											...
											<div class="col-xs-3">
												<input type="text" class="form-control" readonly="" id="kode_spk_pasang_add_on" name="kode_spk_pasang_add_on" required="" value="'.(isset($_GET['id']) ? $row_data["kode_spk_pasang_add_on"] : "").'" onclick="return valideopenerform(\'data_spk_pasang_add_on.php?r=myForm&f=jawab_spk_pasang_add_on\',\'customer\');" >
											</div>
										</div>
										</div> 
										...
										<div class="row">
											...
											<div class="col-xs-4">
												...
												<input class="form-control" readonly="" onclick="valideopenerform(\'data_teknisi.php?r=myForm&t=2\',\'teknisi\');" name="nama_teknisi_2" placeholder="Nama Teknisi" type="text" value="'.(isset($_GET['id']) ? $data_data_teknisi2['cNama'] :"") .'">
											</div>
											<div class="col-xs-2">
											...
											<div class="col-xs-4">
												...
												<input class="form-control" readonly="" onclick="valideopenerform(\'data_teknisi.php?r=myForm&t=4\',\'teknisi4\');" name="nama_teknisi_4" placeholder="Nama Teknisi" type="text" value="'.(isset($_GET['id']) ? $data_data_teknisi4['cNama'] :"") .'">
											</div>
										</div>
										</div>
										...
										<div class="row">
											...
											<div class="col-xs-4">
												<input class="form-control" readonly="" name="id_teknisi_3" type="hidden" value="'.(isset($_GET['id']) ? $row_data['id_teknisi_3'] :"") .'">
													<input class="form-control" readonly="" onclick="valideopenerform(\'data_teknisi.php?r=myForm&t=3\',\'teknisi3\');" name="nama_teknisi_3" placeholder="Nama Teknisi" type="text" value="'.(isset($_GET['id']) ? $data_data_teknisi3['cNama'] :"") .'">
											</div>
											<div class="col-xs-2">
											...
											<div class="col-xs-4">
												...
												<input class="form-control" readonly="" onclick="valideopenerform(\'data_teknisi.php?r=myForm&t=5\',\'teknisi5\');" name="nama_teknisi_5" placeholder="Nama Teknisi" type="text" value="'.(isset($_GET['id']) ? $data_data_teknisi5['cNama'] :"") .'">
											</div>
										</div>
										</div>
...
if(isset($_POST["save"]))
{
    ...
    if($nama_cabang != "" && $kode_jawab_spk_pasang_add_on != "" && $kode_spk_pasang_add_on != "" && $kode_linkbudget != ""){
    $sql_insert = "INSERT INTO `gx_jawab_spk_pasang_add_on` (`id_jawab_spk_pasang_add_on`, `kode_cabang`, `nama_cabang`,
						  `tanggal`, `kode_jawab_spk_pasang_add_on`, `kode_spk_pasang_add_on`, `kode_customer`, `nama_customer`, `kode_paket`, 
	...
	echo "<script language='JavaScript'>
			...
			window.location.href='".URL_ADMIN."add_on/master_jawab_spk_pasang_add_on.php';
			</script>";
...
}elseif(isset($_POST["update"]))
{
    ...
    $sql_update = "UPDATE `gx_jawab_spk_pasang_add_on` SET `level` = '1',
		    `date_upd` = NOW(), `user_upd`= '".$loggedin["username"]."'
		    WHERE `id_jawab_spk_pasang_add_on` = '$_GET[id]';";
	...
	$sql_insert_update = "INSERT INTO `gx_jawab_spk_pasang_add_on` (`id_jawab_spk_pasang_add_on`, `kode_cabang`, `nama_cabang`,
						  `tanggal`, `kode_jawab_spk_pasang_add_on`, `kode_spk_pasang_add_on`, `kode_customer`, `nama_customer`, `kode_paket`, 
						  `nama_paket`, `uid`, `telp`, `kode_linkbudget`, `alamat`, `id_teknisi`, `id_marketing`, `id_teknisi_2`,
						  `id_teknisi_3`, `id_teknisi_4`, `id_teknisi_5`, `status`, `pekerjaan`, `solusi`, `alat_terpasang`, 
						  `user_add`, `user_upd`, `date_add`, `date_upd`,  `level`) 
...
$plugins = '<!-- datepicker -->
    ...
    $title	= 'Form Jawab SPK Pasang Add On';
