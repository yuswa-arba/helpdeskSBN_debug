...
include ("../../config/configuration_admin.php");
    ...
    $sql_data	= mysql_query("SELECT * FROM `gx_spk_aktivasi_add_on` WHERE  `gx_spk_aktivasi_add_on`.`id_spk_aktivasi_add_on` = '$id_data'", $conn);
    ...
    $row_spk        = mysql_fetch_array($sql_data);
      ...
      <tr>
        ...
        <td width="700" colspan="2"> <br /><table width="700" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td width="10" valign="top">:</td>
            <td width="275" valign="top"><strong>'.$row_spk["kode_spk_aktivasi_add_on"].'</strong></td>
          </tr>
          <tr>
        ...
        <td colspan="2"><table width="800" align="center" cellpadding="0" cellspacing="0" style="padding-left: 50px;padding-top: 20px;">
         <tr>
          ...
          <tr>
            ...
            <td valign="top">:</td>
            <td valign="top"><strong> Aktivasi Add On </strong></td>
          </tr>
          <tr>
