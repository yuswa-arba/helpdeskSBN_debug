...
if($loggedin = logged_inAdmin()){ // Check if they are logged in
 ...
 enableLog("", $loggedin["username"], $loggedin["id_employee"], "Open Form Jawab SPK Aktivasi Add On");
 
if(isset($_GET["id"]))
{
    $id_data		= isset($_GET['id']) ? (int)$_GET['id'] : '';
    $query_data		= "SELECT * FROM `gx_jawab_spk_aktivasi_add_on` WHERE `id_jawab_spk_aktivasi_add_on`='$id_data' LIMIT 0,1;";
    $sql_data		= mysql_query($query_data, $conn);
    $row_data		= mysql_fetch_array($sql_data);
	$data_teknisi = mysql_fetch_array(mysql_query("SELECT `cNama` FROM `tbPegawai` WHERE `id_employee`='$row_data[id_teknisi]'", $conn));
	$data_marketing = mysql_fetch_array(mysql_query("SELECT `cNama` FROM `tbPegawai` WHERE `id_employee`='$row_data[id_marketing]'", $conn));
	$data_teknisi_2 = mysql_fetch_array(mysql_query("SELECT `cNama` FROM `tbPegawai` WHERE `id_employee`='$row_data[id_teknisi_2]'", $conn));
	$data_teknisi_3 = mysql_fetch_array(mysql_query("SELECT `cNama` FROM `tbPegawai` WHERE `id_employee`='$row_data[id_teknisi_3]'", $conn));
	$data_teknisi_4 = mysql_fetch_array(mysql_query("SELECT `cNama` FROM `tbPegawai` WHERE `id_employee`='$row_data[id_teknisi_4]'", $conn));
	$data_teknisi_5 = mysql_fetch_array(mysql_query("SELECT `cNama` FROM `tbPegawai` WHERE `id_employee`='$row_data[id_teknisi_5]'", $conn));
}

    $content ='<section class="content-header">
                    <h1>
                        Form Jawab SPK Aktivasi Add On
                    </h1>
                        ...
                        <div class="col-xs-10">
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">Form Jawab SPK Aktivasi Add On</h3>
                                </div><!-- /.box-header -->
                                <!-- form start -->
                                <form role="form" method="POST" name="myForm" action="" enctype="multipart/form-data" >
                                    <div class="box-body">
										...
										if(isset($_GET["id"])){
											...
											$content .='<div class="col-xs-3">
															<input type="text" class="form-control" readonly=""  name="nama_cabang" value="'.(isset($_GET['id']) ? $row_data["nama_cabang"] : "").'" onclick="return valideopenerform(\'data_cabang.php?r=myForm&f=jawab_spk_aktivasi_add_on\',\'cabang\');">
															<input type="hidden" class="form-control" name="kode_cabang" value="'.(isset($_GET['id']) ? $row_data["kode_cabang"] : "").'">
														</div>';
										}
										$content .='
										...
										<div class="row">
											<div class="col-xs-3">
												<label>No Jawab SPK Aktivasi Add On</label>
											</div>
											<div class="col-xs-3">
												<input type="text" readonly="" readonly=""  class="form-control" id="kode_jawab_spk_aktivasi_add_on" name="kode_jawab_spk_aktivasi_add_on" required="" value="'.(isset($_GET['id']) ? $row_data["kode_jawab_spk_aktivasi_add_on"] : "").'">
											</div>
											<div class="col-xs-3">
												<label>No SPK Aktivasi</label>
											</div>
											<div class="col-xs-3">
												<input type="text" class="form-control" readonly="" id="kode_spk_aktivasi_add_on" name="kode_spk_aktivasi_add_on" required="" value="'.(isset($_GET['id']) ? $row_data["kode_spk_aktivasi_add_on"] : "").'" onclick="return valideopenerform(\'data_spk_aktivasi_add_on.php?r=myForm&f=jawab_spk_aktivasi_add_on\',\'customer\');" >
											</div>
										</div>
										</div>
										...
										<div class="row">
											...
											<div class="col-xs-3">
												...
												<input class="form-control" readonly="" name="nama_teknisi" placeholder="Nama Teknisi" type="text" value="'.(isset($_GET['id']) ? $data_teknisi['cNama'] :"") .'">
											</div>
											<div class="col-xs-3">
											...
											<div class="col-xs-3">
												...
												<input class="form-control" readonly="" name="nama_marketing" placeholder="Marketing" type="text" value="'.(isset($_GET['id']) ? $data_marketing['cNama'] :"").'">
											</div>
										</div>
										</div>
										...
										<div class="row">
											...
											<div class="col-xs-3">
												...
												<input class="form-control" readonly="" onclick="valideopenerform(\'data_teknisi.php?r=myForm&t=2\',\'teknisi\');" name="nama_teknisi_2" placeholder="Nama Teknisi" type="text" value="'.(isset($_GET['id']) ? $data_teknisi_2['cNama'] :"") .'">
											</div>
											<div class="col-xs-3">
											...
											<div class="col-xs-3">
												...
												<input class="form-control" readonly="" onclick="valideopenerform(\'data_teknisi.php?r=myForm&t=4\',\'teknisi4\');" name="nama_teknisi_4" placeholder="Nama Teknisi" type="text" value="'.(isset($_GET['id']) ? $data_teknisi_4['cNama'] :"") .'">
											</div>
										</div>
										</div>
										...
										<div class="row">
											...
											<div class="col-xs-3">
												<input class="form-control" readonly="" name="id_teknisi_3" type="hidden" value="'.(isset($_GET['id']) ? $row_data['id_teknisi_3'] :"") .'">
													<input class="form-control" readonly="" onclick="valideopenerform(\'data_teknisi.php?r=myForm&t=3\',\'teknisi3\');" name="nama_teknisi_3" placeholder="Nama Teknisi" type="text" value="'.(isset($_GET['id']) ? $data_teknisi_3['cNama'] :"") .'">
											</div>
											<div class="col-xs-3">
											...
											<div class="col-xs-3">
												...
												<input class="form-control" readonly="" onclick="valideopenerform(\'data_teknisi.php?r=myForm&t=5\',\'teknisi5\');" name="nama_teknisi_5" placeholder="Nama Teknisi" type="text" value="'.(isset($_GET['id']) ? $data_teknisi_5['cNama'] :"") .'">
											</div>
										</div>
										</div>
										...
										<div class="row">
											...
											<div  class="col-xs-9">
												<textarea name="solusi" class="form-control" placeholder="Solusi" style="resize: none;">'.(isset($_GET["id"]) ? $row_data['solusi'] :"").'</textarea>
											</div>
										</div>
										</div>
										...
										<div class="row">
											...
											<div  class="col-xs-9">
												<textarea name="alat_terpasang" class="form-control" placeholder="Alat Yang Terpasang" style="resize: none;">'.(isset($_GET["id"]) ? $row_data['alat_terpasang'] :"").'</textarea>
											</div>
										</div>
										</div>
...
if(isset($_POST["save"]))
{
    ...
    $kode_jawab_spk_aktivasi_add_on 			= isset($_POST['kode_jawab_spk_aktivasi_add_on']) ? mysql_real_escape_string(trim($_POST['kode_jawab_spk_aktivasi_add_on'])) : '';
	$kode_spk_aktivasi_add_on 		= isset($_POST['kode_spk_aktivasi_add_on']) ? mysql_real_escape_string(trim($_POST['kode_spk_aktivasi_add_on'])) : '';
	...
	if($nama_cabang != "" && $kode_jawab_spk_aktivasi_add_on != "" && $kode_spk_aktivasi_add_on != "" && $no_linkbudget != ""){
	$sql_insert = "INSERT INTO `gx_jawab_spk_aktivasi_add_on` (`id_jawab_spk_aktivasi_add_on`, `kode_cabang`, `nama_cabang`,
						  `tanggal`, `kode_jawab_spk_aktivasi_add_on`, `kode_spk_aktivasi_add_on`, `kode_customer`, `nama_customer`, `uid`, `telp`, `kode_paket`,
					  ...
					  VALUES ('', '".$kode_cabang."', '".$nama_cabang."',
						  ...
						  '".$no_linkbudget."', 'AKTIVASI ADD ON', '".$solusi."', '".$alat_terpasang."',
	...
	echo "<script language='JavaScript'>
			...
			window.location.href='".URL_ADMIN."add_on/master_jawab_spk_aktivasi_add_on.php';
			</script>";
...
}elseif(isset($_POST["update"]))
{
    ...
    $sql_update = "UPDATE `gx_jawab_spk_aktivasi_add_on` SET `level` = '1',
		    `date_upd` = NOW(), `user_upd`= '".$loggedin["username"]."'
		    WHERE `id_jawab_spk_aktivasi_add_on` = '$_GET[id]';";
	...
	$sql_insert_update	= "INSERT INTO `gx_jawab_spk_aktivasi_add_on` (`id_jawab_spk_aktivasi_add_on`, `kode_cabang`, `nama_cabang`,
						  `tanggal`, `kode_jawab_spk_aktivasi_add_on`, `kode_spk_aktivasi_add_on`, `kode_customer`, `nama_customer`, `uid`, `telp`, `kode_paket`,
						  `nama_paket`, `alamat`, `id_teknisi`, `id_marketing`, `id_teknisi_2`, `id_teknisi_3`, `id_teknisi_4`, `id_teknisi_5`, `status`,
						  `no_linkbudget`, `pekerjaan`, `solusi`, `alat_terpasang`,
						  `user_add`, `user_upd`, `date_add`, `date_upd`,  `level`) 
...
$plugins = '<!-- datepicker -->
    ...
    $title	= 'Form Jawab SPK Aktivasi Add On';
    $submenu	= "jawab_spk_aktivasi_add_on";
    //$plugins	= '';
