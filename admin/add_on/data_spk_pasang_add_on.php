...
if(isset($_POST["save_search"])){
	...
	$sql_customer	= "SELECT * FROM `gx_spk_pasang_add_on`
	WHERE `kode_customer` LIKE '".$customer_number."%'
	$sql_nama
	$sql_userid
	AND `level` = '0'
	ORDER BY `id_spk_pasang_add_on` DESC LIMIT 0,10;";
...
$no = 1;
if(isset($_GET["f"])){
 if($_GET["f"] == "jawab_spk_pasang_add_on"){
