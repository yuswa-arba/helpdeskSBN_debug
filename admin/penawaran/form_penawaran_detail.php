...
$content .='							    <tr>
					...
					<div class="row">
					    ...
					    <div class="col-xs-8">
							<input type="text" class="form-control" required="" name="quantity" id="quantity" value="'.(isset($_GET['id']) ? $row_penawaran_detail["quantity"] : "").'" >
					    </div>
                    </div>
					</div>
					...
					<div class="row">
					    ...
					    <div class="col-xs-8">
							<input type="text" class="form-control" required="" name="price" id="price" value="'.(isset($_GET['id']) ? $row_penawaran_detail["price"] : "").'">
					    </div>
                    </div>
					</div>
					...
					<div class="row">
					    ...
					    <div class="col-xs-8">
							<input type="text" class="form-control" required="" name="amount" id="amount" value="'.(isset($_GET['id']) ? $row_penawaran_detail["amount"] : "").'">
					    </div>
                    </div>
					</div>
...
}elseif(isset($_POST["update"]))
{
    ...
    $sql_update = "UPDATE `gx_penawaran_detail_detail` SET `level` = '1',
		    `date_upd` = NOW(), `user_upd`= '".$loggedin["username"]."'
		    WHERE `id_penawaran_detail_detail` = '$_GET[id]';";
