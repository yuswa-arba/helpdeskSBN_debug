...
if(isset($_POST["save"]))
{
    ...
    $alamat_cabang  = isset($_POST['alamat_cabang']) ? mysql_real_escape_string(strip_tags(trim($_POST['alamat_cabang']))) : '';
    $kota_cabang    = isset($_POST['kota_cabang']) ? mysql_real_escape_string(strip_tags(trim($_POST['kota_cabang']))) : '';
    $telp_cabang    = isset($_POST['telp_cabang']) ? mysql_real_escape_string(strip_tags(trim($_POST['telp_cabang']))) : '';
    $email_cabang   = isset($_POST['email_cabang']) ? mysql_real_escape_string(strip_tags(trim($_POST['email_cabang']))) : '';
    $invoice_code   = isset($_POST['invoice_code']) ? mysql_real_escape_string(strip_tags(trim($_POST['invoice_code']))) : '';
    
    $kode_pos	    = isset($_POST['kode_pos']) ? mysql_real_escape_string(strip_tags(trim($_POST['kode_pos']))) : '';
    $fax_cabang	    = isset($_POST['fax_cabang']) ? mysql_real_escape_string(strip_tags(trim($_POST['fax_cabang']))) : '';
    $web_cabang	    = isset($_POST['web_cabang']) ? mysql_real_escape_string(strip_tags(trim($_POST['web_cabang']))) : '';
    $email_cso	    = isset($_POST['email_cso']) ? mysql_real_escape_string(strip_tags(trim($_POST['email_cso']))) : '';
    $email_info	    = isset($_POST['email_info']) ? mysql_real_escape_string(strip_tags(trim($_POST['email_info']))) : '';
    $kode_bm	    = isset($_POST['kode_bm']) ? mysql_real_escape_string(strip_tags(trim($_POST['kode_bm']))) : '';
    $kode_bk	    = isset($_POST['kode_bk']) ? mysql_real_escape_string(strip_tags(trim($_POST['kode_bk']))) : '';
    $kode_km	    = isset($_POST['kode_km']) ? mysql_real_escape_string(strip_tags(trim($_POST['kode_km']))) : '';
    $kode_kk	    = isset($_POST['kode_kk']) ? mysql_real_escape_string(strip_tags(trim($_POST['kode_kk']))) : '';
    $kode_cm	    = isset($_POST['kode_cm']) ? mysql_real_escape_string(strip_tags(trim($_POST['kode_cm']))) : '';
    $kode_billing_data	    = isset($_POST['kode_billing_data']) ? mysql_real_escape_string(strip_tags(trim($_POST['kode_billing_data']))) : '';
    $kode_billing_voice	    = isset($_POST['kode_billing_voice']) ? mysql_real_escape_string(strip_tags(trim($_POST['kode_billing_voice']))) : '';
    $kode_billing_video	    = isset($_POST['kode_billing_video']) ? mysql_real_escape_string(strip_tags(trim($_POST['kode_billing_video']))) : '';
    $kode_spk_survey	    = isset($_POST['kode_spk_survey']) ? mysql_real_escape_string(strip_tags(trim($_POST['kode_spk_survey']))) : '';
    
    $kode_prospek	    = isset($_POST['kode_prospek']) ? mysql_real_escape_string(strip_tags(trim($_POST['kode_prospek']))) : '';
    $kode_jawab_survey	    = isset($_POST['kode_jawab_survey']) ? mysql_real_escape_string(strip_tags(trim($_POST['kode_jawab_survey']))) : '';
    $kode_formulir	    = isset($_POST['kode_formulir']) ? mysql_real_escape_string(strip_tags(trim($_POST['kode_formulir']))) : '';
    $kode_link_budget	    = isset($_POST['kode_link_budget']) ? mysql_real_escape_string(strip_tags(trim($_POST['kode_link_budget']))) : '';
    $kode_justifikasi	    = isset($_POST['kode_justifikasi']) ? mysql_real_escape_string(strip_tags(trim($_POST['kode_spk_survey']))) : '';
    $kode_acc_justifikasi   = isset($_POST['kode_acc_justifikasi']) ? mysql_real_escape_string(strip_tags(trim($_POST['kode_acc_justifikasi']))) : '';
    $kode_spk_pasang	    = isset($_POST['kode_spk_pasang']) ? mysql_real_escape_string(strip_tags(trim($_POST['kode_spk_pasang']))) : '';
    $kode_jawab_pasang	    = isset($_POST['kode_jawab_pasang']) ? mysql_real_escape_string(strip_tags(trim($_POST['kode_jawab_pasang']))) : '';
    $kode_spk_aktivasi	    = isset($_POST['kode_spk_aktivasi']) ? mysql_real_escape_string(strip_tags(trim($_POST['kode_spk_aktivasi']))) : '';
    $kode_jawab_aktivasi    = isset($_POST['kode_jawab_aktivasi']) ? mysql_real_escape_string(strip_tags(trim($_POST['kode_jawab_aktivasi']))) : '';
    $kode_realisasi_link_budget	    = isset($_POST['kode_realisasi_link_budget']) ? mysql_real_escape_string(strip_tags(trim($_POST['kode_realisasi_link_budget']))) : '';
    
    $kode_beli	    = isset($_POST['kode_beli']) ? mysql_real_escape_string(strip_tags(trim($_POST['kode_beli']))) : '';
    $kode_pbeli	    = isset($_POST['kode_pbeli']) ? mysql_real_escape_string(strip_tags(trim($_POST['kode_pbeli']))) : '';
    $kode_sbeli	    = isset($_POST['kode_sbeli']) ? mysql_real_escape_string(strip_tags(trim($_POST['kode_sbeli']))) : '';
    $kode_mbeli	    = isset($_POST['kode_mbeli']) ? mysql_real_escape_string(strip_tags(trim($_POST['kode_mbeli']))) : '';
    $kode_po	    = isset($_POST['kode_po']) ? mysql_real_escape_string(strip_tags(trim($_POST['kode_po']))) : '';
	...
	`kode_beli`, `kode_mbeli`, `kode_sbeli`, `kode_pbeli`, `kode_po`,
	...
	window.location.href='master_cabang.php';
	</script>";
    }else{
	echo "<script language='JavaScript'>
...
}elseif(isset($_POST["update"]))
{
    ...
    if($kode_cabang != "" AND $id_cabang !=""){
		$sql_update = "UPDATE `gx_cabang` SET `kode_cabang` = '".$kode_cabang."', `nama_cabang` = '".$nama_cabang."', `alamat_cabang` = '".$alamat_cabang."',
		`kota_cabang` = '".$kota_cabang."', `kode_pos` = '".$kode_pos."',
		`telp_cabang` = '".$telp_cabang."', `fax_cabang` = '".$fax_cabang."', `web_cabang` = '".$web_cabang."', `email_cso` = '".$email_cso."',
		`email_info` = '".$email_info."', `kode_bm` = '".$kode_bm."', `kode_bk` = '".$kode_bk."',
		`kode_km` = '".$kode_km."', `kode_kk` = '".$kode_kk."', `kode_cm` = '".$kode_cm."', `kode_billing_data` = '".$kode_billing_data."',
		`kode_billing_voice` = '".$kode_billing_voice."', `kode_billing_video` = '".$kode_billing_video."', `kode_prospek` = '".$kode_prospek."',
		`kode_spk_survey` = '".$kode_spk_survey."', `kode_jawab_survey` = '".$kode_jawab_survey."', `kode_formulir` = '".$kode_formulir."',
		`kode_link_budget` = '".$kode_link_budget."', `kode_justifikasi` = '".$kode_justifikasi."', `kode_acc_justifikasi` = '".$kode_acc_justifikasi."',
		`kode_spk_pasang` = '".$kode_spk_pasang."', `kode_jawab_pasang` = '".$kode_jawab_pasang."', `kode_spk_aktivasi` = '".$kode_spk_aktivasi."',
		`kode_jawab_aktivasi` = '".$kode_jawab_aktivasi."', `kode_realisasi_link_budget` = '".$kode_realisasi_link_budget."',
		`kode_beli` = '".$kode_beli."', `kode_mbeli` = '".$kode_mbeli."', `kode_sbeli` = '".$kode_sbeli."', `kode_pbeli` = '".$kode_pbeli."', `kode_po` = '".$kode_po."',
    ...
    $content ='
                ...
                <section class="content">
					...
					<div class="row">
					    ...
					    <div class="col-xs-6">
						<input type="text" class="form-control" id="kode_mbeli" name="kode_mbeli" value="'.(isset($_GET['id']) ? $row_cabang["kode_mbeli"] : "").'">
					    </div>
                                        </div>
					</div>
					...
					<div class="row">
					    ...
					    <div class="col-xs-6">
						<input type="text" class="form-control" id="kode_pbeli" name="kode_pbeli" value="'.(isset($_GET['id']) ? $row_cabang["kode_mbeli"] : "").'">
					    </div>
                                        </div>
					</div>
					...
					<div class="row">
					    ...
					    <div class="col-xs-6">
						<input type="text" class="form-control" id="kode_sbeli" name="kode_sbeli" value="'.(isset($_GET['id']) ? $row_cabang["kode_sbeli"] : "").'">
					    </div>
                                        </div>
					</div>
					...
					<div class="row">
					    ...
					    <div class="col-xs-6">
						<input type="text" class="form-control" id="kode_beli" name="kode_beli" value="'.(isset($_GET['id']) ? $row_cabang["kode_beli"] : "").'">
					    </div>
                                        </div>
					</div>
					...
					<div class="row">
					    ...
					    <div class="col-xs-6">
						<input type="text" class="form-control" id="kode_po" name="kode_po" value="'.(isset($_GET['id']) ? $row_cabang["kode_po"] : "").'">
					    </div>
                                        </div>
					</div>
...
$plugins = '
	...
	<script type="text/javascript">
		...
		document.getElementById("kode_mbeli1").value = kodecab;
		document.getElementById("kode_pbeli1").value = kodecab;
		document.getElementById("kode_sbeli1").value = kodecab;
		document.getElementById("kode_beli1").value = kodecab;
		document.getElementById("kode_po1").value = kodecab;
