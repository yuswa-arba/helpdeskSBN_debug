...
if(isset($_POST["save"]))
{
	...
	window.location.href='master_level.php';
	</script>";
...
}elseif(isset($_POST["update"]))
{
    ...
    //insert into gx_bagian
    $sql_update_level = "UPDATE `gx_tblevel` SET `level` = '1',
...
if(isset($_GET["id"]))
{
    ...
    $query_level 	= "SELECT * FROM `gx_tblevel` WHERE `id_level`='$id_level' AND `level` = '0' LIMIT 0,1;";
    ...
    $content ='<section class="content-header">
                ...
                <section class="content">
					...
					<div class="row">
					    ...
					    <div class="col-xs-6">
						'.(isset($_GET['id']) ? $row_level["user_add"] : $loggedin["username"]).'
					    </div>
					...
					<div class="row">
					    ...
					    <div class="col-xs-6">
						'.(isset($_GET['id']) ? $row_level["user_upd"]." ".$row_level["date_upd"] : "").'
					    </div>
