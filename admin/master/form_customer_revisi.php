...
$content .='						</select>
					...
					<div class="row">
					    ...
					    <div class="col-xs-8">
						<input type="text" class="form-control" required="" name="nama_bank" value="'.(isset($_GET['id']) ? $row_promosi["nama_bank"] : "").'">
					    </div>
                    </div>
					</div>
					<div class="form-group">
					<div class="row">
					    ...
					    <div class="col-xs-8">
						<input type="text" class="form-control" required="" name="nama_rekening" value="'.(isset($_GET['id']) ? $row_promosi["nama_rekening"] : "").'">
					    </div>
                    </div>
					</div>
					<div class="form-group">
					<div class="row">
					    ...
					    <div class="col-xs-8">
						<input type="text" class="form-control"  maxlength="10" name="nominal" value="'.(isset($_GET['id']) ? $row_promosi["nominal"] : "").'">
					    </div>
                    </div>
					</div>
					<div class="form-group">
					...
					<div class="row">
					    ...
					    <div class="col-xs-9">
						<textarea class="form-control" name="remark" cols="10" rows="6" style="resize:none;">'.(isset($_GET['id']) ? $row_promosi["remark"] : "").'</textarea>
					    </div>
                                        </div>
					</div>
					<div class="form-group">
