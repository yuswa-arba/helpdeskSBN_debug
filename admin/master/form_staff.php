...
if ($loggedin = logged_inAdmin()) { // Check if they are logged in
    ...
    if ($loggedin["group"] == 'admin') {
        ...
        if (isset($_POST["save"])) {
            ...
            $nik = isset($_POST['nik']) ? mysql_real_escape_string(trim($_POST['nik'])) : '';
            $aktif = isset($_POST['aktif']) ? mysql_real_escape_string(trim($_POST['aktif'])) : '';
            ...
            $idshift = isset($_POST['idshift']) ? mysql_real_escape_string(trim($_POST['idshift'])) : '';
            ...
            if ($kode_pegawai != "" AND $nama != "") {
                ...
                $sql_insert_staff = "
                            ...
                            `nama_bank`, `no_acc`, `nama_pemilik`, `kota`, `ext_voip`, `nik`, `aktif`, `nama_ptkp`, `idshift_pegawai`,
                            `user_add`, `user_upd`, `date_add`, `date_upd`, `level`)
                            VALUES (NULL, '" . $id_cabang . "', '" . $id_bagian . "', '" . $kode_pegawai . "', '" . $nama . "', '" . $alamat . "', '" . $email . "', '" . $hp . "',
                            '" . $no_ktp . "', '" . $tgl_masuk . "', '" . $tgl_lahir . "', '" . $contact_person . "', '" . $nama_cp . "', '" . $alamat_cp . "', '" . $hubungan_cp . "',
                            '" . $id_level . "', '" . $ptkp . "', '" . $sex . "', '" . $no_koperasi . "', '" . $no_hp . "', '" . $agama . "', '" . $status . "', '" . $account_bank . "',
                            '" . $nama_bank . "', '" . $no_acc . "', '" . $nama_pemilik . "', '" . $kota . "', '" . $ext_voip . "', '" . $nik . "', '" . $aktif . "', '" . $nama_ptkp . "', '" . $idshift . "',
            ...
            if ($id_employee != "") {
                ...
                $sql_update_staff = "UPDATE `software`.`gx_pegawai` SET `kode_pegawai`= '" . $kode_pegawai . "', `nama`='" . $nama . "', `alamat`='" . $alamat . "',
                            ...
                            `nik`='" . $nik . "', `aktif`='" . $aktif . "',  `nama_ptkp`='" . $nama_ptkp . "', `idshift_pegawai`='" . $idshift . "',
            ...
            if ($id_user != "" AND $username != "" AND $password != "") {

                //update data login
                $sql_update_login = "UPDATE `software`.`gxLogin_admin` SET `username`='" . strtolower($username) . "',	`password`='" . md5($password) . "',
                            `password_date`=NOW(), `group`='" . $group_nama . "', `id_group`='" . $id_group . "', 
                            `user_upd`='" . $loggedin["username"] . "', `date_upd`=NOW()
        ...
        if (isset($_GET["id"])) {
            ...
            $query_staff = "SELECT * FROM `gx_pegawai` WHERE `id_employee`='$id_staff' AND `level` = '0' LIMIT 0,1;";
            $sql_staff = mysql_query($query_staff, $conn);
            $row_staff = mysql_fetch_array($sql_staff);

            $query_user = "SELECT * FROM `gxLogin_admin` WHERE `id_employee`='" . $row_staff["kode_pegawai"] . "' AND `level` = '0' LIMIT 0,1;";
            $sql_user = mysql_query($query_user, $conn);
            $row_user = mysql_fetch_array($sql_user);

            $query_foto = "SELECT * FROM `gxFoto_Profile` WHERE `id_employee`='" . $id_staff . "' AND `level` = '0' LIMIT 0,1;";
                    ...
                    <div class="row">
                        <div class="col-xs-9">
                            <div class="box box-primary">
                                ...
                                <!-- form start -->
                                <form action="" role="form" name="form_staff" id="form_staff" method="post" enctype="multipart/form-data" autocomplete="off">
                                            ...
                                            <div class="tab-content">
                                                <div class="tab-pane active" id="tab_1">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="row">
                                                            <div class="col-xs-4">
                                                                <label>NIK</label><i class="fa fa-warning danger"></i>
                                                            </div>
                                                            <div class="col-xs-8">
                                                                <input type="text" class="form-control" required="" name="nik" value="' . (isset($_GET['id']) ? $row_staff["nik"] : "") . '">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-xs-8">
                                                                <input type="text" class="form-control" readonly="" name="tgl_lahir" value="' . (isset($_GET['id']) ? date("d-m-Y", strtotime($row_staff["tgl_lahir"])) : "") . '"  id="datepicker" class="hasDatepicker">
                                                            </div>
                                                        </div>
                                                    </div>
        ...
        $content .= '						                    </select>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-xs-4">';
        if (isset($_GET["id"])) {
            $sql_shift = mysql_query("SELECT * FROM `gx_shift` WHERE `id_shift` = '$row_staff[idshift_pegawai]';", $conn);
            $row_shift = mysql_fetch_array($sql_shift);
        }
        $content .= '
                                                                <input  class="form-control" readonly="" type="text" name="shift" value="' . (isset($_GET["id"]) ? $row_shift["nama_shift"] : "") . '" onclick="return valideopenerform(\'data_shift.php?r=form_staff\',\'staff\');">
                                                                <input  class="form-control" readonly="" type="hidden" name="idshift" value="' . (isset($_GET["id"]) ? $row_staff["idshift_pegawai"] : "") . '">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-xs-8">
                                                                <input class="required" type="radio" name="aktif" value="0" ' . ((isset($_GET["id"]) && $row_staff["aktif"] == "0") ? "checked" : "") . '>Aktif
                                                                <input class="required" type="radio" name="aktif" value="1" ' . ((isset($_GET["id"]) && $row_staff["aktif"] == "1") ? "checked" : "") . '>Non-Aktif
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-xs-8">
                                                                <input class="required" type="radio" name="sex" value="L" ' . ((isset($_GET["id"]) && $row_staff["sex"] == "L") ? "checked" : "") . '>Laki-laki
                                                                <input class="required" type="radio" name="sex" value="P" ' . ((isset($_GET["id"]) && $row_staff["sex"] == "P") ? "checked" : "") . '>Perempuan
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-xs-8">
                                                                <input type="text" class="form-control" name="tgl_masuk" readonly="" id="datepicker2" class="hasDatepicker" value="' . (isset($_GET['id']) ? date("d-m-Y", strtotime($row_staff["tgl_masuk"])) : "") . '">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-xs-8">
                                                                <input class="required" type="radio" name="status" value="0" ' . ((isset($_GET["id"]) && $row_staff["status"] == "0") ? "checked" : "") . '>Belum Menikah
                                                                <input class="required" type="radio" name="status" value="1" ' . ((isset($_GET["id"]) && $row_staff["status"] == "1") ? "checked" : "") . '>Menikah
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-xs-3">
                                                                <input type="text" class="form-control" readonly="" name="nama_ptkp" value="' . (isset($_GET['id']) ? $row_staff["nama_ptkp"] : "") . '"
                                                                onclick="return valideopenerform(\'data_ptkp.php?r=form_staff\',\'ptkp\');">
                                                                <input type="hidden" class="form-control" name="kode_ptkp" value="">
                                                                <input type="hidden" class="form-control" name="ptkp" value="' . (isset($_GET['id']) ? $row_staff["ptkp"] : "") . '">
                                                            </div>
                                                        </div>
                                                    </div>
