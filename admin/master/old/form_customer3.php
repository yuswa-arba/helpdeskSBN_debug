...
if($loggedin["group"] == 'admin'){
    ...
    $sql_profile = mysql_query("SELECT `tbCustomer`.*, `gxLogin`.`id_voip`,`gxLogin`.`id_vod`  FROM `tbCustomer`,`gxLogin` WHERE `tbCustomer`.`cKode` = `gxLogin`.`customer_number` AND `tbCustomer`.`cKode` = '".$id_customer."' LIMIT 0,1;", $conn);
...
$row_paket_video = mysql_fetch_array($sql_paket_video);
    ...
    $content ='<section class="content-header">
			...
			<section class="col-lg-7 connectedSortable"> 
				...
				<div class="box-body">
				    ...
				    <div class="col-5 no-padding">
					    ...
					    <img src="'.URL.'img/avatar2.png" class="img-square" alt="User Image" />
				    </div>
		...
		$uploader->Render();
$content .= $uploader->RenderContent();
