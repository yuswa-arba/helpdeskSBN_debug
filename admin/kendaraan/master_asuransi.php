...
//SELECT
    ...
    $select_all_data_valid = "SELECT * FROM `gx_kendaraan_asuransi` WHERE `level` =  '0'";
...
//UPDATE
    ...
    //$sql_update_lock 
    $table_update_lock = "gx_kendaraan_asuransi";
    $redirect_action_lock = "master_asuransi";
...
//String Data View
    //Judul Form
    $judul_form = "Master Asuransi";
    $link_form_add_data = '<a href="form_asuransi.php" class="btn bg-maroon btn-flat margin">Create New</a>';
    $judul_table = "List Data Asuransi";
