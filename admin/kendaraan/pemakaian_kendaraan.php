...
//SELECT
    ...
    $select_all_data_valid = "SELECT * FROM `gx_kendaraan_pemakaian` WHERE `level` =  '0'";
...
//UPDATE
    ...
    //$sql_update_lock 
    $table_update_lock = "gx_kendaraan_pemakaian";
    $redirect_action_lock = "pemakaian_kendaraan";
...
//String Data View
    //Judul Form
    $judul_form = "Pemakaian Kendaraan";
    $link_form_add_data = '<a href="form_pemakaian_kendaraan.php" class="btn bg-maroon btn-flat margin">Create New</a>';
    $judul_table = "List Pemakaian Kendaraan";
    $data_field = array("Kode Kendaraan", "Tanggal", "No Pol", "Nama Kendaraan", "Merk");
    $data_sql_field = array("kode_kendaraan", "tanggal", "no_pol", "nama_kendaraan", "merk");
    $index_field_sql = "id";
    $unix_field_sql = "kode_kendaraan";
    $url_form_detail = "detail_pemakaian_kendaraan";
    $url_form_edit = "form_pemakaian_kendaraan";
    
    
    //id web
    $title_header = 'Pemakaian Kendaraan';
    $submenu_header = 'pemakaian_kendaraan';
    
    
if($loggedin["group"] == 'admin'){
    enableLog("", $loggedin["username"], $loggedin["id_employee"], "Open Master Asuransi");
    global $conn;
