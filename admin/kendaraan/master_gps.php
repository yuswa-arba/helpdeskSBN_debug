...
//SELECT
    ...
    $select_all_data_valid = "SELECT * FROM `gx_kendaraan_gps` WHERE `level` =  '0'";
...
//UPDATE
    ...
    //$sql_update_lock 
    $table_update_lock = "gx_kendaraan_gps";
    $redirect_action_lock = "master_gps";
...
//String Data View
    //Judul Form
    $judul_form = "Master GPS";
    $link_form_add_data = '<a href="form_gps.php" class="btn bg-maroon btn-flat margin">Create New</a>';
    $judul_table = "List Data GPS";
    $data_field = array("Kode GPS", "Nama GPS", "IMEI", "No SIM", "Operator Seluler");
    $data_sql_field = array("kode_gps", "nama_gps", "imei_gps", "nomer_sim_gps", "operator_seluler");
    $index_field_sql = "id";
