    ...
    $content ='<!-- Content Header (Page header) -->
			...
			<div class="box box-solid box-info">
			    ...
			    <div class="box box-solid box-success">
                                <div class="box-header">
                                    <h3 class="box-title">TV Channels</h3>
                                </div>
                                <div class="box-body">
                                    
				    Youth : IDR 100K/month <a href=""><span class="label label-warning">Select</span></a><br>
				    EXECUTIVE: IDR 130K/month <a href=""><span class="label label-warning">Select</span></a><br>
				    FAMILY : IDR 150K/month <a href=""><span class="label label-warning">Select</span></a><br>
				    <br><br><br><br><br><br>
				    <a href=""><span class="label label-warning">Detail</span></a>
                                </div>
                            </div>
			    ...
			    <div class="box box-solid box-warning">
				    ...
				    IDR 5000 / movies<br>
				    Limit : 5 movies /day<br><br>
				    Active : 24 hour / movie<br>
				    <br><br><br><br><br>
				    <a href=""><span class="label label-warning">List Movies</span></a>
                                </div>
                            </div>
                        </section><section class="col-lg-4">                            
			    <div class="box box-solid box-danger">
                                <div class="box-header">
                                    <h3 class="box-title">Karaoke</h3>
                                </div>
                                <div class="box-body">
                                    
				  <br><br>
				  <br><br>
				    <a href=""><span class="label label-warning">CCOMMING SOON</span></a>
				  <br><br><br><br><br><br>
