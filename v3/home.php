...
if($loggedin["group"] == 'super_admin' || $loggedin["group"] == 'admin' || $loggedin["group"] == 'manager' || $loggedin["group"] == 'kabag' || $loggedin["group"] == 'na' || $loggedin["group"] == 'cso'){
    $content ='<div class="container-fluid padded">
    <div class="row-fluid">
...
<ul class="chat-box timeline">
  ...
  <li class="arrow-box-left gray">
    <div class="avatar"><img class="avatar-small" src="'.URL.'core-admin/images/avatars/avatar1.jpg" /></div>
    <div class="info">
      <span class="name">
  ...
  <li class="arrow-box-left gray">
    <div class="avatar"><img class="avatar-small" src="'.URL.'core-admin/images/avatars/avatar2.jpg" /></div>
    <div class="info">
      <span class="name">
  ...
  <li class="arrow-box-left gray">
    <div class="avatar"><img class="avatar-small" src="'.URL.'core-admin/images/avatars/avatar3.jpg" /></div>
    <div class="info">
      <span class="name">
...
$plugins = '';
    ...
    $template	= bootstrap_helpdesk($title,$content,$plugins,$user,$submenu,$group);
