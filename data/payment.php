...
enableLog($loggedin["id_user"], $loggedin["username"], "", "Open Payment History Data");
global $conn_voip;
    ...
    $content ='<section class="content">
		  ...
		  <th width="60" class="lrborder">Status</th>
			...
			<td><input name="cNoJual[]" class="cNoJual" type="checkbox" value="BJL-130902237"></td>
			<td>BJL-130902237  </td>
			<td>2013-09-28</td>
			<td>2013-10-28</td>
			<td>IDR 50000.00</td>
			<td><span class="label label-danger">Unpaid</span></td>
			<td><a href="'.URL.'/data/detail_invoice" target="Invoice BJL-130902237" title="Invoice BJL-130902237">View detail</a></td>
		      </tr><tr>
			<td><input name="cNoJual[]" class="cNoJual" type="checkbox" value="BJL-130901812"></td>
			<td>BJL-130901812  </td>
			<td>2013-09-07</td>
			<td>2013-10-07</td>
			<td>IDR 766400.00</td>
			<td><span class="label label-danger">Unpaid</span></td>
			<td><a href="'.URL.'/data/detail_invoice" target="Invoice BJL-130901812" title="Invoice BJL-130901812">View detail</a></td>
		      </tr></tbody></table>
