	...
	<div >
		...
		<div class="table-container table-form">
		   <!-- <a href="'.URL_STAFF.'helpdesk/data_cust.php?r=form_troubleticket" class="btn btn-sm bg-navy btn-flat margin pull-right"
		    ...
		    <tr>
			<td colspan="2">
			   <!--<a href="'.URL_STAFF.'helpdesk/data_complaint.php?r=form_troubleticket" class="btn btn-sm bg-navy btn-flat margin pull-right"
						onclick="return valideopenerform(\''.URL_STAFF.'helpdesk/data_complaint.php?r=form_troubleticket\',\'troubleticketc\');">Search Complaint</a>-->
		    <br>
			</td>
		      </tr>
