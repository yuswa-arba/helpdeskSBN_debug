...
$sql_last_data_complaint = mysql_num_rows(mysql_query("SELECT * FROM `gx_helpdesk_complaint` ORDER BY `date_add` DESC", $conn)) + 1;
	...
	<div >
		...
		<div class="table-container table-form">
		    <a href="'.URL_STAFF.'helpdesk/data_cust.php?r=form_complaint" class="btn btn-sm bg-navy btn-flat margin pull-right"
						onclick="return valideopenerform(\''.URL_STAFF.'helpdesk/data_cust.php?r=form_complaint\',\'complaint\');">Search Customer</a>
		    <br>
