...
if (isset($_POST['username']) && isset($_POST['password'])) { // Check if submit button has been pressed.#fdf1f1
	...
	{ // Check if they are correct
	    ...
	    $results = mysql_query("INSERT into `gxSessions_admin` (`sess_id`, `id_employee`, `expired_session`, `logged`, `ip`, `waktu`)
			       VALUES ('".md5("GX".date("Y-m-dH:i"))."', '".$vcu['id_employee']."', DATE_ADD(NOW(), INTERVAL 1 HOUR), '0',
...
<html class="bg-black">
    <head>
        <meta charset="UTF-8">
        <title>Globalxtreme Administrator Log in</title>
        <meta content='width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no' name='viewport'>
        <!-- bootstrap 3.0.2 -->
        <link href="https://172.16.79.194/software/beta/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
        <!-- font Awesome -->
        <link href="https://172.16.79.194/software/beta/css/font-awesome.min.css" rel="stylesheet" type="text/css" />
        <!-- Theme style -->
        <link href="https://172.16.79.194/software/beta/css/AdminLTE.css" rel="stylesheet" type="text/css" />

        <!-- HTML5 Shim and Respond.js IE8 support of HTML5 elements and media queries -->
        <!-- WARNING: Respond.js doesn't work if you view the page via file:// -->
        <!--[if lt IE 9]>
          <script src="https://172.16.79.194/software/beta/js/html5shiv.js"></script>
          <script src="https://172.16.79.194/software/beta/js/respond.min.js"></script>
        <![endif]-->
    </head>
    <body class="bg-black">

        <div class="form-box" id="login-box">
            <div class="header"><img alt="GX Panel Customer Logo" src="/software/beta/img/gx-1111000.png" style="width:35px;"> Administrator Login</div>
