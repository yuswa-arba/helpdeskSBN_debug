 ...
 */
include ("../config/configuration_hrd.php");
    ...
    $content ='<!-- Content Header (Page header) -->
			    ...
			    <div class="box box-solid box-danger">
                                ...
                                <div class="box-body">
                                    <table class="table">
                                        ...
                                        <tr>
                                            <td><a href="'.URL_HRD.'helpdesk/helpdesk.php?type=complaint">Incoming</a></td>
                                            <td>'.$sum_complaint.'</td>
                                        </tr>
                                        <tr>
                                            <td><a href="'.URL_HRD.'helpdesk/helpdesk.php?type=prospek">Prospek</a></td>
                                            <td>'.$sum_prospek.'</td>
                                        </tr>
                                        <tr>
                                            <td><a href="'.URL_HRD.'helpdesk/helpdesk.php?type=nonprospek">Non Prospek</a></td>
                                            <td>'.$sum_nonprospek.'</td>
                                        </tr>
                                        <tr>
                                            <td><a href="'.URL_HRD.'helpdesk/helpdesk.php?type=spktech">SPK Teknisi</a></td>
                                            <td>'.$sum_spktech.'</td>
                                        </tr>
                                        <tr>
                                            <td><a href="'.URL_HRD.'helpdesk/helpdesk.php?type=spkmkt">SPK Marketing</a></td>
                                            <td>'.$sum_spkmkt.'</td>
                                        </tr>
                                    </table>
                                </div><!-- /.box-body -->
			...
			<div class="box box-solid box-warning">
				    ...
				    <table class="table">
                                        ...
                                        <tr>
                                            <td><a href="'.URL_HRD.'helpdesk/mailbox.php">All</a></td>
                                            <td>'.$sum_all.'</td>
                                        </tr>';
...
while ($row_kategori = mysql_fetch_array($kategori))
{
    ...
    //AND `gx_email`.`date_add` LIKE '%".date("Y-m-")."%'
    $content .='<tr>
                    <td><a href="'.URL_HRD.'helpdesk/mailbox.php?type='.$row_kategori["id_kategori"].'">'.$row_kategori["nama_kategori"].'</a></td>
                    <td>'.$sum_kategori.'</td>
                </tr>';
}
			    ...
			    <div class="box box-solid box-success">
                                ...
                                <div class="box-body">
                                    <table class="table">
                                        ...
                                        <tr>
                                            <td><a href="'.URL_HRD.'helpdesk/chat.php">Bali</a></td>
                                            <td></td>
                                        </tr>
                                        <tr>
                                            <td><a href="'.URL_HRD.'helpdesk/chat.php?locate=mlg">Malang</a></td>
                                            <td></td>
                                        </tr>
                                        <tr>
                                            <td><a href="'.URL_HRD.'helpdesk/chat.php?locate=bpn">Balikpapan</a></td>
                                            <td></td>
                                        </tr>
                                        <tr>
                                            <td><a href="'.URL_HRD.'helpdesk/chat.php?locate=smd">Samarinda</a></td>
                                            <td></td>
                                        </tr>
                                    </table>
                                </div><!-- /.box-body -->
...
$plugins = '
    ...
    $template	= hrd_theme($title,$content,$plugins,$user,$submenu,$group,$loggedin["id_bagian"]);
