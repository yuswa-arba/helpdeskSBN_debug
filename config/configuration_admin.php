...
//update 1 mei untuk menu sesuai login
include("admin/template_baru.php"); //na software theme
...
include("cso/template_v1.php"); //cso software theme
include("staff/template_v1.php"); //staff software theme