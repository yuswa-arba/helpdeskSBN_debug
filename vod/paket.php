...
<div id="graphDashboard" style="min-width:100%; height: 380px; margin: 0 auto;"></div>
    ...
    $content ='<section class="content-header">
                    <h1>
                        My Packages
                        <small>Movies & TV Channels</small>
                    </h1>
                </section>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="box box-solid box-primary">
                                <div class="box-header">
                                    <h3  align="center">TV Channels</h3>
                                </div>
                                <div class="box-body" align="center">
                                    <table width="90%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td><div align="center"><h4><strong>YOUTH : IDR 100K/month</strong></h4> </div></td><td><a href=""><span class="label label-warning">Select</span></a> </td>
  </tr>
  <tr>
    <td><div align="center"><h4><strong>EXECUTIVE : IDR 130K/month</strong></h4> </div></td><td> <a href=""><span class="label label-warning">Select</span></a></td>
  </tr>
  <tr>
    <td><div align="center"><h4><strong>FAMILY : IDR 150K/month</strong></h4></div></td><td> <a href=""><span class="label label-warning">Select</span></a> </td>
  </tr>
  <tr>
    <td><div align="center" colspan="2">&nbsp;</div></td>
  </tr>
  <tr>
    <td colspan="2"><div align="center"><button class="btn btn-primary btn-sm" onclick="window.location.href=\'tv_channels.php\'">Detail</button></div></td>
  </tr>
</table>
                                </div><!-- /.box-body -->
                            </div><!-- /.box -->
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="box box-solid box-success">
                                ...
                                <div class="box-body" align="center">
                                    <table width="90%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td><div align="center"><strong><h4>IDR 5000/movies</strong></h4></div></td>
  </tr>
  <tr>
    <td><div align="center"><strong><h4>Limit : 5 movies/day</strong></h4></div></td>
  </tr>
  <tr>
    <td><div align="center"><strong><h4>Active : 24 hour/movie</strong></h4></div></td>
  </tr>
  <tr>
    <td><div align="center">&nbsp;</div></td>
  </tr>
  <tr>
    <td><div align="center"><button class="btn btn-success btn-sm" onclick="window.open(\'http://globalxtreme.tv/list_movies.php\', \'_blank\');">List Movies</button></div></td>
  </tr>
</table>
                                </div><!-- /.box-body -->
                            </div><!-- /.box -->
  ...
  <tr>
    <td><div align="center"><button class="btn btn-danger btn-sm">COMING SOON</button></div></td>
  </tr>
  <tr>
    <td><div align="center">&nbsp;</div></td>
  </tr>
