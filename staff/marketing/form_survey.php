...
$sql_last_survey  	= mysql_fetch_array(mysql_query("SELECT * FROM `gx_survey` WHERE `tanggal` = '".date("Y-m-d")."' ORDER BY `id_survey` DESC", $conn));
$last_data  		= $sql_last_survey["id_survey"] + 1;
$tanggal    		= date("Ymd");
$kode_random 		= 'MKT-'.$tanggal.''.sprintf("%04d", $last_data);
    ...
    $content ='<section class="content-header">
                ...
                <section class="content">
					...
					<div class="row">
					    ...
					    <div class="col-xs-3">
						<input type="text" class="form-control" id="no_survey" name="no_survey" required="" readonly="" value="'.(isset($_GET["id_survey"]) ? $data_survey['no_spk_survey'] : $kode_random).'">
						<input type="hidden" class="form-control" id="cabang" name="cabang" required="" readonly="" value="'.(isset($_GET["id_survey"]) ? $data_survey['cabang'] : $loggedin["cabang"]).'">
					    </div>
					    <div class="col-xs-3">
						<label>Tanggal</label>
					    </div>
					    <div class="col-xs-3">
						<input type="text" class="form-control hasDatepicker" id="datepicker" name="tanggal" readonly="" required="" value="'.(isset($_GET["id_survey"]) ? date("Y-m-d H:i", strtotime($data_survey['tanggal'])) : date("Y-m-d H:i")).'">
					    </div>
                                        </div>
					</div>
					...
					<div class="row">
					    ...
					    <div class="col-xs-3">
						<input type="text" class="form-control"  readonly="" name="kode_customer" value="'.(isset($_GET["id_survey"]) ? $data_survey['kode_cust'] : "").'">
					    </div>-->
                                        </div>
					</div>
					<div class="form-group">
					<div class="row">
					    ...
					    <div class="col-xs-9">
						<input type="text" class="form-control" maxlength="50"  name="nama_customer" value="'.(isset($_GET["id_survey"]) ? $data_survey['nama_cust'] : "").'">
					    </div>
                                        </div>
					</div>
					<div class="form-group">
					<div class="row">
					    ...
					    <div class="col-xs-9">
						<input type="text" class="form-control" maxlength="50" name="nama_perusahaan" value="'.(isset($_GET["id_survey"]) ? $data_survey['nama_perusahaan'] : "").'">
					    </div>
                                        </div>
					</div>
					...
					<div class="row">
					    ...
					    <div class="col-xs-9">
					        <input type="text" class="form-control"  maxlength="60"  name="alamat" value="'.(isset($_GET["id_survey"]) ? $data_survey['alamat'] : "").'">
					    </div>
                                        </div>
					</div>
					...
					<div class="row">
					    ...
					    <div class="col-xs-3">
						<input type="text" class="form-control" maxlength="15" name="kelurahan" value="'.(isset($_GET["id_survey"]) ? $data_survey['kelurahan'] : "").'">
					    </div>
					    <div class="col-xs-3">
						<label>Kecamatan</label>
                                            </div>
					    <div class="col-xs-3">
						<input type="text" class="form-control" maxlength="15" name="kecamatan" value="'.(isset($_GET["id_survey"]) ? $data_survey['kecamatan'] : "").'">
					    </div>
                                        </div>
					</div>
					...
					<div class="row">
					    ...
					    <div class="col-xs-3">
						<input type="text" class="form-control" maxlength="15" name="kota" value="'.(isset($_GET["id_survey"]) ? $data_survey['kota'] : "").'">
					    </div>
					    <div class="col-xs-3">
						<label>Kode Pos</label>
                                            </div>
					    <div class="col-xs-3">
						<input type="text" class="form-control" maxlength="10" name="kode_pos" value="'.(isset($_GET["id_survey"]) ? $data_survey['kode_pos'] : "").'">
					    </div>
                                        </div>
					</div>
					...
					<div class="row">
					    ...
					    <div class="col-xs-6">
						<input type="text" class="form-control" maxlength="20" name="notelp" value="'.(isset($_GET["id_survey"]) ? $data_survey['no_telp'] : "").'">
					    </div>
                                        </div>
					</div>
					...
					<div class="row">
					    ...
					    <div class="col-xs-3">
						<input type="text" class="form-control" maxlength="20" name="hp1" value="'.(isset($_GET["id_survey"]) ? $data_survey['no_hp_1'] : "").'">
					    </div>
					    <div class="col-xs-3">
						<label>No. HP 2 </label>
                                            </div>
					    <div class="col-xs-3">
						<input type="text" class="form-control" maxlength="20" name="hp2" value="'.(isset($_GET["id_survey"]) ? $data_survey['no_hp_2'] : "").'">
					    </div>
                                        </div>
					</div>
					...
					<div class="row">
					    ...
					    <div class="col-xs-9">
						<input type="text" class="form-control" maxlength="30" name="contact" value="'.(isset($_GET["id_survey"]) ? $data_survey['contact_person'] : "").'">
					    </div>
                                        </div>
					</div>
					...
					<div class="row">
					    ...
					    <div class="col-xs-9">
						<input type="text" class="form-control" maxlength="40" name="email" value="'.(isset($_GET["id_survey"]) ? $data_survey['email'] : "").'">
					    </div>
                                        </div>
					</div>
					...
					<div class="row">
					    ...
					    <div class="col-xs-3">
						<input type="text" class="form-control"  maxlength="20" name="longitude" value="'.(isset($_GET["id_survey"]) ? $data_survey['longitude'] : "").'">
					    </div>
					    <div class="col-xs-3">
						<label>Latitude</label>
                                            </div>
					    <div class="col-xs-3">
						<input type="text" class="form-control" maxlength="20" name="latitude" value="'.(isset($_GET["id_survey"]) ? $data_survey['latitude'] : "").'">
					    </div>
                                        </div>
					</div>
					...
					<div class="row">
					    ...
					    <div class="col-xs-6">
						<input type="hidden" readonly="" class="form-control" name="id_marketing" value="'.$loggedin["id_employee"] .'" >
						<input type="hidden" readonly="" class="form-control" name="nama_marketing" value="'.$loggedin["username"].'">
						
						<input type="hidden" readonly="" class="form-control" name="id_marketing_spk" value="'.(isset($_GET["id_survey"]) ? $data_survey['id_marketing_spk'] : "").'" >
						<input type="text" readonly="" class="form-control" name="nama_marketing_spk" value="'.$loggedin["username"].'"
						onclick="return valideopenerform(\'data_marketing.php?r=myForm\',\'mkt\');">
...
$update = isset($_POST["update"]) ? $_POST["update"] : "";
	...
	if($save == "Save"){
	    ...
	    $id_marketing		= isset($_POST['id_marketing']) ? mysql_real_escape_string(trim(strip_tags($_POST['id_marketing']))) : "";
		$marketing_spk		= isset($_POST['nama_marketing_spk']) ? mysql_real_escape_string(trim(strip_tags($_POST['nama_marketing_spk']))) : "";
	    $id_marketing_spk	= isset($_POST['id_marketing_spk']) ? mysql_real_escape_string(trim(strip_tags($_POST['id_marketing_spk']))) : "";
		
	    if(($no_survey != "") && ($no_prospek != "") && ($longitude != "")  && ($latitude != "") ){
		$insert_survey   	= "INSERT INTO `gx_survey`(`id_survey`, `no_spk_survey`, `no_prospek`, `tanggal`, `cabang`, `nama_cust`,
		`nama_perusahaan`, `alamat`, `kelurahan`, `kecamatan`, `kota`, `kode_pos`, `no_telp`, `no_hp_1`, `no_hp_2`,
		`contact_person`, `email`, `longitude`, `latitude`, `marketing`, `id_marketing`,
		`marketing_spk`, `id_marketing_spk`,
		`date_add`, `date_upd`, `user_add`, `user_upd`, `level`)
					    VALUES (NULL, '".$no_survey."', '".$no_prospek."',NOW(),'".$cabang."','".$nama_cust."',
						'".$nama_perusahaan."','".$alamat."','".$kelurahan."','".$kecamatan."','".$kota."',
						'".$kode_pos."','".$no_telp."','".$no_hp_1."','".$no_hp_2."','".$contact_person."',
						'".$email."','".$longitude."','".$latitude."','".$marketing."', '".$id_marketing."',
						'".$marketing_spk."', '".$id_marketing_spk."',
		...
		`marketing`='".$marketing."', `id_marketing`='".$id_marketing."',
		`marketing_spk`='".$marketing_spk."', `id_marketing_spk`='".$id_marketing_spk."',
