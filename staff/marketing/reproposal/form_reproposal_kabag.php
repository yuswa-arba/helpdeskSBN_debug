...
if(isset($_GET["id"]))
{
    ...
    $query_data		= "SELECT * FROM `gx_reproposal_kabag` WHERE `id_reproposal`='$id_data' LIMIT 0,1;";
                        ...
                        <div class="col-xs-10">
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">Form Re Proposal KABAG</h3>
                                </div><!-- /.box-header -->
                                <!-- form start -->
                                    ...
                                    <div class="box-body">
										...
										<div class="row">
											...
											<div class="col-xs-3">
												...
												<input type="text" readonly="" class="form-control" id="kode_proposal" name="kode_proposal" required="" value="'.(isset($_GET['id']) ? $row_proposal["kode_proposal"] : "").'" onclick="return valideopenerform(\'data_proposal.php?r=myForm&f=reproposalkabag\',\'proposal\');">
											</div>
										</div>
										</div>
										...
										<div class="row">
											...
											<div class="col-xs-3">
												<input type="hidden" readonly="" class="form-control" id="id_marketing" name="id_marketing" required="" value="'.(isset($_GET['id']) ? "" : "").'">
												<input type="text" readonly="" class="form-control" id="nama_marketing" name="nama_marketing" required="" value="'.(isset($_GET['id']) ? "" : "").'">
											</div>
										</div>
										</div>
										...
										<div class="row">
											...
											<div class="col-xs-3">
												<input type="text" maxlength="6" class="form-control" id="harga" name="reproposal_ke" required="" value="'.(isset($_GET['id']) ? $row_data["reproposal_ke"] : "").'">
											</div>
										</div>
										</div>
...
if(isset($_POST["save"]))
{
	...
	$sql_insert = "INSERT INTO `gx_reproposal_kabag` (`id_reproposal`, `id_proposal`, `id_cabang`, `id_marketing`,
						  `kode_reproposal`, `tanggal`, `nama_customer`, `nama_perusahaan`, `allowance`, `harga_reproposal`, `reproposal_ke`,
						  `user_add`, `user_upd`, `date_add`, `date_upd`,  `level`) 
					  VALUES ('', '".$id_proposal."', '".$kode_cabang."', '".$nama_marketing."',
						  '".$kode_reproposal."', '".$tanggal."', '".$nama_customer."', '".$nama_perusahaan."', '".$allowance."', '".$harga_reproposal."', '".$reproposal_ke."',
	...
	echo "<script language='JavaScript'>
			...
			window.location.href='".URL_STAFF."marketing/reproposal/master_reproposal_kabag.php';
			</script>";
...
}elseif(isset($_POST["update"]))
{
    ...
    $sql_update = "UPDATE `gx_reproposal_kabag` SET `level` = '1',
	...
	$sql_insert_update	= "INSERT INTO `gx_reproposal_kabag` (`id_reproposal`, `id_proposal`, `id_cabang`, `id_marketing`,
						  `kode_reproposal`, `tanggal`, `nama_customer`, `nama_perusahaan`, `allowance`, `harga_reproposal`, `reproposal_ke`,
						  `user_add`, `user_upd`, `date_add`, `date_upd`,  `level`) 
					  VALUES ('', '".$id_proposal."', '".$kode_cabang."', '".$nama_marketing."',
						  '".$kode_reproposal."', '".$tanggal."', '".$nama_customer."', '".$nama_perusahaan."', '".$allowance."', '".$harga_reproposal."', '".$reproposal_ke."',
