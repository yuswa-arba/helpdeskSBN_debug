...
$query_data1	= "SELECT * FROM `gx_reproposal_kabag` WHERE `id_reproposal`='$id_data';";
...
$sql_update 	= "UPDATE `gx_reproposal_kabag` SET `print_pdf` = '$hit_print' WHERE `id_reproposal` = '$id_data';";        
