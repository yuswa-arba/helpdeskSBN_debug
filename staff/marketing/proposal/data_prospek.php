...
if(isset($_GET["f"])){
 ...
 <script type="text/javascript">
	 ...
	 function validepopupform2(ckode_prospek, ckode_customer, cmarketing, cnama_customer, calamat, ckelurahan, ckecamatan, ckota, ckode_pos, cno_telp, cno_hp1, cno_hp2, ccontact_person, cemail, cnama_perusahaan){
		 window.opener.document.'.$return_form.'.no_prospek.value=ckode_prospek;
		 ...
		 window.opener.document.'.$return_form.'.nama_perusahaan.value=cnama_perusahaan;
