                                ...
                                <form role="form" method="POST" name="myForm" action="" enctype="multipart/form-data" >
									...
									<div class="form-group">
										<div class="row">
											...
											<div class="col-xs-3">
												<input type="text" readonly="" class="form-control" id="tanggal" name="tanggal" required="" value="'.(isset($_GET['c']) ? date("Y-m-d H:i", strtotime($row_data1["tanggal"])) : date("Y-m-d H:i")).'">
											</div>
										</div>
										</div>
...
$content .='							    <tr>
					...
					<div class="row">
					    ...
					    <div class="col-xs-8">
							<input type="text" class="form-control" maxlength="4" required="" name="quantity"  id="harga" value="'.(isset($_GET['id']) ? $row_proposal_detail["qty"] : "").'" >
					    </div>
                    </div>
					</div>
					...
					<div class="row">
					    ...
					    <div class="col-xs-8">
							<input type="text" class="form-control" maxlength="20" required="" name="price" id="harga" value="'.(isset($_GET['id']) ? $row_proposal_detail["price"] : "").'">
					    </div>
                    </div>
					</div>
