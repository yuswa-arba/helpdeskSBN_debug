    ...
    $content ='<section class="content-header">
                ...
                <section class="content">
					...
					<div class="row">
					    ...
					    <div class="col-xs-4">
						'.date("Y-m-d H:i", strtotime($data_survey['tanggal'])).'
					    </div>
                                        </div>
					</div>
				...
				<table id="formulir" class="table table-bordered table-striped">
						...
						<th>Tanggal</th>
                                        ...
                                        <tbody>';
$sql_master_jawabsurvey = mysql_query("SELECT * FROM `gx_jawab_spksurvey` WHERE `level` = '0' AND `no_spksurvey` = '$data_survey[no_spk_survey]' ORDER BY `id_jawab_spksurvey` DESC LIMIT 0,5;",$conn);
$no = 1;
