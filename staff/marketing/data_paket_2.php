...
$no = 1;
    ...
    while ($row_paket = mysql_fetch_array($query_paket)) {
     ...
     $abonemen    	= $row_paket["abonemen_voip"];
     ...
     $content .='<tr>
                    ...
                    <td>
                      <a href="" onclick="validepopupform2(\''.mysql_real_escape_string($row_paket["id_paket"]).'\',\''.mysql_real_escape_string($row_paket["nama_paket"]).'\',\''.mysql_real_escape_string($row_paket["monthly_fee"]).'\',\''.mysql_real_escape_string($abonemen).'\',\''.mysql_real_escape_string($fee).'\',\''.$bandwith.'\')">Select</a>
                    </td>
                  </tr>';
	$no++;
    }
