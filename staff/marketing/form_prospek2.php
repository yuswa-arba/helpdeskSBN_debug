    ...
    $content ='<section class="content-header">
                ...
                <section class="content">
					...
					<div class="row">
					    ...
					    <div class="col-xs-4">
						<input type="text" maxlength="30" class="form-control"  name="kelurahan" value="'.(isset($_GET["id_prospek"]) ? $data_prospek['kelurahan'] :"").'">
					    </div>
					    <div class="col-xs-2">
					...
					<div class="row">
					    ...
					    <div class="col-xs-10">
						<textarea name="chat_history_wa" rows="10" cols="80" id="mytextarea" cols="70" style="resize: none;"> '.(isset($_GET["id_prospek"]) ? $data_prospek['chat_history_wa'] :"").' </textarea>
					    </div>
                    </div>
					</div>
...
$update = isset($_POST["update"]) ? $_POST["update"] : "";
	...
	if($save == "Save"){
	    ...
	    if(($no_prospek != "")  && ($nama_cust != "") && ($alamat != "") && ($kelurahan != "") && ($kecamatan != "") && ($kota != "") && ($kode_pos != "") && ($no_telp != "") && ($no_hp_1 != "") && ($no_hp_2 != "") && ($no_wa != "") && ($email != ""))
		{
