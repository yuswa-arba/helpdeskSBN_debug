    ...
    $content ='<section class="content-header">
				...
				<div class="box-tools pull-right">
				   <div class="btn bg-olive btn-flat margin">
					<a href="'.URL_STAFF.'helpdesk/mailbox.php">ALL</a>
				   </div>
                                        ';
...
while($row_email_kategori = mysql_fetch_array($sql_email_kategori))
{
     ...
     <a href="'.URL_STAFF.'helpdesk/mailbox.php?type='.$row_email_kategori["id_kategori"].'">'.$row_email_kategori["nama_kategori"].'</a></div>';
}
     ...
     <script type="text/javascript">
	  $(function () {
	       ...
	       setInterval(function() {
		    $(\'#download_mail\').load(\''.URL_STAFF.'ajax/mailbox.php\');
	       }, 300000); 
	  });
