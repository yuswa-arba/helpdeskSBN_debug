...
//UPDATE
    ...
    $redirect_action_lock = "master_spk_maintance";
...
//String Data View
    //Judul Form
    $judul_form = "Master SPK Maintance";
    $link_form_add_data = '<a href="form_spk_maintance.php" class="btn bg-maroon btn-flat margin">Create New</a>';
    $judul_table = "List Data SPK Maintance";
    $data_field = array("No SPK Maintance", "Nama Customer", "Kode Customer", "Telp", "Alamat", "Teknisi");
    $data_sql_field = array("kode_spk_maintance", "nama_customer", "kode_customer", "telp", "alamat", "teknisi");
    $index_field_sql = "id";
    ...
    enableLog("", $loggedin["username"], $loggedin["id_employee"], "Open Master SPK Maintance");
    global $conn;
...
//select data
	...
	$content .= '<tr>
			...
			<td><a href="'.$url_form_detail.'?c='.$row_data[$unix_field_sql].'"><span class="label label-info">Detail</span></a>
					<a href="form_jawab_spk_maintance?c='.$row_data[$unix_field_sql].'"><span class="label label-info">Jawab SPK</span></a>
					<a href="spk_maintenance_pdf.php?c='.$row_data[$unix_field_sql].'" target="_blank"><span class="label label-info">View PDF</span></a>
					<!--<a href="pdf_spk_maintance_2.php?c='.$row_data[$unix_field_sql].'" target="_blank"><span class="label label-info">PDF 2</span></a>-->
			</td>
		    </tr>';
	$no++;
    }
