    ...
    $content = '<section class="content-header">
                ...
                <section class="content">
					...
					<div class="row">
					    ...
					    <div class="col-xs-2">
						<label>No Jawab SPK Maintance</label>
					    </div>
					    <div class="col-xs-4">
						<input readonly="" type="text" class="form-control" required="" name="kode_jawab_spk_maintance" value="'.$row["kode_jawab_spk_maintance"].'">
					    </div>
                    </div>
					</div>
