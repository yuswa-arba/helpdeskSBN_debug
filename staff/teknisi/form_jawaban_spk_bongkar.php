...
//INSERT 
    ...
    $url_redirect_insert = "list_spk_bongkar";
...
//UPDATE
    ...
    $redirect_update_data = "list_spk_bongkar";
    ...
    $content = '<section class="content-header">
                ...
                <section class="content">
				    ...
				    $content.=' <div class="col-xs-2">
					    ...
					    <div class="col-xs-4">
						<input type="text" readonly="" class="form-control" required="" name="no_spk_bongkar" value="'.(isset($_GET['c']) ? $row["kode_spk_bongkar"] : '').'" >
					...
					<div class="row">
					    ...
					    <div class="col-xs-10">
						<input readonly="" type="text" class="form-control" required="" name="kode_jawaban_spk_bongkar" value="'.(isset($_GET['c']) ? "JSB-".rand(0000000, 9999999) : "JSB-".rand(0000000, 9999999)).'">
					    </div>
					...
					<div class="row">
					    ...
					    <div class="col-xs-4">
						<input type="text"  class="form-control" name="teknisi_1" value="'.(isset($_GET['c']) ? $row["teknisi"] : '').'"  readonly="" >';
						$row_teknisi = mysql_fetch_array(mysql_query("SELECT * FROM `gx_pegawai` WHERE `nama`='$row[teknisi]'", $conn));
						$content .='<input type="hidden"  class="form-control" name="kode_teknisi_1" value="'.(isset($_GET['c']) ? $row_teknisi["id_employee"] : '').'">
					    </div>
