...
include ("../../config/configuration_admin.php");
    ...
    */
    $sql_d = "SELECT `id`, `kode_spk_bongkar`, `tanggal`, `kode_cabang`, `cabang`, `user_id`, `kode_customer`, `nama_customer`, `no_inactive`, `no_off_connection`, `telp`, `kode_teknisi`, `teknisi`, `alamat`, `pekerjaan`, `status`, `date_add`, `date_upd`, `level`, `user_add`, `user_upd` FROM `gx_spk_bongkar` WHERE `kode_spk_bongkar`='$c_d' ORDER BY `id` DESC LIMIT 0,1";
