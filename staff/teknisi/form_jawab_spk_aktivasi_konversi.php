...
{
    $id_spk_aktivasi_konversi		= isset($_GET['id_spk']) ? (int)$_GET['id_spk'] : '';
    $query_jawab_spk_aktivasikonversi		= "SELECT * FROM `gx_spk_aktivasi_konversi` WHERE `id_spk_aktivasi_konversi`='$id_spk_aktivasi_konversi' LIMIT 0,1;";
    $sql_jawab_spk_aktivasikonversi		= mysql_query($query_jawab_spk_aktivasikonversi, $conn);
    $row_jawab_spk_aktivasi_konversi		= mysql_fetch_array($sql_jawab_spk_aktivasikonversi);
	$data_jawab_spk_aktivasi_konversi_teknisi = mysql_fetch_array(mysql_query("SELECT `nama` FROM `gx_pegawai` WHERE `id_employee`='$row_jawab_spk_aktivasi_konversi[id_teknisi]'", $conn));
	$data_jawab_spk_aktivasi_konversi_marketing = mysql_fetch_array(mysql_query("SELECT `nama` FROM `gx_pegawai` WHERE `id_employee`='$row_jawab_spk_aktivasi_konversi[id_marketing]'", $conn));
                                ...
                                <form role="form" method="POST" name="myForm" action="" enctype="multipart/form-data" >
                                    <div class="box-body">
										...
										<div class="row">
											...
											<div class="col-xs-3">
												<input type="text" class="form-control" readonly="" id="kode_spk_aktivasi" name="kode_spk_aktivasi" required="" value="'.(isset($_GET['id']) ? $row_jawab_spk_aktivasi_konversi["kode_spk_aktivasi"] : "").''.(isset($_GET['id_spk']) ? $row_jawab_spk_aktivasi_konversi["kode_spk_aktivasi_konversi"] : "").'">
											</div>
										</div>
										</div>
										...
										<div class="row">
											...
											<div class="col-xs-3">
												<input type="text" class="form-control" readonly="" id="kode_customer" name="kode_customer" required="" value="'.(isset($_GET['id']) ? $row_jawab_spk_aktivasi_konversi["kode_customer"] : "").''.(isset($_GET['id_spk']) ? $row_jawab_spk_aktivasi_konversi["kode_customer"] : "").'">
											</div>
											<div class="col-xs-3">
												<label>Nama Customer</label>
											</div>
											<div class="col-xs-3">
												<input type="text" readonly=""  class="form-control" name="nama_customer" value="'.(isset($_GET['id']) ? $row_jawab_spk_aktivasi_konversi["nama_customer"] : "").''.(isset($_GET['id_spk']) ? $row_jawab_spk_aktivasi_konversi["nama_customer"] : "").'">
											</div>
										</div>
										</div>
										...
										<div class="row">
											...
											<div class="col-xs-3">
												<input type="text" readonly=""  class="form-control"  name="uid" value="'.(isset($_GET['id']) ? $row_jawab_spk_aktivasi_konversi["uid"] : "").''.(isset($_GET['id_spk']) ? $row_jawab_spk_aktivasi_konversi["uid"] : "").'">
											</div>
											<div class="col-xs-3">
												<label>Telp</label>
											</div>
											<div class="col-xs-3">
												<input type="text" readonly=""  class="form-control"  name="telp" value="'.(isset($_GET['id']) ? $row_jawab_spk_aktivasi_konversi["telp"] : "").''.(isset($_GET['id_spk']) ? $row_jawab_spk_aktivasi_konversi["telp"] : "").'">
											</div>
										</div>
										</div>
										...
										<div class="row">
											...
											<div class="col-xs-3">
												<input type="text" class="form-control" readonly="" name="kode_paket" value="'.(isset($_GET['id']) ? $row_jawab_spk_aktivasi_konversi["kode_paket"] : "").''.(isset($_GET['id_spk']) ? $row_jawab_spk_aktivasi_konversi["kode_paket"] : "").'">
											</div>
											<div class="col-xs-5">
												<input type="text" class="form-control" readonly="" name="nama_paket" value="'.(isset($_GET['id']) ? $row_jawab_spk_aktivasi_konversi["nama_paket"] : "").''.(isset($_GET['id_spk']) ? $row_jawab_spk_aktivasi_konversi["nama_paket"] : "").'">
											</div>
										</div>
										</div>
										...
										<div class="row">
											...
											<div  class="col-xs-9">
												<textarea name="alamat" readonly="" class="form-control" placeholder="Alamat" style="resize: none;"> '.(isset($_GET["id"]) ? $row_jawab_spk_aktivasi_konversi['alamat'] :"").''.(isset($_GET['id_spk']) ? $row_jawab_spk_aktivasi_konversi["alamat"] : "").' </textarea>
											</div>
										</div>
										</div>
										...
										<div class="row">
											...
											<div class="col-xs-3">
												<input class="form-control" readonly="" name="id_teknisi" type="hidden" value="'.(isset($_GET['id']) ? $row_jawab_spk_aktivasi_konversi['id_teknisi'] :"") .''.(isset($_GET['id_spk']) ? $row_jawab_spk_aktivasi_konversi["id_teknisi"] : "").'">
												<input class="form-control" readonly="" name="nama_teknisi" placeholder="Nama Teknisi" type="text" value="'.(isset($_GET['id']) ? $data_jawab_spk_aktivasi_konversi_teknisi['nama'] :"") .''.(isset($_GET['id_spk']) ? $data_jawab_spk_aktivasi_konversi_teknisi['nama'] :"") .'">
											</div>
											<div class="col-xs-3">
												  <label>Marketing</label>
											</div>
											<div class="col-xs-3">
												<input class="form-control" readonly="" name="id_marketing" type="hidden" value="'.(isset($_GET['id']) ? $row_jawab_spk_aktivasi_konversi['id_marketing'] :"") .''.(isset($_GET['id_spk']) ? $row_jawab_spk_aktivasi_konversi["id_marketing"] : "").'">
												<input class="form-control" readonly="" name="nama_marketing" placeholder="Marketing" type="text" value="'.(isset($_GET['id']) ? $data_jawab_spk_aktivasi_konversi_marketing['nama'] :"").''.(isset($_GET['id_spk']) ? $data_jawab_spk_aktivasi_konversi_marketing['nama'] :"").'">
											</div>
										</div>
										</div>
										...
										<div class="row">
											...
											<div class="col-xs-3">
												...
												<input class="form-control" readonly="" onclick="valideopenerform(\'data_teknisi.php?r=myForm&t=2\',\'teknisi\');" name="nama_teknisi_2" placeholder="Nama Teknisi" type="text" value="'.(isset($_GET['id']) ? $data_jawab_spk_aktivasi_konversi_teknisi_2['nama'] :"") .'">
											</div>
											<div class="col-xs-3">
											...
											<div class="col-xs-3">
												...
												<input class="form-control" readonly="" onclick="valideopenerform(\'data_teknisi.php?r=myForm&t=4\',\'teknisi4\');" name="nama_teknisi_4" placeholder="Nama Teknisi" type="text" value="'.(isset($_GET['id']) ? $data_jawab_spk_aktivasi_konversi_teknisi_4['nama'] :"") .'">
											</div>
										</div>
										</div>
										...
										<div class="row">
											...
											<div class="col-xs-3">
												<input class="form-control" readonly="" name="id_teknisi_3" type="hidden" value="'.(isset($_GET['id']) ? $row_jawab_spk_aktivasi_konversi['id_teknisi_3'] :"") .'">
													<input class="form-control" readonly="" onclick="valideopenerform(\'data_teknisi.php?r=myForm&t=3\',\'teknisi3\');" name="nama_teknisi_3" placeholder="Nama Teknisi" type="text" value="'.(isset($_GET['id']) ? $data_jawab_spk_aktivasi_konversi_teknisi_3['nama'] :"") .'">
											</div>
											<div class="col-xs-3">
											...
											<div class="col-xs-3">
												...
												<input class="form-control" readonly="" onclick="valideopenerform(\'data_teknisi.php?r=myForm&t=5\',\'teknisi5\');" name="nama_teknisi_5" placeholder="Nama Teknisi" type="text" value="'.(isset($_GET['id']) ? $data_jawab_spk_aktivasi_konversi_teknisi_5['nama'] :"") .'">
											</div>
										</div>
										</div>
										...
										<div class="row">
											...
											<div class="col-xs-3">
												<input type="text" readonly=""  class="form-control" name="no_linkbudget" value="'.(isset($_GET['id']) ? $row_jawab_spk_aktivasi_konversi["no_linkbudget"] : "").''.(isset($_GET['id_spk']) ? $row_jawab_spk_aktivasi_konversi["no_linkbudget"] : "").'">
											</div>
										</div>
										</div>
...
if(isset($_POST["save"]))
{
	...
	$alat_terpasang			= isset($_POST['alat_terpasang']) ? mysql_real_escape_string(trim($_POST['alat_terpasang'])) : '';
	 ...
	 if($kode_jawab_spk_aktivasi != "" && $kode_spk_aktivasi != "" && $solusi != "" && $alat_terpasang != "" ){
	...
	echo "<script language='JavaScript'>
			...
			window.location.href='".URL_STAFF."teknisi/list_spk_aktivasi_konversi.php';
			</script>";
