...
if($sum_setting_topup == 1){
	...
	$inter_call = $row_setting_topup["inter_call"];
			...
			<div class="col-xs-7">
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">Setting Payment</h3>
                                </div><!-- /.box-header -->
                                <!-- form start -->
                                <div class="box-body">
				'.$message.'
					...
					<div class="row">
					    ...
					    <div class="col-xs-4">
							<input id="default_inet" type="radio" name="type_payment_inet" value="default" checked="" /> Default
					    </div>
					    <!--<div class="col-xs-4">
							<input id="custom_inet" type="radio" name="type_payment_inet" value="custom"  /> Custom
					    </div>-->
                    </div>
					</div>
				    <div id="form_custom_inet" style="display:none;">
					<div class="form-group">
					<div class="row">
					    <div class="col-xs-4">
						<label for="limited_vod">Limited</label>
					    </div>
					    <div class="col-xs-4">
                        <select class="form-control" name="limited_inet">
					...
					<div class="row">
					    ...
					    <div class="col-xs-4">
						<input id="default_voip" type="radio" name="type_payment_voip" value="default" /> Default
					    </div>
					    <div class="col-xs-4">
						<input id="custom_voip" type="radio" name="type_payment_voip" value="custom" /> Custom
					    </div>
                                        </div>
					</div>
					<div class="form-group">
					<div class="row">
					    <div class="col-xs-4">
						<label for="inter_call">International Call</label>
					    </div>
					    <div class="col-xs-4">
						<input id="yes_inter" type="radio" name="inter_call_voip" value="yes" /> Yes
					    </div>
					    <div class="col-xs-4">
						<input id="no_inter" type="radio" name="inter_call_voip" value="no" checked="" /> No
					    </div>
                                        </div>
					</div>
					<div id="form_inter" '.(($inter_call != "") ? '' : 'style="display:none;"').'>
					<div class="form-group">
					<div class="row">
					    <div class="col-xs-4">
					    ...
					    <div class="col-xs-4">
                                            <select class="form-control" name="inter_minimal_saldo">
						<option value="200000" '.((($sum_setting_topup == 1) AND ($row_setting_topup["inter_minimal_saldo"] == 200000)) ? 'selected=""' : "").'>Rp 200.000</option>
						<option value="100000" '.((($sum_setting_topup == 1) AND ($row_setting_topup["inter_minimal_saldo"] == 100000)) ? 'selected=""' : "").'>Rp 100.000</option>
						</select>
					    </div>
					...
					<div class="row">
					    ...
					    <div class="col-xs-4">
							<input id="default_vod" type="radio" name="type_payment_vod" value="default" checked="" /> Default
					    </div>
					    <!--<div class="col-xs-4">
							<input id="custom_vod" type="radio" name="type_payment_vod" value="custom"  /> Custom
					    </div>-->
                    </div>
					</div>
					<div id="form_custom_vod" style="display:none;">
					<div class="form-group">
					<div class="row">
					    <div class="col-xs-4">
						<label for="limited_vod">Limited</label>
					    ...
					    <div class="col-xs-4">
                        <select class="form-control" name="limited_vod">
							<option value="50000" '.((($sum_setting_topup == 1) AND ($row_setting_topup["minimal_saldo"] == 50000)) ? 'selected=""' : "").'>Rp 50.000</option>
							<option value="100000" '.((($sum_setting_topup == 1) AND ($row_setting_topup["minimal_saldo"] == 100000)) ? 'selected=""' : "").'>Rp 100.000</option>
							<option value="200000" '.((($sum_setting_topup == 1) AND ($row_setting_topup["minimal_saldo"] == 200000)) ? 'selected=""' : "").'>Rp 200.000</option>
...
$(\'#custom_voip\').on(\'ifChecked\', function(event){

    $(\'#form_auto\').show(\'fast\');
});
   $(\'#default_voip\').on(\'ifChecked\', function(event){
        $(\'#form_auto\').hide(\'fast\');
    });
	
	$(\'#custom_vod\').on(\'ifChecked\', function(event){

    $(\'#form_custom_vod\').show(\'fast\');
});
   $(\'#default_vod\').on(\'ifChecked\', function(event){
        $(\'#form_custom_vod\').hide(\'fast\');
    });
	
	$(\'#custom_inet\').on(\'ifChecked\', function(event){

    $(\'#form_custom_inet\').show(\'fast\');
});
   $(\'#default_inet\').on(\'ifChecked\', function(event){
        $(\'#form_custom_inet\').hide(\'fast\');
    });
	
	$(\'#yes_inter\').on(\'ifChecked\', function(event){

    $(\'#form_inter\').show(\'fast\');
});
   $(\'#no_inter\').on(\'ifChecked\', function(event){
        $(\'#form_inter\').hide(\'fast\');
    });
});
</script>';
