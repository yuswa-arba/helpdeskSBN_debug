...
<html class="bg-black">
    <head>
        <meta charset="UTF-8">
        <title>Globalxtreme CSO Log in</title>
    ...
    <body class="bg-black">
        ...
        <div class="form-box" id="login-box">
            <div class="header"><img alt="GX Panel Customer Logo" src="/sbn/beta/img/gx-1111000.png" style="width:35px;"> CSO GlobalXtreme</div>
