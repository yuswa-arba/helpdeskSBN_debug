...
$no = 1;
	...
	$content .='<tr>
		    ...
		    <td>'.$row_customer["cNonAktiv"].'</td>-->
                    <td>
                      <a href="" onclick="validepopupform2(\''.$row_customer["cUserID"].'\',\''.$row_customer["cKode"].'\',\''.$row_customer["cNama"].'\',\''.$row_customer["cAlamat1"].'\',\''.$row_customer["ctelp"].'\',\''.$row_customer["cEmail"].'\',\''.$row_customer["cPaket"].'\',\''.$row_customer["cNoHp1"].'\',\''.$row_customer["cNoHp2"].'\')">Select</a>
                    </td>
                  </tr>';
	$no++;
    }
...
<script type="text/javascript">
	...
	function validepopupform2(uid, custNumber, nama, alamat,ctelp, cemail, con_type, chp, chp2){
		...
		window.opener.document.'.$return_form.'.hp.value=chp;
