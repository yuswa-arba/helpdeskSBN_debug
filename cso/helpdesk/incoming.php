...
<table id="example1" class="table table-bordered table-striped">
    ...
    $sql_spkmkt = mysql_query("SELECT  `gx_helpdesk_spk` . * ,  `gx_pegawai`.`nama`, `gx_helpdesk_complaint`.`name` ,  `gx_helpdesk_complaint`.`note_nclient` ,  `gx_helpdesk_complaint`.`address` ,
							  `gx_helpdesk_complaint`.`email` ,  `gx_helpdesk_complaint`.`phone` 
