...
//SELECT
    ...
    $select_all_data_valid = "SELECT * FROM `gx_cso_maintenance` WHERE `level`='0'";
...
//UPDATE
    ...
    //$sql_update_lock 
    $table_update_lock = "gx_cso_maintenance";
    $redirect_action_lock = "master_maintenance";
...
//String Data View
    //Judul Form
    $judul_form = "Jadwal Maintenance";
    $link_form_add_data = '<a href="form_maintenance.php" class="btn bg-maroon btn-flat margin">Create New</a>';
    $judul_table = "List Data Maintenance";
    $data_field = array("CSO", "Last Upd", "User ID", "Nama", "Alamat", "Jenis Pekerjaan", "Status", "Teknisi", "Problem");
    $data_sql_field = array("nama_cso", "last_update", "user_id", "nama", "alamat", "jenis_pekerjaan", "status", "teknisi", "problem");
    $index_field_sql = "id";
    ...
    //id web
    $title_header = 'Jadwal Maintenance';
    $submenu_header = 'master_cso_maintenance';
    
    
if($loggedin["group"] == 'cso'){
    enableLog("", $loggedin["username"], $loggedin["id_employee"], "Open Master CSO Maintenance");
    global $conn;
