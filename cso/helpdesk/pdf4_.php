...
enableLog("", $loggedin["username"], "$loggedin[id_employee]", "Open PDF SPK");
    ...
    $sql_spk	= mysql_query("SELECT `gx_helpdesk_spk`.*
				      FROM `gx_helpdesk_spk`
                                      WHERE `gx_helpdesk_spk`.`id_spk` = '$id_spk';", $conn);
    ...
    $sql_employee	= mysql_query("SELECT `tbPegawai`.*
				      FROM `tbPegawai`
                                      WHERE `tbPegawai`.`id_employee` = '$row_spk[id_teknisi]';", $conn);
    
    $row_employee	= mysql_fetch_array($sql_employee);
     $sql_cust	= mysql_query("SELECT `gx_helpdesk_complaint`.*
				      FROM `gx_helpdesk_complaint`
                                      WHERE `gx_helpdesk_complaint`.`id_complaint` = '$row_spk[id_complaint]';", $conn);
  ...
  <tr>
    ...
    <td><table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <td width="221" height="110" valign="top"><img src="http://globalxtreme.net/malang/images/yootheme/logo.png" width="221" height="51"></td>

        <td width="579"><table width="553" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            ...
            <td valign="top"><strong>'.$row_employee['cNama'].'</strong></td>
          ...
          <tr>
            ...
            <td valign="top"><strong>'.$row_cust['phone'].'</strong></td>
      ...
      <tr>
        ...
        <td colspan="2"><table width="800" align="center" cellpadding="0" cellspacing="0" style="padding-left: 50px;padding-top: 20px;">
          ...
          <tr>
            ...
            <td width="638" valign="top"><strong>'.$row_cust['address'].'</strong></td>
          ...
          <tr>
            ...
            <td valign="top">'.$row_cust['connection_type'].'</td>
      ...
      <tr>
        ...
        <td colspan="2"><table width="800" align="center" cellpadding="15px" cellspacing="0" >
          ...
          <tr>
            ...
            <td align="center"><h5>'.$row_employee['cNama'].'</h5></td>
