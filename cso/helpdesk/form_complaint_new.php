...
$sql_last_data  = mysql_num_rows(mysql_query("SELECT * FROM `gx_helpdesk_complaint` WHERE `date_add` LIKE '".date("Y-m-d")."%' ORDER BY `date_add` DESC", $conn)) + 1;
 //echo date("Y-m-d H:i:s");   
		...
		$data_customer = mysql_fetch_array(mysql_query("SELECT * FROM `tbCustomer`
							  WHERE `tbCustomer`.`cKode` = '$get_id';", $conn));
	    }
	...
	<div >
		...
		<div class="table-container table-form">
			...
			<td width="37.5%">
			  ...
			  <input class="form-control required" required="" name="user_id" id="user_id" placeholder="User ID" type="text" value="'.(isset($_GET["id_complaint"]) ? $data_complaint['user_id'] :"") .''.(isset($_GET["id"]) ? $data_customer['cUserID'] :"") .'" >
			</td>
		      </tr>
		      <tr>
			<td>
			...
			<td>
			  <input class="form-control" name="customer_number" required="" id="customer_number" placeholder="Customer Number" type="text" value="'.(isset($_GET["id_complaint"]) ? $data_complaint['cust_number'] :"") .''.(isset($_GET["id"]) ? $data_customer['cKode'] :"") .'" >
			</td>
		      </tr>
		      <tr>
			<td>
			...
			<td>
			  <input class="form-control" name="name" required="" placeholder="Name" type="text" value="'.(isset($_GET["id_complaint"]) ? $data_complaint['name'] :"") .''.(isset($_GET["id"]) ? $data_customer['cNama'] :"") .'" >
			</td>
		      </tr>
			...
			<td>
			  <textarea name="address" rows="3" cols="70" class="" style="resize: none;">'.(isset($_GET["id_complaint"]) ? $data_complaint['address'] :"") .''.(isset($_GET["id"]) ? $data_customer['cAlamat1'] :"") .'</textarea>
			</td>
		      </tr>
		      <tr>
			<td>
			...
			<td>
			  <input class="form-control" name="phone" required="" placeholder="Phone" type="text" value="'.(isset($_GET["id_complaint"]) ? $data_complaint['phone'] :"") .''.(isset($_GET["id"]) ? $data_customer['ctelp'] :"") .'" >
			</td>
		      </tr>
		      <tr>
			<td>
			...
			<td>
			  <input class="form-control" name="email" placeholder="Email" type="text" value="'.(isset($_GET["id_complaint"]) ? $data_complaint['email'] :"") .''.(isset($_GET["id"]) ? $data_customer['cEmail'] :"") .'" >
			</td>
		      </tr>
		      <!--<tr>
			<td>
			...
			<td>
			  <input class="form-control" name="connection_type" placeholder="Connection Type" type="text" value="'.(isset($_GET["id_complaint"]) ? $data_complaint['connection_type'] :"") .''.(isset($_GET["id"]) ? $data_customer['tipe_koneksi'] :"") .'">
			</td>
		      </tr>-->
			...
			<td>
			    <input class="required" type="radio" name="connection_type" value="fo" style="float:left;" '.((isset($_GET["id_complaint"]) && $data_complaint["connection_type"]== "fo" ) ? "checked" :"") .' '.((isset($_GET["id"]) && $data_customer["tipe_koneksi"]== "fo" ) ? "checked" :"") .'>FO
			    <input class="required" type="radio" name="connection_type" value="wl" style="float:left;" '.((isset($_GET["id_complaint"]) && $data_complaint["connection_type"]== "wl" ) ? "checked" :"") .' '.((isset($_GET["id"]) && $data_customer["tipe_koneksi"]== "wireless" ) ? "checked" :"") .'>Wireless
			</td>
		      </tr>
			...
			<tr>
				...
				<select name="media" style="width:200px;">
                    ...
                    <option value="voicemail" '.((isset($_GET["id_complaint"]) && $data_complaint["media"]== "voicemail" ) ? 'selected="selected"' :"") .'>Voice Mail</option>
				    <option value="">-----------------------------------</option>
				    <option value="Admin" '.((isset($_GET["id_complaint"]) && $data_complaint["media"]== "admin" ) ? 'selected="selected"' :"") .'>Admin</option>
				</select>
			    </td>
		      </tr>
			...
			<td>
                ...
                <input class="required" type="radio" name="complaint_type" value="admin" style="float:left;" '.((isset($_GET["id_complaint"]) && $data_complaint["complaint_type"]== "admin" ) ? "checked" :"") .'>Administrasi
			</td>
		      </tr>
			...
			<td>
		      ...
		      <tr>
				...
				<select name="action" style="width:200px;">
				    ...
				    <option value="survey" '.((isset($_GET["id_complaint"]) && $data_complaint["action"]== "survey" ) ? 'selected="selected"' :"") .'>Survey</option>
			...
			<td>
			  <textarea hidden="" name="problem" rows="3" cols="70" style="resize: none;">'.(isset($_GET["id_complaint"]) ? $data_complaint['problem'] :"") .'</textarea>
			...
			$content .='<option value="'.$row_problem["problem"].'" '.((isset($_GET["id_complaint"]) && $data_complaint["problem_select"]== $row_problem["problem"] ) ? 'selected="selected"' :"") .'>'.$row_problem["problem"].'</option>';
		    }else{
