    ...
    $content ='<section class="content-header">
		...
		<div class="form-group">
			<div class="row">
				...
				<div class="col-xs-4">
					<input name="spk_start" class="form-control" type="text" id="datepicker2" value="'.(isset($_GET['id']) ? strip_tags(trim($row_data["spk_start"])) : "").'" />
				</div>
				...
				<div class="col-xs-4">
					<input name="spk_finish" class="form-control" type="text" id="datepicker3" value="'.(isset($_GET['id']) ? strip_tags(trim($row_data["spk_finish"])) : "").'" />
				</div>
			</div>
		</div>
