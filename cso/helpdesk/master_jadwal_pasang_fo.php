...
//SELECT
    ...
    $select_all_data_valid = "SELECT * FROM `gx_cso_jadwal_pasang_fo` WHERE `level`='0'";
...
//UPDATE
    ...
    $redirect_action_lock = "master_jadwal_pasang_fo";
...
//String Data View
    //Judul Form
    $judul_form = "Master Jadwal Pasang FO";
    $link_form_add_data = '<a href="form_jadwal_pasang_fo.php" class="btn bg-maroon btn-flat margin">Create New</a>';
    $judul_table = "List Data Jadwal Pasang FO";
    $data_field = array("User ID", "Tanggal", "Nama", "Alamat", "Status", "Teknisi", "Pekerjaan");
    $data_sql_field = array("user_id", "tanggal", "nama", "alamat", "status", "teknisi", "pekerjaan");
    $index_field_sql = "id";
    ...
    $submenu_header = 'master_cso_jadwal_pasang_fo';
    
    
if($loggedin["group"] == 'cso'){
    enableLog("", $loggedin["username"], $loggedin["id_employee"], "Open Master CSO Jadwal Pasang FO");
    global $conn;
