...
/*$sql_paket_data = mysql_query("SELECT `gx_paket`.* FROM `gx_paket`, `tbCustomer`
			     ...
			     AND `tbCustomer`.`cKode` = '".$_GET["id"]."';", $conn);
...
$sql_paket_tv = mysql_query("SELECT `gx_tv_customer`.* FROM `gx_tv_customer` WHERE `gx_tv_customer`.`id_customer` = '".$_GET["id"]."';", $conn);
				    ...
				    <br><br><br>
							...
							<div class="box">
                                ...
                                <div class="box-body no-padding">
									...
									$sql_data		= mysql_query("SELECT * FROM `gx_invoice` WHERE `customer_number` = '".$_GET["id"]."' AND `level` =  '0' ORDER BY `id_invoice` DESC LIMIT 0,5;", $conn);
