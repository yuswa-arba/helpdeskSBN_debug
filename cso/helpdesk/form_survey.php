    ...
    $content ='<section class="content-header">
                ...
                <section class="content">
					...
					<div class="row">
					    ...
					    <div class="col-xs-6">
						<input type="hidden" readonly="" class="form-control" name="id_marketing" value="'.(isset($_GET["id_survey"]) ? $data_survey['id_marketing'] :"") .'" >
...
$update = isset($_POST["update"]) ? $_POST["update"] : "";
	...
	if($save == "Save"){
		...
		$insert_survey   	= "INSERT INTO `gx_survey`(`id_survey`, `no_spk_survey`, `no_prospek`, `tanggal`, `cabang`, `nama_cust`, `nama_perusahaan`, `alamat`, `kelurahan`, `kecamatan`, `kota`, `kode_pos`, `no_telp`, `no_hp_1`, `no_hp_2`, `contact_person`, `email`, `longitude`, `latitude`, `marketing`, `id_marketing`, `date_add`, `date_upd`, `user_add`, `user_upd`, `level`)
					    VALUES (NULL, '".$no_survey."', '".$no_prospek."',NOW(),'".$cabang."','".$nama_cust."','".$nama_perusahaan."','".$alamat."','".$kelurahan."','".$kecamatan."','".$kota."','".$kode_pos."','".$no_telp."','".$no_hp_1."','".$no_hp_2."','".$contact_person."','".$email."','".$longitude."','".$latitude."','".$marketing."', '".$id_marketing."',NOW(),NOW(),'".$loggedin["username"]."','".$loggedin["username"]."','0');";
		//echo $insert_prospek;
