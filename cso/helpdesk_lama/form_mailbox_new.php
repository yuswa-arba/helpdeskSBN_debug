...
$submit = isset($_POST["update"]) ? $_POST["update"] : "";
	...
	if($submit == "Save"){
	    ...
	    enableLog("", $loggedin["username"], $loggedin["id_employee"], "SQL update kategori mailbox: $update");
		...
		enableLog("", $loggedin["username"], $loggedin["id_employee"], "SQL Insert complaint: $insert_complaint");
