...
//AND `gx_email`.`date_add` LIKE '%".date("Y-m-")."%'
    $content ='<!-- Content Header (Page header) -->
                <a href="helpdesk/customer.php" class="btn bg-maroon btn-flat margin">Search Kode Customer/ UID</a>
                <a href="helpdesk/form_prospek.php" class="btn bg-green btn-flat margin">New Customer</a>
