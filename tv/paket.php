...
$sql_data_paket_tv	= mysqli_query($conn_tv,"SELECT `ott`.`ott_product`.* FROM `ott`.`ott_product` WHERE `proID` = '".$row_paket_tv["id_paket"]."';");
...
//Status : '.(($row_paket_voip["level"] == "0") ? "Aktif" : "Nonaktif").'<br><br>
    ...
    $content ='<!-- Content Header (Page header) -->
			...
			<div class="box box-solid box-danger">
				...
				Nama Paket :  <b>'.$row_data_paket_tv["proName"].'</b><br>
...
$sql_list_paket = mysqli_query($conn_tv ,"SELECT * FROM `ott`.`ott_product` ;");
$no = 0;
    ...
    $content .='
			<section class="col-lg-4">                            
			    <div class="box box-solid '.boxColor($no).'">
                                <div class="box-header">
                                    <h3 class="box-title">'.$row_list_paket["proName"].'</h3>
                                </div>
                                <div class="box-body">
                    Expired Paket: -  <br>
